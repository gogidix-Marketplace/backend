...
public class GlobalExceptionHandler {
    ...
    public ResponseEntity<ErrorResponse> handleAvailabilityNotFound(AvailabilityNotFoundException ex, HttpServletRequest request) {
        log.error("Availability not found: {}", ex.getMessage());
