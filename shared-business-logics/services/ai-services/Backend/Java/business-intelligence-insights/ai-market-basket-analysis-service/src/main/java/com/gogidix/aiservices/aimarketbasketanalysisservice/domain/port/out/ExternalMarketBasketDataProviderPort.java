...
import com.gogidix.aiservices.aimarketbasketanalysisservice.domain.model.CustomerProfile;
 ...
 */
public interface ExternalMarketBasketDataProviderPort {
     ...
     */
    List<CustomerProfile> getCustomerProfiles(List<String> customerIds, String tenantId);
