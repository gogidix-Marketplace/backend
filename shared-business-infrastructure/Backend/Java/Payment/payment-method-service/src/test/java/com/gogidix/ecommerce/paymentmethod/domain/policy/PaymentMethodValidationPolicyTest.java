...
@DisplayName("PaymentMethodValidationPolicy Tests")
class PaymentMethodValidationPolicyTest {

    private PaymentMethodValidationPolicy policy;

    @BeforeEach
    void setUp() { policy = new PaymentMethodValidationPolicy(); }
