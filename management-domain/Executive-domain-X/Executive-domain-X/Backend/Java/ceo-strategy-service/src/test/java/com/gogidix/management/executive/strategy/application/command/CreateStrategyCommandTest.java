...
class CreateStrategyCommandTest {

        @Test
    void testBuilder() {
        CreateStrategyCommand dto = CreateStrategyCommand.builder()
    ...
    void testSettersAndGetters() {
        CreateStrategyCommand dto = new CreateStrategyCommand();
    ...
    void testEqualsAndHashCode() {
        CreateStrategyCommand dto1 = CreateStrategyCommand.builder()
                        .tenantId("test-tenantId")
            .name("test-name")
            .description("test-description")
            .ownerId("test-ownerId")
            ...
            .widgets(Collections.emptyList())
            .build();
        CreateStrategyCommand dto2 = CreateStrategyCommand.builder()
                        .tenantId("test-tenantId")
            .name("test-name")
            .description("test-description")
            .ownerId("test-ownerId")
