package com.gogidix.ecommerce.orchestrator.infrastructure.config;
...
public class OpenApiConfig {
    @Bean
    public OpenAPI fulfillmentOrchestratorServiceOpenAPI() {
        return new OpenAPI()
                .info(new Info()
                        .title("Fulfillment Orchestrator Service API")
                        .description("REST API for fulfillment orchestration in the Gogidix E-commerce platform")
                        .version("1.0.0")
