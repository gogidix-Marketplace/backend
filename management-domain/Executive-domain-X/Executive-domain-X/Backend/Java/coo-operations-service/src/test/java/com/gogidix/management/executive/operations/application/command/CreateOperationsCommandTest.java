...
class CreateOperationsCommandTest {

        @Test
    void testBuilder() {
        CreateOperationsCommand dto = CreateOperationsCommand.builder()
    ...
    void testSettersAndGetters() {
        CreateOperationsCommand dto = new CreateOperationsCommand();
    ...
    void testEqualsAndHashCode() {
        CreateOperationsCommand dto1 = CreateOperationsCommand.builder()
                        .tenantId("test-tenantId")
            .name("test-name")
            .description("test-description")
            .ownerId("test-ownerId")
            ...
            .widgets(Collections.emptyList())
            .build();
        CreateOperationsCommand dto2 = CreateOperationsCommand.builder()
                        .tenantId("test-tenantId")
            .name("test-name")
            .description("test-description")
            .ownerId("test-ownerId")
