...
class ReportCommand_SetSummaryCommandTest {

        @Test
    void testSettersAndGetters() {
        ReportCommand.SetSummaryCommand dto = new ReportCommand.SetSummaryCommand();
    ...
    void testEqualsAndHashCode() {
        ReportCommand.SetSummaryCommand dto1 = new ReportCommand.SetSummaryCommand();
        ReportCommand.SetSummaryCommand dto2 = new ReportCommand.SetSummaryCommand();
