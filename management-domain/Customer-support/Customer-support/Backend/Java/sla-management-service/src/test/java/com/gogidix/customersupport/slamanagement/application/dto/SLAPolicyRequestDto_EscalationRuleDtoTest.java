...
class SLAPolicyRequestDto_EscalationRuleDtoTest {

        @Test
    void testBuilder() {
        SLAPolicyRequestDto.EscalationRuleDto dto = SLAPolicyRequestDto.EscalationRuleDto.builder()
                        .level(42)
            .name("test-name")
    ...
    void testSettersAndGetters() {
        SLAPolicyRequestDto.EscalationRuleDto dto = new SLAPolicyRequestDto.EscalationRuleDto();
        dto.setLevel(99);
    ...
    void testEqualsAndHashCode() {
        SLAPolicyRequestDto.EscalationRuleDto dto1 = SLAPolicyRequestDto.EscalationRuleDto.builder()
                        .level(42)
            .name("test-name")
            .triggerAfterMinutes(42L)
            .escalateTo("test-escalateTo")
            ...
            .notifyTeams("test-notifyTeams")
            .build();
        SLAPolicyRequestDto.EscalationRuleDto dto2 = SLAPolicyRequestDto.EscalationRuleDto.builder()
                        .level(42)
            .name("test-name")
            .triggerAfterMinutes(42L)
            .escalateTo("test-escalateTo")
