...
class GovernanceGenTest {
    ...
    @BeforeEach
    void setup() {
        metrics = new ChatbotMetrics(new SimpleMeterRegistry());
    ...
    @Test
    void validate_NLU_PROCESSING_LATENCY() {
        var r = validator.validateThreshold(ThresholdValidator.ThresholdType.NLU_PROCESSING_LATENCY);
        assertThat(r).isNotNull();
    }
