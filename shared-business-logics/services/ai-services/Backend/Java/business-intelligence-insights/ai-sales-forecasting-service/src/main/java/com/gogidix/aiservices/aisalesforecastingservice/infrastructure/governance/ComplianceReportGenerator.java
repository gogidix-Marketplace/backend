package com.gogidix.aiservices.aisalesforecastingservice.infrastructure.governance;
...
public class ComplianceReportGenerator {
    ...
    private final SalesForecastingMetrics metrics;
    ...
    public ComplianceReportGenerator(
            SalesForecastingMetrics metrics,
    ...
    private SloComplianceSection generateSloComplianceSection() {
        ...
        // P95 Latency
        double p95Latency = metrics.getForecastingLatencyP95();
        ...
        // P99 Latency
        double p99Latency = metrics.getForecastingLatencyP99();
    ...
    private PerformanceMetricsSection generatePerformanceSection() {
        ...
        section.setTotalForecastings((long) metrics.getMeterRegistry()
                .get("segmentation.total").counter().count());

        section.setSuccessfulForecastings((long) metrics.getMeterRegistry()
                .get("segmentation.success").counter().count());

        section.setFailedForecastings((long) metrics.getMeterRegistry()
                .get("segmentation.failure").counter().count());

        section.setForecastsCreated((long) metrics.getMeterRegistry()
                .get("segment.created").counter().count());

        section.setForecastsUpdated((long) metrics.getMeterRegistry()
                .get("segment.updated").counter().count());

        section.setForecastModelsAnalyzed((long) metrics.getMeterRegistry()
    ...
    public static class GovernanceReport {
        ...
        private Map<String, Object> performanceMetricsToMap() {
            Map<String, Object> map = new HashMap<>();
            map.put("totalForecastings", performanceMetrics.getTotalForecastings());
            map.put("successfulForecastings", performanceMetrics.getSuccessfulForecastings());
            map.put("failedForecastings", performanceMetrics.getFailedForecastings());
            map.put("segmentsCreated", performanceMetrics.getForecastsCreated());
            map.put("customersAnalyzed", performanceMetrics.getForecastModelsAnalyzed());
            return map;
        }
    ...
    public static class PerformanceMetricsSection {
        private long totalForecastings;
        private long successfulForecastings;
        private long failedForecastings;
        ...
        // Getters and Setters
        public long getTotalForecastings() { return totalForecastings; }
        public void setTotalForecastings(long totalForecastings) { this.totalForecastings = totalForecastings; }
        public long getSuccessfulForecastings() { return successfulForecastings; }
        public void setSuccessfulForecastings(long successfulForecastings) { this.successfulForecastings = successfulForecastings; }
        public long getFailedForecastings() { return failedForecastings; }
        public void setFailedForecastings(long failedForecastings) { this.failedForecastings = failedForecastings; }
        public long getForecastsCreated() { return segmentsCreated; }
        public void setForecastsCreated(long segmentsCreated) { this.segmentsCreated = segmentsCreated; }
        public long getForecastsUpdated() { return segmentsUpdated; }
        public void setForecastsUpdated(long segmentsUpdated) { this.segmentsUpdated = segmentsUpdated; }
        public long getForecastModelsAnalyzed() { return customersAnalyzed; }
        public void setForecastModelsAnalyzed(long customersAnalyzed) { this.customersAnalyzed = customersAnalyzed; }
