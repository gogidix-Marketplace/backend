...
class CouponExceptionTest {
    ...
    void shouldCreateDuplicateException() {
        DuplicateCouponException ex = new DuplicateCouponException("name-1");
    ...
    void shouldCreateInvalidException() {
        InvalidCouponException ex = new InvalidCouponException("bad data");
    ...
    void shouldCreateInvalidExceptionWithCause() {
        ...
        InvalidCouponException ex = new InvalidCouponException("msg", cause);
