...
import com.gogidix.management.executive.operations.application.query.OperationsQueryService;
...
class OperationsQueryServiceTest {
    ...
    @InjectMocks
    private OperationsQueryService service;
    ...
    @Test
    void handle() {
        GetOperationsQuery query = new GetOperationsQuery();
        query.setOperationsId("test-operationsId");
    ...
    @Test
    void exists() {
        String operationsId = "test-operationsId";
        String tenantId = "test-tenantId";

        try {
        boolean result = service.exists(operationsId, tenantId);
