...
public class ThresholdValidator {
    ...
    public ThresholdValidator(ContentGenerationMetrics metrics) {
    ...
    public ComplianceReport validateAllThresholds() {
        ...
        // Validate AI generation latency
        double aiLatency = metrics.getAiGenerationLatencyP95();
        boolean aiCompliant = aiLatency <= MAX_AI_LATENCY_MS;
        report.addCheck("AI Generation Latency", aiLatency, MAX_AI_LATENCY_MS, aiCompliant);
