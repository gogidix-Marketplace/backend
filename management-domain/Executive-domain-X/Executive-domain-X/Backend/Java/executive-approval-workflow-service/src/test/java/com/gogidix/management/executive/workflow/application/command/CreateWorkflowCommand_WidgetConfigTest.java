...
class CreateWorkflowCommand_WidgetConfigTest {

        @Test
    void testBuilder() {
        CreateWorkflowCommand.WidgetConfig dto = CreateWorkflowCommand.WidgetConfig.builder()
                        .name("test-name")
            .type("test-type")
            .position(42)
            .row(42)
    ...
    void testSettersAndGetters() {
        CreateWorkflowCommand.WidgetConfig dto = new CreateWorkflowCommand.WidgetConfig();
    ...
    void testEqualsAndHashCode() {
        CreateWorkflowCommand.WidgetConfig dto1 = CreateWorkflowCommand.WidgetConfig.builder()
                        .name("test-name")
            .type("test-type")
            .position(42)
            .row(42)
            ...
            .dataSource("test-dataSource")
            .build();
        CreateWorkflowCommand.WidgetConfig dto2 = CreateWorkflowCommand.WidgetConfig.builder()
                        .name("test-name")
            .type("test-type")
            .position(42)
            .row(42)
