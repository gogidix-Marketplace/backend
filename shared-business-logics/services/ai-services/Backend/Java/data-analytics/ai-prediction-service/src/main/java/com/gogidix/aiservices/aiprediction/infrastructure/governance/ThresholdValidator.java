...
public class ThresholdValidator {
    ...
    private static final double MAX_P95_LATENCY_MS = 1000.0; // Prediction/forecasting
    private static final double MAX_P99_LATENCY_MS = 2000.0; // Prediction/forecasting
    private static final double MAX_ERROR_RATE = 0.02;        // 2%

    public ThresholdValidator(PredictionMetrics metrics) {
