...
public class ComplianceReportGenerator {
    ...
    public ComplianceReportGenerator(
            SentimentAnalysisMetrics metrics,
    ...
    private PerformanceMetricsSection generatePerformanceSection() {
        ...
        section.setTotalRequests((long) metrics.getMeterRegistry()
                .get("ai.sentiment.analysis.total").counter().count());
        section.setSuccessfulRequests((long) metrics.getMeterRegistry()
                .get("ai.sentiment.analysis.success").counter().count());
        section.setFailedRequests((long) metrics.getMeterRegistry()
                .get("ai.sentiment.analysis.failure").counter().count());
        section.setSentimentsAnalyzed((long) metrics.getMeterRegistry()
                .get("ai.sentiment.analysis.analyzed").counter().count());
    ...
    public static class PerformanceMetricsSection {
        ...
        private long sentimentsAnalyzed;
        ...
        public long getSentimentsAnalyzed() { return sentimentsAnalyzed; }
        public void setSentimentsAnalyzed(long sentimentsAnalyzed) { this.sentimentsAnalyzed = sentimentsAnalyzed; }
