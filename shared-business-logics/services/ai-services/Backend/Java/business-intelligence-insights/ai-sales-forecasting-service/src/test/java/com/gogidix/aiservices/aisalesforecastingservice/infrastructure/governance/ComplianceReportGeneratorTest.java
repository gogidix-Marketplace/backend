...
class ComplianceReportGeneratorTest {
    ...
    class ReportGenerationTests {
        ...
        void shouldPopulateSloComplianceSection() {
            Timer segmentationTimer = meterRegistry.timer("segmentation.duration", "service", "ai-sales-forecastation");
            ...
            Counter totalCounter = meterRegistry.counter("segmentation.total", "service", "ai-sales-forecastation");
            Counter failureCounter = meterRegistry.counter("segmentation.failure", "service", "ai-sales-forecastation");
        ...
        void shouldPopulatePerformanceMetricsSection() {
            Counter totalCounter = meterRegistry.counter("segmentation.total", "service", "ai-sales-forecastation");
            Counter successCounter = meterRegistry.counter("segmentation.success", "service", "ai-sales-forecastation");
            Counter failureCounter = meterRegistry.counter("segmentation.failure", "service", "ai-sales-forecastation");
            Counter createdCounter = meterRegistry.counter("segment.created", "service", "ai-sales-forecastation");
            Counter updatedCounter = meterRegistry.counter("segment.updated", "service", "ai-sales-forecastation");
            Counter analyzedCounter = meterRegistry.counter("customer.analyzed", "service", "ai-sales-forecastation");
            ...
            assertThat(perf.getTotalForecastings()).isEqualTo(5000L);
            assertThat(perf.getSuccessfulForecastings()).isEqualTo(4750L);
            assertThat(perf.getFailedForecastings()).isEqualTo(250L);
            assertThat(perf.getForecastsCreated()).isEqualTo(100L);
            assertThat(perf.getForecastsUpdated()).isEqualTo(50L);
            assertThat(perf.getForecastModelsAnalyzed()).isEqualTo(50000L);
        }
    ...
    private void recordGoodMetrics() {
        ...
        Timer analysisTimer = meterRegistry.timer("segment.analysis.duration", "service", "ai-sales-forecastation");
