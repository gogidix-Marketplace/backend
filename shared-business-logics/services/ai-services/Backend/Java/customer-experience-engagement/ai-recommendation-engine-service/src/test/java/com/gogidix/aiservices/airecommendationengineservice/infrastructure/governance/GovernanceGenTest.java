...
class GovernanceGenTest {
    ...
    @BeforeEach
    void setup() {
        metrics = new RecommendationEngineMetrics(new SimpleMeterRegistry());
    ...
    @Test
    void validate_ML_INFERENCE_LATENCY() {
        var r = validator.validateThreshold(ThresholdValidator.ThresholdType.ML_INFERENCE_LATENCY);
        assertThat(r).isNotNull();
    }
