...
/**
 * OpenAPI Configuration for Packing Service
 */
@Configuration
public class OpenAPIConfig {

    @Bean
    public OpenAPI packingServiceOpenAPI() {
        return new OpenAPI()
                .info(new Info()
                        .title("Packing Service API")
                        .description("Multi-tenant Warehouse Packing Order Management API for Gogidix Ecosystem")
                        .version("1.0.0")
                        .contact(new Contact()
    ...
    @Bean
    public GroupedOpenApi packingApi() {
        return GroupedOpenApi.builder()
                .group("packing")
                .pathsToMatch("/api/v1/fulfillment/packing/**")
                .build();
    }
