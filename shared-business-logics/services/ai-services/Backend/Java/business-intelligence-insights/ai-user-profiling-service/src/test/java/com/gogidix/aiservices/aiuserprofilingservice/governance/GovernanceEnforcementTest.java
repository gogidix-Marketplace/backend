package com.gogidix.aiservices.aiuserprofilingservice.governance;
...
import com.gogidix.aiservices.aiuserprofilingservice.infrastructure.governance.ComplianceReportGenerator;
import com.gogidix.aiservices.aiuserprofilingservice.infrastructure.governance.ThresholdValidator;
...
class GovernanceEnforcementTest {
    ...
    private UserProfileApplicationService segmentApplicationService;
        ...
        void shouldValidateP95LatencyThreshold() {
            ...
            for (int i = 0; i < 20; i++) {
                try {
                    ...
                    metrics.recordProfileationTime(100 + (i * 10));
                } catch (Exception e) {
                    // Ignore
                }
            }
    ...
    class ComplianceReportTests {
        ...
        void shouldIncludePerformanceMetricsSection() {
            ...
            for (int i = 0; i < 5; i++) {
                metrics.incrementProfileationTotal();
                metrics.recordProfileationTime(100);
            }
            ...
            assertThat(perf.getTotalProfileations()).isGreaterThanOrEqualTo(0);
            assertThat(perf.getSuccessfulProfileations()).isGreaterThanOrEqualTo(0);
        }
