package com.gogidix.aiservices.multimodalprocessingservice.security;
...
class SecurityValidationTest {
    ...
    class TenantIsolationTests {
        ...
        @Test
        @Order(10)
        @DisplayName("Should isolate processing results by tenant")
        void shouldIsolateProcessingResultsByTenant() {
            String tenant1 = "tenant-1";
            String tenant2 = "tenant-2";

            // Processing results for tenant1 should not affect tenant2
