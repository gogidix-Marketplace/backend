...
import com.gogidix.aiservices.aicustomersegmentationservice.infrastructure.governance.ComplianceReportGenerator;
...
class GovernanceEnforcementTest {
    ...
    private CustomerSegmentApplicationService segmentApplicationService;
        ...
        void shouldValidateP95LatencyThreshold() {
            ...
            for (int i = 0; i < 20; i++) {
                try {
                    ...
                    metrics.recordSegmentationTime(100 + (i * 10));
                } catch (Exception e) {
                    // Ignore
                }
            }
    ...
    class ComplianceReportTests {
        ...
        void shouldIncludePerformanceMetricsSection() {
            ...
            for (int i = 0; i < 5; i++) {
                metrics.incrementSegmentationTotal();
                metrics.recordSegmentationTime(100);
            }
            ...
            assertThat(perf.getTotalSegmentations()).isGreaterThanOrEqualTo(0);
            assertThat(perf.getSuccessfulSegmentations()).isGreaterThanOrEqualTo(0);
        }
