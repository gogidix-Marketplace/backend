...
class GovernanceGenTest {
    ...
    @Test
    void validate_P95_REGISTRATION_LATENCY() {
        var result = validator.validateThreshold(ThresholdValidator.ThresholdType.P95_REGISTRATION_LATENCY);
        assertThat(result).isNotNull();
        assertThat(result.isPassed()).isTrue();
    }

    @Test
    void validate_P99_REGISTRATION_LATENCY() {
        var result = validator.validateThreshold(ThresholdValidator.ThresholdType.P99_REGISTRATION_LATENCY);
        assertThat(result).isNotNull();
        assertThat(result.isPassed()).isTrue();
    }

    @Test
    void validate_MODEL_LOADING_LATENCY() {
        var result = validator.validateThreshold(ThresholdValidator.ThresholdType.MODEL_LOADING_LATENCY);
        assertThat(result).isNotNull();
        assertThat(result.isPassed()).isTrue();
    }
