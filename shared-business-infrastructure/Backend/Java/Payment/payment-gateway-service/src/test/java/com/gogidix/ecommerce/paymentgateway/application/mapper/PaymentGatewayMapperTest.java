...
@DisplayName("PaymentGatewayMapper Tests")
class PaymentGatewayMapperTest {

    private PaymentGatewayMapper mapper;

    @BeforeEach
    void setUp() { mapper = new PaymentGatewayMapper(); }
    ...
    void shouldMapToResponse() {
        ...
        PaymentGatewayResponse response = mapper.toResponse(entity);
    ...
    void shouldMapToEntity() {
        CreatePaymentGatewayRequest request = new CreatePaymentGatewayRequest("test", "desc", "type", null, null, null);
    ...
    void shouldUpdateFromRequest() {
        PaymentGateway entity = new PaymentGateway("tenant-1");
        entity.setName("old");
        UpdatePaymentGatewayRequest request = new UpdatePaymentGatewayRequest("new", "desc", null, null, null, null, null);
    ...
    void shouldSkipNullFields() {
        ...
        UpdatePaymentGatewayRequest request = new UpdatePaymentGatewayRequest(null, null, null, null, null, null, null);
        mapper.updateFromRequest(entity, request);
