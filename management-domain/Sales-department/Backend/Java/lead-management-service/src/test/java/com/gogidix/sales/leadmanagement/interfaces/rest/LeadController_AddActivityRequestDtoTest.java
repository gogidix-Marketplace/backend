...
class LeadController_AddActivityRequestDtoTest {

        @Test
    void testSettersAndGetters() {
        LeadController.AddActivityRequestDto dto = new LeadController.AddActivityRequestDto();
    ...
    void testEqualsAndHashCode() {
        LeadController.AddActivityRequestDto dto1 = new LeadController.AddActivityRequestDto();
        LeadController.AddActivityRequestDto dto2 = new LeadController.AddActivityRequestDto();
