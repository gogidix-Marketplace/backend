...
class LedgerAccountController_UpdateAccountRequestDtoTest {

        @Test
    void testSettersAndGetters() {
        LedgerAccountController.UpdateAccountRequestDto dto = new LedgerAccountController.UpdateAccountRequestDto();
    ...
    void testEqualsAndHashCode() {
        LedgerAccountController.UpdateAccountRequestDto dto1 = new LedgerAccountController.UpdateAccountRequestDto();
        LedgerAccountController.UpdateAccountRequestDto dto2 = new LedgerAccountController.UpdateAccountRequestDto();
