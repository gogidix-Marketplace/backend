...
public class RequestContextHolder {
    ...
    private static boolean isSystemContext(RequestContext context) {
        return "system".equals(context.tenantId()) && "system".equals(context.userId());
    }
