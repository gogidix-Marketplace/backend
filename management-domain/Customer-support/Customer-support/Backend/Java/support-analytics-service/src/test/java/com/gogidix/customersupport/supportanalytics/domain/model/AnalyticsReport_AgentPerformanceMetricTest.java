...
class AnalyticsReport_AgentPerformanceMetricTest {

        @Test
    void testBuilder() {
        AnalyticsReport.AgentPerformanceMetric dto = AnalyticsReport.AgentPerformanceMetric.builder()
    ...
    void testSettersAndGetters() {
        AnalyticsReport.AgentPerformanceMetric dto = new AnalyticsReport.AgentPerformanceMetric();
    ...
    void testEqualsAndHashCode() {
        AnalyticsReport.AgentPerformanceMetric dto1 = AnalyticsReport.AgentPerformanceMetric.builder()
                        .agentId("test-agentId")
            .agentName("test-agentName")
            .ticketsHandled(42)
            .ticketsResolved(42)
            ...
            .escalations(42)
            .build();
        AnalyticsReport.AgentPerformanceMetric dto2 = AnalyticsReport.AgentPerformanceMetric.builder()
                        .agentId("test-agentId")
            .agentName("test-agentName")
            .ticketsHandled(42)
            .ticketsResolved(42)
