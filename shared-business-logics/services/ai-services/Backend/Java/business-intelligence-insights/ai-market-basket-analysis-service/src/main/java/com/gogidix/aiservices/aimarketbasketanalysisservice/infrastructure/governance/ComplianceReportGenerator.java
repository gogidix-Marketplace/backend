...
public class ComplianceReportGenerator {
    ...
    private final MarketBasketMetrics metrics;
    ...
    private PerformanceMetricsSection generatePerformanceSection() {
        ...
        section.setTotalAnalyses((long) metrics.getMeterRegistry()
                .get("segmentation.total").counter().count());

        section.setSuccessfulAnalyses((long) metrics.getMeterRegistry()
                .get("segmentation.success").counter().count());

        section.setFailedAnalyses((long) metrics.getMeterRegistry()
                .get("segmentation.failure").counter().count());

        section.setBasketsCreated((long) metrics.getMeterRegistry()
                .get("segment.created").counter().count());

        section.setBasketsUpdated((long) metrics.getMeterRegistry()
    ...
    public static class GovernanceReport {
        ...
        private Map<String, Object> performanceMetricsToMap() {
            Map<String, Object> map = new HashMap<>();
            map.put("totalAnalyses", performanceMetrics.getTotalAnalyses());
            map.put("successfulAnalyses", performanceMetrics.getSuccessfulAnalyses());
            map.put("failedAnalyses", performanceMetrics.getFailedAnalyses());
            map.put("segmentsCreated", performanceMetrics.getBasketsCreated());
    ...
    public static class PerformanceMetricsSection {
        ...
        public void setSuccessfulAnalyses(long successfulAnalyses) { this.successfulAnalyses = successfulAnalyses; }
        public long getFailedAnalyses() { return failedAnalyses; }
        public void setFailedAnalyses(long failedAnalyses) { this.failedAnalyses = failedAnalyses; }
        public long getBasketsCreated() { return segmentsCreated; }
        public void setBasketsCreated(long segmentsCreated) { this.segmentsCreated = segmentsCreated; }
        public long getBasketsUpdated() { return segmentsUpdated; }
        public void setBasketsUpdated(long segmentsUpdated) { this.segmentsUpdated = segmentsUpdated; }
