...
class LeadCommand_CreateLeadCommandTest {

        @Test
    void testSettersAndGetters() {
        LeadCommand.CreateLeadCommand dto = new LeadCommand.CreateLeadCommand();
    ...
    void testEqualsAndHashCode() {
        LeadCommand.CreateLeadCommand dto1 = new LeadCommand.CreateLeadCommand();
        LeadCommand.CreateLeadCommand dto2 = new LeadCommand.CreateLeadCommand();
