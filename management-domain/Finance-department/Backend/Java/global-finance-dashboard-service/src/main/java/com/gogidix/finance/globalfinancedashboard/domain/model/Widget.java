 ...
 * Represents a visual component on a financial dashboard
 */
@Data
@Builder
@NoArgsConstructor
...
public class Widget {
     ...
     */
    public static Widget create(String tenantId, String dashboardId, String name,
    ...
    private static String generateWidgetId() {
        return "WIDG-" + java.util.UUID.randomUUID().toString().substring(0, 8).toUpperCase();
    }
