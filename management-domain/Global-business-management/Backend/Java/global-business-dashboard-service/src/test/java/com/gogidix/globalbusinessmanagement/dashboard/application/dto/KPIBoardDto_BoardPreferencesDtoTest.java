...
class KPIBoardDto_BoardPreferencesDtoTest {

        @Test
    void testBuilder() {
        KPIBoardDto.BoardPreferencesDto dto = KPIBoardDto.BoardPreferencesDto.builder()
                        .theme("test-theme")
            .autoRefresh(true)
            .refreshInterval(42)
    ...
    void testSettersAndGetters() {
        KPIBoardDto.BoardPreferencesDto dto = new KPIBoardDto.BoardPreferencesDto();
    ...
    void testEqualsAndHashCode() {
        KPIBoardDto.BoardPreferencesDto dto1 = KPIBoardDto.BoardPreferencesDto.builder()
                        .theme("test-theme")
            .autoRefresh(true)
            .refreshInterval(42)
            .timeZone("test-timeZone")
            ...
            .enableDrillDown(true)
            .build();
        KPIBoardDto.BoardPreferencesDto dto2 = KPIBoardDto.BoardPreferencesDto.builder()
                        .theme("test-theme")
            .autoRefresh(true)
            .refreshInterval(42)
            .timeZone("test-timeZone")
