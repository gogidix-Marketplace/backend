...
class OnboardingController_UpdateTemplateRequestDtoTest {

        @Test
    void testSettersAndGetters() {
        OnboardingController.UpdateTemplateRequestDto dto = new OnboardingController.UpdateTemplateRequestDto();
    ...
    void testEqualsAndHashCode() {
        OnboardingController.UpdateTemplateRequestDto dto1 = new OnboardingController.UpdateTemplateRequestDto();
        OnboardingController.UpdateTemplateRequestDto dto2 = new OnboardingController.UpdateTemplateRequestDto();
        dto1.setName("test");
