...
class PaymentCommand_AddAllocationCommandTest {

        @Test
    void testSettersAndGetters() {
        PaymentCommand.AddAllocationCommand dto = new PaymentCommand.AddAllocationCommand();
    ...
    void testEqualsAndHashCode() {
        PaymentCommand.AddAllocationCommand dto1 = new PaymentCommand.AddAllocationCommand();
        PaymentCommand.AddAllocationCommand dto2 = new PaymentCommand.AddAllocationCommand();
