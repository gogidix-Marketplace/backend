...
class SmsExceptionTest {
    ...
    void shouldCreateNotFoundException() {
        SmsNotFoundException ex = new SmsNotFoundException("id-1");
    ...
    void shouldCreateDuplicateException() {
        DuplicateSmsException ex = new DuplicateSmsException("name-1");
    ...
    void shouldCreateInvalidException() {
        InvalidSmsException ex = new InvalidSmsException("bad data");
    ...
    void shouldCreateInvalidExceptionWithCause() {
        ...
        InvalidSmsException ex = new InvalidSmsException("msg", cause);
