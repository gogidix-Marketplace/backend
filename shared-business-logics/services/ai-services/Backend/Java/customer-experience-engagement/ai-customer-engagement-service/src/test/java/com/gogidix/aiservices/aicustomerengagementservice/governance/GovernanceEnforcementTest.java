package com.gogidix.aiservices.aicustomerengagementservice.governance;

import com.gogidix.aiservices.aicustomerengagementservice.TestApplication;
import com.gogidix.aiservices.aicustomerengagementservice.infrastructure.governance.ComplianceReportGenerator;
import com.gogidix.aiservices.aicustomerengagementservice.infrastructure.governance.ThresholdValidator;
    ...
    class ThresholdValidationTests {
        ...
        void shouldValidateP95LatencyThreshold() {
            ...
            for (int i = 0; i < 20; i++) {
                ...
                metrics.recordEngagementTime(100 + i * 10);
            }
    ...
    class ThresholdEnforcementTests {
        ...
        void shouldEnforceLatencyThreshold() {
            ...
            for (int i = 0; i < requests; i++) {
                metrics.incrementEngagementTotal();
                metrics.incrementEngagementSuccess();
                metrics.recordEngagementTime(150 + i * 5);
            }
