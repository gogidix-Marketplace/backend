package com.gogidix.aiservices.aicontentgenerationservice.infrastructure.governance;
...
public class ComplianceReportGenerator {
    ...
    private final ContentGenerationMetrics metrics;
    ...
    public ComplianceReportGenerator(
            ContentGenerationMetrics metrics,
    ...
    private PerformanceMetricsSection generatePerformanceSection() {
        ...
        section.setTotalRequests((long) metrics.getMeterRegistry()
                .get("ai.content.generation.total").counter().count());

        section.setSuccessfulRequests((long) metrics.getMeterRegistry()
                .get("ai.content.generation.success").counter().count());

        section.setFailedRequests((long) metrics.getMeterRegistry()
                .get("ai.content.generation.failure").counter().count());

        section.setContentGenerated((long) metrics.getMeterRegistry()
                .get("ai.content.generation.generated").counter().count());

        section.setContentOptimized((long) metrics.getMeterRegistry()
                .get("ai.content.generation.optimized").counter().count());

        section.setTemplateUsed((long) metrics.getMeterRegistry()
                .get("ai.content.generation.template.used").counter().count());
    ...
    public static class GovernanceReport {
        ...
        private Map<String, Object> performanceMetricsToMap() {
            ...
            map.put("contentGenerated", performanceMetrics.getContentGenerated());
            return map;
        }
    ...
    public static class PerformanceMetricsSection {
        ...
        private long contentGenerated;
        private long contentOptimized;
        private long templateUsed;
        ...
        public long getContentGenerated() { return contentGenerated; }
        public void setContentGenerated(long contentGenerated) { this.contentGenerated = contentGenerated; }
        public long getContentOptimized() { return contentOptimized; }
        public void setContentOptimized(long contentOptimized) { this.contentOptimized = contentOptimized; }
        public long getTemplateUsed() { return templateUsed; }
        public void setTemplateUsed(long templateUsed) { this.templateUsed = templateUsed; }
