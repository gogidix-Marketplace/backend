...
class Alert_WidgetTest {

        @Test
    void testBuilder() {
        Alert.Widget dto = Alert.Widget.builder()
                        .id("test-id")
            .name("test-name")
            .type(Alert.Widget.WidgetType.KPI_CARD)
            .position(42)
            .row(42)
            .column(42)
            .width(42)
        ...
        assertEquals(Alert.Widget.WidgetType.KPI_CARD, dto.getType());
    ...
    void testSettersAndGetters() {
        Alert.Widget dto = new Alert.Widget();
        dto.setId("val-id");
        dto.setName("val-name");
        dto.setType(Alert.Widget.WidgetType.KPI_CARD);
        dto.setPosition(99);
        dto.setRow(99);
        dto.setColumn(99);
        dto.setWidth(99);
    ...
    void testEqualsAndHashCode() {
        Alert.Widget dto1 = Alert.Widget.builder()
                        .id("test-id")
            .name("test-name")
            .type(Alert.Widget.WidgetType.KPI_CARD)
            .position(42)
            ...
            .dataSource("test-dataSource")
            .build();
        Alert.Widget dto2 = Alert.Widget.builder()
                        .id("test-id")
            .name("test-name")
            .type(Alert.Widget.WidgetType.KPI_CARD)
            .position(42)
