...
public record AnalysisAnalysisResponseDto(

        @Schema(description = "Analysis identifier", example = "seg_1234567890abcdef")
        String segmentId,
        ...
        int totalIntelligenceReports,

        @Schema(description = "IntelligenceReport demographics breakdown")
    ...
    /**
     * Get the customer count (alias for totalIntelligenceReports for test compatibility).
     * @return the total number of customers analyzed
     */
    public int customerCount() {
        return totalIntelligenceReports;
    }
}
