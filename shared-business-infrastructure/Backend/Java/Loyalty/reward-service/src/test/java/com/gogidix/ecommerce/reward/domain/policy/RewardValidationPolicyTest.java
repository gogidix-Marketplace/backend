...
@DisplayName("RewardValidationPolicy Tests")
class RewardValidationPolicyTest {

    private RewardValidationPolicy policy;

    @BeforeEach
    void setUp() { policy = new RewardValidationPolicy(); }
