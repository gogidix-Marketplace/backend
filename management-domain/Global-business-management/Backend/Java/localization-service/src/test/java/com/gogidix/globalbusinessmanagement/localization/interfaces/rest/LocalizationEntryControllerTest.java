...
import com.gogidix.globalbusinessmanagement.localization.interfaces.rest.LocalizationEntryController;
...
class LocalizationEntryControllerTest {

    @Mock
    private LocalizationEntryService service;

    @InjectMocks
    private LocalizationEntryController underTest;
