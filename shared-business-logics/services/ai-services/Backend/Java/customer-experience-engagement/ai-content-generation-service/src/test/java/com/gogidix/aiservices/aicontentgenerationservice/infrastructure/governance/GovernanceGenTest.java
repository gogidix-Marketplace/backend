...
class GovernanceGenTest {
    ...
    @BeforeEach
    void setup() {
        metrics = new ContentGenerationMetrics(new SimpleMeterRegistry());
    ...
    @Test
    void validate_AI_GENERATION_LATENCY() {
        var r = validator.validateThreshold(ThresholdValidator.ThresholdType.AI_GENERATION_LATENCY);
        assertThat(r).isNotNull();
    }
