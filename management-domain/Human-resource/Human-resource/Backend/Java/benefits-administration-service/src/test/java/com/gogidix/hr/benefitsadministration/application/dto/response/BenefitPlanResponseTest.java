...
class BenefitPlanResponseTest {

        @Test
    void testBuilder() {
        BenefitPlanResponse dto = BenefitPlanResponse.builder()
                        .id("test-id")
    ...
    void testSettersAndGetters() {
        BenefitPlanResponse dto = new BenefitPlanResponse();
        dto.setId("val-id");
    ...
    void testEqualsAndHashCode() {
        BenefitPlanResponse dto1 = BenefitPlanResponse.builder()
                        .id("test-id")
            .tenantId("test-tenantId")
            .countryCode("test-countryCode")
            .planId("test-planId")
            ...
            .updatedBy("test-updatedBy")
            .build();
        BenefitPlanResponse dto2 = BenefitPlanResponse.builder()
                        .id("test-id")
            .tenantId("test-tenantId")
            .countryCode("test-countryCode")
            .planId("test-planId")
