...
/**
 * DTO for sales forecast response.
 */
@Schema(description = "Response DTO for sales forecast")
public record SalesForecastingResponseDto(

        @Schema(description = "Unique segment identifier", example = "seg_1234567890abcdef")
        String id,

        @Schema(description = "Name of the segment", example = "High Value ForecastModels")
        String name,
        ...
        @Schema(description = "ForecastModel IDs in this segment")
