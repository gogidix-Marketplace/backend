package com.gogidix.finance.cashflow.shared.requestcontext;
...
public final class RequestContextHolder {
    ...
    public static String getUserIdOrDefault(String defaultValue) { return getUserId().orElse(defaultValue); }
