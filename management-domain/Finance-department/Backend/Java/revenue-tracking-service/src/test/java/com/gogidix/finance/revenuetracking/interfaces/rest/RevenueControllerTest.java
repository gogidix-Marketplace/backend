...
import com.gogidix.finance.revenuetracking.interfaces.rest.RevenueController;
...
class RevenueControllerTest {
    ...
    @InjectMocks
    private RevenueController underTest;

    @BeforeEach
    void setUp() {
        lenient().when(service.getById(any())).thenReturn(java.util.Optional.empty());
