...
class DashboardQuery_GetPerformanceComparisonQueryTest {

        @Test
    void testSettersAndGetters() {
        DashboardQuery.GetPerformanceComparisonQuery dto = new DashboardQuery.GetPerformanceComparisonQuery();
    ...
    void testEqualsAndHashCode() {
        DashboardQuery.GetPerformanceComparisonQuery dto1 = new DashboardQuery.GetPerformanceComparisonQuery();
        DashboardQuery.GetPerformanceComparisonQuery dto2 = new DashboardQuery.GetPerformanceComparisonQuery();
