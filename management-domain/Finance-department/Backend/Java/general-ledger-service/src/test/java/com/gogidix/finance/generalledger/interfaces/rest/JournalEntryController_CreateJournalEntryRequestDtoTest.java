...
class JournalEntryController_CreateJournalEntryRequestDtoTest {

        @Test
    void testSettersAndGetters() {
        JournalEntryController.CreateJournalEntryRequestDto dto = new JournalEntryController.CreateJournalEntryRequestDto();
    ...
    void testEqualsAndHashCode() {
        JournalEntryController.CreateJournalEntryRequestDto dto1 = new JournalEntryController.CreateJournalEntryRequestDto();
        JournalEntryController.CreateJournalEntryRequestDto dto2 = new JournalEntryController.CreateJournalEntryRequestDto();
