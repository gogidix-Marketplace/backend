...
export function LoginPage() {
  ...
  const demoUsers = [
    { email: 'john.davis@gogidix.com', name: 'John Davis', dept: 'Sales' },
    { email: 'amanda.peters@gogidix.com', name: 'Amanda Peters', dept: 'Marketing' },
    { email: 'david.wilson@gogidix.com', name: 'David Wilson', dept: 'IT' },
  ]
    ...
    <div className="min-h-screen bg-gradient-to-br from-blue-600 to-blue-800 flex items-center justify-center p-4">
      <div className="w-full max-w-md">
        ...
        <div className="text-center mb-8">
          ...
          <p className="text-blue-200">Employee Expense Submission - Port 3021</p>
        </div>

        {/* Login Form */}
        <div className="bg-white rounded-2xl shadow-xl p-8">
          <h2 className="text-xl font-semibold text-slate-900 mb-6">Employee Sign In</h2>
              ...
              {demoUsers.map((user) => (
                ...
                >
                  <div>
                    ...
                    <span className="text-xs text-slate-500 ml-2">• {user.dept}</span>
                  </div>
