...
class CountryDashboardCommand_AddTrendDataCommandTest {

        @Test
    void testSettersAndGetters() {
        CountryDashboardCommand.AddTrendDataCommand dto = new CountryDashboardCommand.AddTrendDataCommand();
    ...
    void testEqualsAndHashCode() {
        CountryDashboardCommand.AddTrendDataCommand dto1 = new CountryDashboardCommand.AddTrendDataCommand();
        CountryDashboardCommand.AddTrendDataCommand dto2 = new CountryDashboardCommand.AddTrendDataCommand();
