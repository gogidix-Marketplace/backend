...
@DisplayName("AirFreightMapper Tests")
class AirFreightMapperTest {

    private AirFreightMapper mapper;

    @BeforeEach
    void setUp() { mapper = new AirFreightMapper(); }
    ...
    void shouldMapToResponse() {
        ...
        AirFreightResponse response = mapper.toResponse(entity);
    ...
    void shouldMapToEntity() {
        CreateAirFreightRequest request = new CreateAirFreightRequest("test", "desc", "type", null, null, null);
    ...
    void shouldUpdateFromRequest() {
        AirFreight entity = new AirFreight("tenant-1");
        entity.setName("old");
        UpdateAirFreightRequest request = new UpdateAirFreightRequest("new", "desc", null, null, null, null, null);
    ...
    void shouldSkipNullFields() {
        ...
        UpdateAirFreightRequest request = new UpdateAirFreightRequest(null, null, null, null, null, null, null);
        mapper.updateFromRequest(entity, request);
