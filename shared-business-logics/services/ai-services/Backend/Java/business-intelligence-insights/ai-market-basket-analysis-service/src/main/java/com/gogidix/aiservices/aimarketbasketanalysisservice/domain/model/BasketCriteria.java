...
public class BasketCriteria {
    ...
    private final List<BasketCriteria> nestedCriteria;

    // Private constructor
    private BasketCriteria(Builder builder) {
    ...
    public List<BasketCriteria> getNestedCriteria() {
     ...
     * @return a new BasketCriteria with the nested criteria added
     */
    public BasketCriteria withNestedCriteria(BasketCriteria criteria) {
        List<BasketCriteria> newNested = new ArrayList<>(this.nestedCriteria);
    ...
    public boolean equals(Object o) {
        ...
        BasketCriteria that = (BasketCriteria) o;
    ...
    public static class Builder {
        ...
        private List<BasketCriteria> nestedCriteria;
        ...
        public Builder nestedCriteria(List<BasketCriteria> nestedCriteria) {
            this.nestedCriteria = nestedCriteria;
            return this;
        }

        public Builder addNestedCriteria(BasketCriteria criteria) {
        ...
        public BasketCriteria build() {
            return new BasketCriteria(this);
        }
    }
