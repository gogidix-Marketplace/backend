package com.gogidix.aiservices.anomalydetectionservice.infrastructure.config;
...
public class AnomalyDetectionSloConfig {
    ...
    public long getLatencyThreshold(String sloName, String thresholdType) {
        ...
        return 2000L; // Default 2 seconds for anomaly detection
    }
    ...
    public static class SloDefinition {
        ...
        public Map<String, Object> getObjective() { return objective; }
        public void setObjective(Map<String, Object> objective) { this.objective = objective; }
