...
class CountryMetricsDto_SalesChannelMetricsDtoTest {

        @Test
    void testBuilder() {
        CountryMetricsDto.SalesChannelMetricsDto dto = CountryMetricsDto.SalesChannelMetricsDto.builder()
    ...
    void testSettersAndGetters() {
        CountryMetricsDto.SalesChannelMetricsDto dto = new CountryMetricsDto.SalesChannelMetricsDto();
    ...
    void testEqualsAndHashCode() {
        CountryMetricsDto.SalesChannelMetricsDto dto1 = CountryMetricsDto.SalesChannelMetricsDto.builder()
                        .onlineRevenue(BigDecimal.TEN)
            .offlineRevenue(BigDecimal.TEN)
            .marketplaceRevenue(BigDecimal.TEN)
            .b2bRevenue(BigDecimal.TEN)
            ...
            .marketplaceOrders(42L)
            .build();
        CountryMetricsDto.SalesChannelMetricsDto dto2 = CountryMetricsDto.SalesChannelMetricsDto.builder()
                        .onlineRevenue(BigDecimal.TEN)
            .offlineRevenue(BigDecimal.TEN)
            .marketplaceRevenue(BigDecimal.TEN)
            .b2bRevenue(BigDecimal.TEN)
