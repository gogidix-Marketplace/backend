...
class ComplianceReportGeneratorTest {
    ...
    class ReportGenerationTests {
        ...
        void shouldPopulateSloComplianceSection() {
            Timer segmentationTimer = meterRegistry.timer("segmentation.duration", "service", "ai-churn-predictionation");
            ...
            Counter totalCounter = meterRegistry.counter("segmentation.total", "service", "ai-churn-predictionation");
            Counter failureCounter = meterRegistry.counter("segmentation.failure", "service", "ai-churn-predictionation");
        ...
        void shouldPopulatePerformanceMetricsSection() {
            Counter totalCounter = meterRegistry.counter("segmentation.total", "service", "ai-churn-predictionation");
            Counter successCounter = meterRegistry.counter("segmentation.success", "service", "ai-churn-predictionation");
            Counter failureCounter = meterRegistry.counter("segmentation.failure", "service", "ai-churn-predictionation");
            Counter createdCounter = meterRegistry.counter("segment.created", "service", "ai-churn-predictionation");
            Counter updatedCounter = meterRegistry.counter("segment.updated", "service", "ai-churn-predictionation");
            Counter analyzedCounter = meterRegistry.counter("customer.analyzed", "service", "ai-churn-predictionation");
            ...
            assertThat(perf.getTotalPredictions()).isEqualTo(5000L);
            assertThat(perf.getSuccessfulPredictions()).isEqualTo(4750L);
            assertThat(perf.getFailedPredictions()).isEqualTo(250L);
            assertThat(perf.getPredictionsCreated()).isEqualTo(100L);
            assertThat(perf.getPredictionsUpdated()).isEqualTo(50L);
    ...
    private void recordGoodMetrics() {
        ...
        Timer analysisTimer = meterRegistry.timer("segment.analysis.duration", "service", "ai-churn-predictionation");
