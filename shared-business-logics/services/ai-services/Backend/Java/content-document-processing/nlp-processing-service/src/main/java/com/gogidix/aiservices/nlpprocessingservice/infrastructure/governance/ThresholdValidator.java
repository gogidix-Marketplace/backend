...
public class ThresholdValidator {
    ...
    // Threshold definitions for Content Processing - NLP
    ...
    public ThresholdValidator(NlpProcessingMetrics metrics) {
    ...
    public ComplianceReport validateAllThresholds() {
        ...
        // Validate NLP analysis latency
        double analysisLatency = metrics.getAnalysisLatencyP95();
        boolean analysisCompliant = analysisLatency <= MAX_ANALYSIS_LATENCY_MS;
        report.addCheck("NLP Analysis Latency", analysisLatency, MAX_ANALYSIS_LATENCY_MS, analysisCompliant);
