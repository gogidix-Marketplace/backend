...
class GovernanceGenTest {
    ...
    @BeforeEach
    void setup() {
        metrics = new EmailOptimizationMetrics(new SimpleMeterRegistry());
    ...
    @Test
    void validate_AI_ANALYSIS_LATENCY() {
        var r = validator.validateThreshold(ThresholdValidator.ThresholdType.AI_ANALYSIS_LATENCY);
        assertThat(r).isNotNull();
    }
