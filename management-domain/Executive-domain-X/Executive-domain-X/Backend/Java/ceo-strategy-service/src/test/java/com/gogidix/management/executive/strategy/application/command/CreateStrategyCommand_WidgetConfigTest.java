...
class CreateStrategyCommand_WidgetConfigTest {

        @Test
    void testBuilder() {
        CreateStrategyCommand.WidgetConfig dto = CreateStrategyCommand.WidgetConfig.builder()
                        .name("test-name")
            .type("test-type")
            .position(42)
            .row(42)
    ...
    void testSettersAndGetters() {
        CreateStrategyCommand.WidgetConfig dto = new CreateStrategyCommand.WidgetConfig();
    ...
    void testEqualsAndHashCode() {
        CreateStrategyCommand.WidgetConfig dto1 = CreateStrategyCommand.WidgetConfig.builder()
                        .name("test-name")
            .type("test-type")
            .position(42)
            .row(42)
            ...
            .dataSource("test-dataSource")
            .build();
        CreateStrategyCommand.WidgetConfig dto2 = CreateStrategyCommand.WidgetConfig.builder()
                        .name("test-name")
            .type("test-type")
            .position(42)
            .row(42)
