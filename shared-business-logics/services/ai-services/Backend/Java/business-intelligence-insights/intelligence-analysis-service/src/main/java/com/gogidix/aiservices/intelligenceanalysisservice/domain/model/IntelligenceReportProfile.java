 ...
 */
public class IntelligenceReportProfile {
    ...
    // Private constructor
    private IntelligenceReportProfile(Builder builder) {
        ...
        if (customerId != null && customerId.isEmpty()) {
            throw new NullPointerException("customerId is required");
        }
        if (tenantId != null && tenantId.isEmpty()) {
            throw new NullPointerException("tenantId is required");
        }
    ...
    // Getters
    public String getIntelligenceReportId() {
        return customerId;
    }
    ...
    public boolean equals(Object o) {
        ...
        IntelligenceReportProfile that = (IntelligenceReportProfile) o;
    ...
    public String toString() {
        return "IntelligenceReportProfile{" +
    ...
    /**
     * Builder for IntelligenceReportProfile.
     */
    public static class Builder {
        ...
        public IntelligenceReportProfile build() {
            return new IntelligenceReportProfile(this);
        }
    }
}
