...
public class ComplianceReportGenerator {
    ...
    private PerformanceMetricsSection generatePerformanceSection() {
        ...
        section.setTotalRequests((long) metrics.getMeterRegistry()
                .get("ai.personalization.total").counter().count());
        section.setSuccessfulRequests((long) metrics.getMeterRegistry()
                .get("ai.personalization.success").counter().count());
        section.setFailedRequests((long) metrics.getMeterRegistry()
                .get("ai.personalization.failure").counter().count());
        section.setRecommendationsGenerated((long) metrics.getMeterRegistry()
                .get("ai.personalization.recommendations").counter().count());
        section.setUserProfilesMatched((long) metrics.getMeterRegistry()
                .get("ai.personalization.profiles.matched").counter().count());
    ...
    public static class GovernanceReport {
        ...
        private Map<String, Object> performanceMetricsToMap() {
            ...
            map.put("recommendationsGenerated", performanceMetrics.getRecommendationsGenerated());
            return map;
        }
    ...
    public static class PerformanceMetricsSection {
        ...
        private long userProfilesMatched;
        ...
        public long getUserProfilesMatched() { return userProfilesMatched; }
        public void setUserProfilesMatched(long userProfilesMatched) { this.userProfilesMatched = userProfilesMatched; }
