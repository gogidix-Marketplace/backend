package com.gogidix.shared.multitenancy.interceptor;
 ...
 * and populates the TenantContextHolder for the current request.
 * </p>
 *
 * Expected headers:
...
public class TenantInterceptor implements HandlerInterceptor {
    ...
    public boolean preHandle(HttpServletRequest request, HttpServletResponse response, Object handler) {
        ...
        if (domain != null && !domain.isEmpty()) {
            TenantContextHolder.setDomain(domain);
        }
        ...
        if (correlationId != null && !correlationId.isEmpty()) {
            ...
            TenantContextHolder.setCorrelationId(generateCorrelationId());
        }
        ...
        if (userRoles != null && !userRoles.isEmpty()) {
            TenantContextHolder.setUserRoles(userRoles);
        }
