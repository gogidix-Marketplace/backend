...
class GovernanceGenTest {
    ...
    @BeforeEach
    void setup() {
        metrics = new TranslationMetrics(new SimpleMeterRegistry());
    ...
    @Test
    void validate_DETECTION_LATENCY() {
        var r = validator.validateThreshold(ThresholdValidator.ThresholdType.DETECTION_LATENCY);
        assertThat(r).isNotNull();
    }
