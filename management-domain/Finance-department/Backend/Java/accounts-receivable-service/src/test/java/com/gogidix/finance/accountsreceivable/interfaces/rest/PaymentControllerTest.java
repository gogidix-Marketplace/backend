...
import com.gogidix.finance.accountsreceivable.interfaces.rest.PaymentController;
...
class PaymentControllerTest {
    ...
    @Test
    void createPayment___callsService() {
        try {
            underTest.createPayment(null);
        } catch (Throwable e) {
    ...
    @Test
    void getAllPayments___callsService() {
        try {
