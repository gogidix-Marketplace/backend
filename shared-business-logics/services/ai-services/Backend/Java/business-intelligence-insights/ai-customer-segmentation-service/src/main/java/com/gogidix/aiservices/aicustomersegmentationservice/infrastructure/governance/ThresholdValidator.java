...
public class ThresholdValidator {
    ...
    public ThresholdValidator(CustomerSegmentationMetrics metrics) {
    ...
    public ComplianceReport validateAllThresholds() {
        ...
        double analysisLatency = metrics.getSegmentAnalysisLatencyP95();
        boolean analysisCompliant = analysisLatency <= MAX_ANALYSIS_LATENCY_MS;
        report.addCheck("Segment Analysis Latency", analysisLatency, MAX_ANALYSIS_LATENCY_MS, analysisCompliant);
    ...
    public ThresholdValidation validateThreshold(ThresholdType type) {
        return switch (type) {
            ...
            case SEGMENT_ANALYSIS_LATENCY -> {
                double value = metrics.getSegmentAnalysisLatencyP95();
