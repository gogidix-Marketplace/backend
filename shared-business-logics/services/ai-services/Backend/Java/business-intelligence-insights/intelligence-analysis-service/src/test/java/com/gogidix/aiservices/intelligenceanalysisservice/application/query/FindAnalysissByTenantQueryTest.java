...
/**
 * Unit tests for FindAnalysissByTenantQuery.
 */
@DisplayName("FindAnalysissByTenantQuery Tests")
class FindAnalysissByTenantQueryTest {
    ...
    class CreationTests {
        ...
        void shouldCreateWithRequiredParametersOnly() {
            FindAnalysissByTenantQuery query = FindAnalysissByTenantQuery.create(TENANT_ID);
        ...
        void shouldCreateWithAllParameters() {
            FindAnalysissByTenantQuery query = new FindAnalysissByTenantQuery(
                    TENANT_ID, AnalysisType.BEHAVIORAL, true, 1, 50, "name", "ASC"
            );

            assertEquals(TENANT_ID, query.tenantId());
            assertEquals(AnalysisType.BEHAVIORAL, query.segmentType());
        ...
        void shouldAcceptValidSortDirectionValues() {
            FindAnalysissByTenantQuery ascQuery = new FindAnalysissByTenantQuery(
                    TENANT_ID, null, null, 0, 20, "createdAt", "ASC"
            );
            FindAnalysissByTenantQuery descQuery = new FindAnalysissByTenantQuery(
    ...
    class ValidationTests {
        ...
        void shouldThrowWhenTenantIdIsNull() {
            assertThrows(IllegalArgumentException.class,
                    () -> new FindAnalysissByTenantQuery(null, null, null, 0, 20, "createdAt", "DESC"));
        }
        ...
        void shouldThrowWhenTenantIdIsBlank() {
            assertThrows(IllegalArgumentException.class,
                    () -> new FindAnalysissByTenantQuery("   ", null, null, 0, 20, "createdAt", "DESC"));
        }
        ...
        void shouldThrowWhenPageIsNegative() {
            assertThrows(IllegalArgumentException.class,
                    () -> new FindAnalysissByTenantQuery(TENANT_ID, null, null, -1, 20, "createdAt", "DESC"));
        }
        ...
        void shouldThrowWhenSizeIsLessThan1() {
            assertThrows(IllegalArgumentException.class,
                    () -> new FindAnalysissByTenantQuery(TENANT_ID, null, null, 0, 0, "createdAt", "DESC"));
        }
        ...
        void shouldThrowWhenSizeExceedsMaximum() {
            assertThrows(IllegalArgumentException.class,
                    () -> new FindAnalysissByTenantQuery(TENANT_ID, null, null, 0, 101, "createdAt", "DESC"));
        }
    }
