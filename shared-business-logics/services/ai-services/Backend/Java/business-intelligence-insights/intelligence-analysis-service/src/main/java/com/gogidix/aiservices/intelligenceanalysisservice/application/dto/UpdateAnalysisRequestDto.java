...
public record UpdateAnalysisRequestDto(

        @Schema(description = "Updated name of the segment", example = "Premium IntelligenceReports")
        @Size(max = 100, message = "name must not exceed 100 characters")
        String name,

        @Schema(description = "Updated description of the segment", example = "IntelligenceReports with lifetime value > $25,000")
