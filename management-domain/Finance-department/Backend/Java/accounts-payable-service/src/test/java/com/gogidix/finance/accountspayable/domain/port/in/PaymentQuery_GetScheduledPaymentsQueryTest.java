...
class PaymentQuery_GetScheduledPaymentsQueryTest {

        @Test
    void testSettersAndGetters() {
        PaymentQuery.GetScheduledPaymentsQuery dto = new PaymentQuery.GetScheduledPaymentsQuery();
    ...
    void testEqualsAndHashCode() {
        PaymentQuery.GetScheduledPaymentsQuery dto1 = new PaymentQuery.GetScheduledPaymentsQuery();
        PaymentQuery.GetScheduledPaymentsQuery dto2 = new PaymentQuery.GetScheduledPaymentsQuery();
