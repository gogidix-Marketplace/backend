...
class LoyaltyServiceTest {
    ...
    @Mock private LoyaltyRepository repository;
    @Mock private LoyaltyMapper mapper;
    private LoyaltyService service;

    @BeforeEach
    void setUp() {
        service = new LoyaltyService(repository, mapper);
    ...
    void shouldGetById() {
        ...
        when(mapper.toResponse(entity)).thenReturn(
            new LoyaltyResponse("id-1", "test", null, null, null, null, null, true, null, null));
    ...
    void shouldCreate() {
        ...
        when(mapper.toResponse(any())).thenReturn(
            new LoyaltyResponse("id-1", "test", null, null, null, null, null, true, null, null));
        assertThat(service.create(new CreateLoyaltyRequest("test", null, null, null, null, null))).isNotNull();
    }
    ...
    void shouldUpdate() {
        ...
        when(repository.save(any())).thenReturn(entity);
        when(mapper.toResponse(any())).thenReturn(
            new LoyaltyResponse("id-1", "updated", null, null, null, null, null, true, null, null));
        assertThat(service.update("id-1", new UpdateLoyaltyRequest("updated", null, null, null, null, null, null))).isNotNull();
    }
