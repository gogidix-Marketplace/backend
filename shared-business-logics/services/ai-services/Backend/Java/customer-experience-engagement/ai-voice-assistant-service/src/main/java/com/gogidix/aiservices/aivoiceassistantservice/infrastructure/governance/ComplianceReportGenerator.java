...
public class ComplianceReportGenerator {
    ...
    private PerformanceMetricsSection generatePerformanceSection() {
        ...
        section.setTotalRequests((long) metrics.getMeterRegistry()
                .get("ai.voice.assistant.total").counter().count());
        section.setSuccessfulRequests((long) metrics.getMeterRegistry()
                .get("ai.voice.assistant.success").counter().count());
        section.setFailedRequests((long) metrics.getMeterRegistry()
                .get("ai.voice.assistant.failure").counter().count());
        section.setVoiceCommandsProcessed((long) metrics.getMeterRegistry()
                .get("ai.voice.assistant.commands.processed").counter().count());
    ...
    public static class PerformanceMetricsSection {
        ...
        private long voiceCommandsProcessed;
        ...
        public long getVoiceCommandsProcessed() { return voiceCommandsProcessed; }
        public void setVoiceCommandsProcessed(long voiceCommandsProcessed) { this.voiceCommandsProcessed = voiceCommandsProcessed; }
