package com.gogidix.ecommerce.pricing.catalog.infrastructure.config;
...
public class OpenApiConfig {
    @Bean
    public OpenAPI catalogPricingServiceOpenAPI() {
        return new OpenAPI()
                .info(new Info()
                        .title("Catalog Pricing Service API")
                        .description("REST API for catalog pricing in the Gogidix E-commerce platform")
                        .version("1.0.0")
                ...
                .servers(List.of(
                        new Server().url("http://localhost:8005").description("Development"),
