...
import com.gogidix.globalbusinessmanagement.batchaggregation.interfaces.rest.BatchAggregationController;
...
class BatchAggregationControllerTest {

    @Mock
    private BatchAggregationService service;

    @InjectMocks
    private BatchAggregationController underTest;
