package com.gogidix.aiservices.aimarketbasketanalysisservice.security;
...
class SecurityValidationTest {
    ...
    class TenantIsolationTests {
        ...
        void shouldIsolateBasketsByTenant() {
            String tenant1 = "tenant-1";
            String tenant2 = "tenant-2";

            // Baskets for tenant1 should not affect tenant2
    ...
    class ResourceLimitsTests {
        ...
        void shouldEnforceBasketResultLimit() {
