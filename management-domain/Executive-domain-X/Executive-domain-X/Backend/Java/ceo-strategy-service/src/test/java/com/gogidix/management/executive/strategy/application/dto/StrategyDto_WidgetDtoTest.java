...
class StrategyDto_WidgetDtoTest {

        @Test
    void testBuilder() {
        StrategyDto.WidgetDto dto = StrategyDto.WidgetDto.builder()
                        .id("test-id")
            .name("test-name")
            .type(null)
            .position(42)
    ...
    void testSettersAndGetters() {
        StrategyDto.WidgetDto dto = new StrategyDto.WidgetDto();
        dto.setId("val-id");
    ...
    void testEqualsAndHashCode() {
        StrategyDto.WidgetDto dto1 = StrategyDto.WidgetDto.builder()
                        .id("test-id")
            .name("test-name")
            .type(null)
            .position(42)
            ...
            .dataSource("test-dataSource")
            .build();
        StrategyDto.WidgetDto dto2 = StrategyDto.WidgetDto.builder()
                        .id("test-id")
            .name("test-name")
            .type(null)
            .position(42)
