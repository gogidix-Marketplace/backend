package com.gogidix.aiservices.aiproductrecommendationservice.infrastructure.persistence.document;
...
/**
 * MongoDB document for ProductRecommendation.
 */
@Document(collection = "product_recommendations")
public record ProductRecommendationDocument(
    ...
    public ProductRecommendationDocument {
        if (customerIds == null) {
    ...
    /**
     * Create a new ProductRecommendationDocument.
     */
    public static ProductRecommendationDocument create(
            String id,
            String name,
            String description,
            RecommendationType segmentType,
     ...
     */
    public ProductRecommendationDocument withProductCount(int count) {
        return new ProductRecommendationDocument(
