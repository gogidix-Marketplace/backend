...
class CountryMetricsDto_OperationalMetricsDtoTest {

        @Test
    void testBuilder() {
        CountryMetricsDto.OperationalMetricsDto dto = CountryMetricsDto.OperationalMetricsDto.builder()
    ...
    void testSettersAndGetters() {
        CountryMetricsDto.OperationalMetricsDto dto = new CountryMetricsDto.OperationalMetricsDto();
    ...
    void testEqualsAndHashCode() {
        CountryMetricsDto.OperationalMetricsDto dto1 = CountryMetricsDto.OperationalMetricsDto.builder()
                        .inventoryTurnover(BigDecimal.TEN)
            .fulfillmentRate(BigDecimal.TEN)
            .onTimeDeliveryRate(BigDecimal.TEN)
            .returnRate(BigDecimal.TEN)
            ...
            .firstContactResolution(BigDecimal.TEN)
            .build();
        CountryMetricsDto.OperationalMetricsDto dto2 = CountryMetricsDto.OperationalMetricsDto.builder()
                        .inventoryTurnover(BigDecimal.TEN)
            .fulfillmentRate(BigDecimal.TEN)
            .onTimeDeliveryRate(BigDecimal.TEN)
            .returnRate(BigDecimal.TEN)
