package com.gogidix.aiservices.airecommendationservice.infrastructure.governance;

import com.gogidix.aiservices.airecommendationservice.infrastructure.metrics.RecommendationMetrics;
...
public class ComplianceReportGenerator {
    ...
    // SLO Targets for Customer Experience - Recommendation Service
    ...
    private SloComplianceSection generateSloComplianceSection() {
        ...
        section.setP99LatencyCompliant(p99Latency <= 500.0);
    ...
    private PerformanceMetricsSection generatePerformanceSection() {
        ...
        section.setTotalRequests((long) metrics.getMeterRegistry()
                .get("recommendation.total").counter().count());

        section.setSuccessfulRequests((long) metrics.getMeterRegistry()
                .get("recommendation.success").counter().count());

        section.setFailedRequests((long) metrics.getMeterRegistry()
                .get("recommendation.failure").counter().count());

        section.setSimilarItemsRequests((long) metrics.getMeterRegistry()
                .get("recommendation.similar.total").counter().count());

        section.setTrendingItemsRequests((long) metrics.getMeterRegistry()
                .get("recommendation.trending.total").counter().count());

        section.setInteractionsTracked((long) metrics.getMeterRegistry()
                .get("recommendation.interaction.total").counter().count());
    ...
    public static class GovernanceReport {
        ...
        private Map<String, Object> performanceMetricsToMap() {
            ...
            map.put("similarItemsRequests", performanceMetrics.getSimilarItemsRequests());
            map.put("trendingItemsRequests", performanceMetrics.getTrendingItemsRequests());
            return map;
        }
    ...
    public static class PerformanceMetricsSection {
        ...
        private long similarItemsRequests;
        private long trendingItemsRequests;
        private long interactionsTracked;
        ...
        public long getSimilarItemsRequests() { return similarItemsRequests; }
        public void setSimilarItemsRequests(long similarItemsRequests) { this.similarItemsRequests = similarItemsRequests; }
        public long getTrendingItemsRequests() { return trendingItemsRequests; }
        public void setTrendingItemsRequests(long trendingItemsRequests) { this.trendingItemsRequests = trendingItemsRequests; }
        public long getInteractionsTracked() { return interactionsTracked; }
        public void setInteractionsTracked(long interactionsTracked) { this.interactionsTracked = interactionsTracked; }
