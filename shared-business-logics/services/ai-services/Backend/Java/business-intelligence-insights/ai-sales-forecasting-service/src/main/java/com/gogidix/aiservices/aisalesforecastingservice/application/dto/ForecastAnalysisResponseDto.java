...
public record ForecastAnalysisResponseDto(

        @Schema(description = "Forecast identifier", example = "seg_1234567890abcdef")
        String segmentId,
        ...
        int totalForecastModels,

        @Schema(description = "ForecastModel demographics breakdown")
    ...
    /**
     * Get the customer count (alias for totalForecastModels for test compatibility).
     * @return the total number of customers analyzed
     */
    public int customerCount() {
        return totalForecastModels;
    }
}
