...
class InteractionCommand_CreateInteractionCommandTest {

        @Test
    void testSettersAndGetters() {
        InteractionCommand.CreateInteractionCommand dto = new InteractionCommand.CreateInteractionCommand();
    ...
    void testEqualsAndHashCode() {
        InteractionCommand.CreateInteractionCommand dto1 = new InteractionCommand.CreateInteractionCommand();
        InteractionCommand.CreateInteractionCommand dto2 = new InteractionCommand.CreateInteractionCommand();
