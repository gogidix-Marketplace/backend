...
@DisplayName("RewardMapper Tests")
class RewardMapperTest {

    private RewardMapper mapper;

    @BeforeEach
    void setUp() { mapper = new RewardMapper(); }
    ...
    void shouldMapToResponse() {
        ...
        RewardResponse response = mapper.toResponse(entity);
    ...
    void shouldMapToEntity() {
        CreateRewardRequest request = new CreateRewardRequest("test", "desc", "type", null, null, null);
    ...
    void shouldUpdateFromRequest() {
        Reward entity = new Reward("tenant-1");
        entity.setName("old");
        UpdateRewardRequest request = new UpdateRewardRequest("new", "desc", null, null, null, null, null);
    ...
    void shouldSkipNullFields() {
        ...
        UpdateRewardRequest request = new UpdateRewardRequest(null, null, null, null, null, null, null);
        mapper.updateFromRequest(entity, request);
