...
/**
 * Unit tests for FindSegmentsByTenantQuery.
 */
@DisplayName("FindSegmentsByTenantQuery Tests")
class FindSegmentsByTenantQueryTest {
    ...
    class CreationTests {
        ...
        void shouldCreateWithRequiredParametersOnly() {
            FindSegmentsByTenantQuery query = FindSegmentsByTenantQuery.create(TENANT_ID);
        ...
        void shouldCreateWithAllParameters() {
            FindSegmentsByTenantQuery query = new FindSegmentsByTenantQuery(
                    TENANT_ID, SegmentType.BEHAVIORAL, true, 1, 50, "name", "ASC"
            );

            assertEquals(TENANT_ID, query.tenantId());
            assertEquals(SegmentType.BEHAVIORAL, query.segmentType());
        ...
        void shouldAcceptValidSortDirectionValues() {
            FindSegmentsByTenantQuery ascQuery = new FindSegmentsByTenantQuery(
                    TENANT_ID, null, null, 0, 20, "createdAt", "ASC"
            );
            FindSegmentsByTenantQuery descQuery = new FindSegmentsByTenantQuery(
    ...
    class ValidationTests {
        ...
        void shouldThrowWhenTenantIdIsNull() {
            assertThrows(IllegalArgumentException.class,
                    () -> new FindSegmentsByTenantQuery(null, null, null, 0, 20, "createdAt", "DESC"));
        }
        ...
        void shouldThrowWhenTenantIdIsBlank() {
            assertThrows(IllegalArgumentException.class,
                    () -> new FindSegmentsByTenantQuery("   ", null, null, 0, 20, "createdAt", "DESC"));
        }
        ...
        void shouldThrowWhenPageIsNegative() {
            assertThrows(IllegalArgumentException.class,
                    () -> new FindSegmentsByTenantQuery(TENANT_ID, null, null, -1, 20, "createdAt", "DESC"));
        }
        ...
        void shouldThrowWhenSizeIsLessThan1() {
            assertThrows(IllegalArgumentException.class,
                    () -> new FindSegmentsByTenantQuery(TENANT_ID, null, null, 0, 0, "createdAt", "DESC"));
        }
        ...
        void shouldThrowWhenSizeExceedsMaximum() {
            assertThrows(IllegalArgumentException.class,
                    () -> new FindSegmentsByTenantQuery(TENANT_ID, null, null, 0, 101, "createdAt", "DESC"));
        }
    }
