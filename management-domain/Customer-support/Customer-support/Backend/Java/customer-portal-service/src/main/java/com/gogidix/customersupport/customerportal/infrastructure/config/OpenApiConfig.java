...
public class OpenApiConfig {
    ...
    public OpenAPI customerPortalOpenAPI() {
        ...
        server.setUrl("http://localhost:8106");
        ...
        Info info = new Info()
                .title("Customer Portal Service API")
                .version("1.0.0")
                .description("RESTful APIs for customer self-service portal with profile management and ticket history tracking")
                .contact(contact)
                .license(license);
