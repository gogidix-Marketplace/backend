...
@DisplayName("SearchValidationPolicy Tests")
class SearchValidationPolicyTest {

    private SearchValidationPolicy policy;

    @BeforeEach
    void setUp() { policy = new SearchValidationPolicy(); }
