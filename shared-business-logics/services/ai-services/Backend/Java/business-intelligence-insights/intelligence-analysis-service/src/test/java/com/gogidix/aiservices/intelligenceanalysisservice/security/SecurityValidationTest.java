package com.gogidix.aiservices.intelligenceanalysisservice.security;
...
class SecurityValidationTest {
    ...
    class InputValidationTests {
        ...
        void shouldRejectNullIntelligenceReportId() {
            assertThatThrownBy(() -> {
                if (null == null) {
                    throw new IllegalArgumentException("IntelligenceReport ID cannot be null");
                }
    ...
    class TenantIsolationTests {
        ...
        @Test
        @Order(10)
        @DisplayName("Should isolate segments by tenant")
        void shouldIsolateAnalysissByTenant() {
            String tenant1 = "tenant-1";
            String tenant2 = "tenant-2";

            // Analysiss for tenant1 should not affect tenant2
    ...
    class ResourceLimitsTests {
        ...
        @Test
        @Order(20)
        @DisplayName("Should enforce segment result limit")
        void shouldEnforceAnalysisResultLimit() {
    ...
    class AuthenticationContextTests {
        ...
        void shouldPreventUnauthorizedCrossTenantAccess() {
            ...
            // Attempting segmentation from different tenant context
            assertThat(tenant1).isNotEqualTo(tenant2);
        }
    }
}
