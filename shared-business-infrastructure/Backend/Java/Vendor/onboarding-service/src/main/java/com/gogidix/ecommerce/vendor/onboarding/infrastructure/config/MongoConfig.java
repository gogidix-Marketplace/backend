...
@Configuration
@EnableMongoRepositories(basePackages = "com.gogidix.ecommerce.vendor.onboarding.domain.repository")
public class MongoConfig extends AbstractMongoClientConfiguration {
    @Override protected String getDatabaseName() { return "gogidix_onboarding"; }
