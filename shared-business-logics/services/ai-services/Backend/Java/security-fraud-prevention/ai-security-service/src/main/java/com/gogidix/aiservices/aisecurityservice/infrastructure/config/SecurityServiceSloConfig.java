package com.gogidix.aiservices.aisecurityservice.infrastructure.config;
...
public class SecurityServiceSloConfig {
    ...
    public long getLatencyThreshold(String sloName, String thresholdType) {
        ...
        return 1000L; // Default 1 second for encryption operations
    }
