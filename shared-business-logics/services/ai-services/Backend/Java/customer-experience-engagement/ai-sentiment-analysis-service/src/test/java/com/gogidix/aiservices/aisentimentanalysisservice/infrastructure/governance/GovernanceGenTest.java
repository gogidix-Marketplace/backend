...
class GovernanceGenTest {
    ...
    @BeforeEach
    void setup() {
        metrics = new SentimentAnalysisMetrics(new SimpleMeterRegistry());
    ...
    @Test
    void validate_AI_INFERENCE_LATENCY() {
        var r = validator.validateThreshold(ThresholdValidator.ThresholdType.AI_INFERENCE_LATENCY);
        assertThat(r).isNotNull();
    }
