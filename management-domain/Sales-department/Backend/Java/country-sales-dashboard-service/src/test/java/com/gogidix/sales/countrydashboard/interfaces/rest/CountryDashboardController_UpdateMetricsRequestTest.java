...
class CountryDashboardController_UpdateMetricsRequestTest {

        @Test
    void testSettersAndGetters() {
        CountryDashboardController.UpdateMetricsRequest dto = new CountryDashboardController.UpdateMetricsRequest();
    ...
    void testEqualsAndHashCode() {
        CountryDashboardController.UpdateMetricsRequest dto1 = new CountryDashboardController.UpdateMetricsRequest();
        CountryDashboardController.UpdateMetricsRequest dto2 = new CountryDashboardController.UpdateMetricsRequest();
