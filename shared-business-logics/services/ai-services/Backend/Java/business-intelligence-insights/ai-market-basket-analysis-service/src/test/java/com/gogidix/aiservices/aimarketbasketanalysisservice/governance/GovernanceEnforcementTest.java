...
import com.gogidix.aiservices.aimarketbasketanalysisservice.infrastructure.governance.ComplianceReportGenerator;
...
class GovernanceEnforcementTest {
        ...
        void shouldValidateP95LatencyThreshold() {
            ...
            for (int i = 0; i < 20; i++) {
                try {
                    ...
                    metrics.recordAnalysisTime(100 + (i * 10));
                } catch (Exception e) {
                    // Ignore
                }
            }
    ...
    class ComplianceReportTests {
        ...
        void shouldIncludePerformanceMetricsSection() {
            ...
            assertThat(perf.getTotalAnalyses()).isGreaterThanOrEqualTo(0);
            assertThat(perf.getSuccessfulAnalyses()).isGreaterThanOrEqualTo(0);
        }
