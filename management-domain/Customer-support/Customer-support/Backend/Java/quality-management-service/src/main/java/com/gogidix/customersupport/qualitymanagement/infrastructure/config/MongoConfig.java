...
/**
 * MongoDB Configuration for Quality Management Service
 */
@Configuration
@EnableMongoRepositories(basePackages = {
        "com.gogidix.customersupport.qualitymanagement.domain.repository"
})
...
public class MongoConfig {
    ...
    @Value("${spring.data.mongodb.database:quality_management_db}")
