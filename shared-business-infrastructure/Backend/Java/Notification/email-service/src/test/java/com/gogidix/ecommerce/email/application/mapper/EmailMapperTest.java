...
class EmailMapperTest {
    ...
    @BeforeEach
    void setUp() { mapper = new EmailMapper(); }
    ...
    void shouldMapToResponse() {
        ...
        EmailResponse response = mapper.toResponse(entity);
    ...
    void shouldMapToEntity() {
        CreateEmailRequest request = new CreateEmailRequest("test", "desc", "type", null, null, null);
    ...
    void shouldUpdateFromRequest() {
        Email entity = new Email("tenant-1");
        entity.setName("old");
        UpdateEmailRequest request = new UpdateEmailRequest("new", "desc", null, null, null, null, null);
    ...
    void shouldSkipNullFields() {
        ...
        UpdateEmailRequest request = new UpdateEmailRequest(null, null, null, null, null, null, null);
        mapper.updateFromRequest(entity, request);
