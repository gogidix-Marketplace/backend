...
public record SegmentSearchRequestDto(
    ...
    public SegmentSearchRequestDto {
    ...
    public static SegmentSearchRequestDto create() {
        return new SegmentSearchRequestDto(null, null, 0, 20, "createdAt", "DESC");
    }
}
