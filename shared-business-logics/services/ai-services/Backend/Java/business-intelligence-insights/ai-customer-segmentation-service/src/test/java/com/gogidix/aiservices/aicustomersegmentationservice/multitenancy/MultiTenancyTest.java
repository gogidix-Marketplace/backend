package com.gogidix.aiservices.aicustomersegmentationservice.multitenancy;
...
class MultiTenancyTest {
    ...
    class CrossTenantAccessTests {
        ...
        void shouldPreventCrossTenantSegmentAccess() {
    ...
    class TenantQuotaTests {
        ...
        void shouldEnforcePerTenantSegmentLimits() {
