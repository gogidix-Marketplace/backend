...
@DisplayName("InventoryValidationPolicy Tests")
class InventoryValidationPolicyTest {

    private InventoryValidationPolicy policy;

    @BeforeEach
    void setUp() { policy = new InventoryValidationPolicy(); }
