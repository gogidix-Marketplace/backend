...
import com.gogidix.aiservices.aiproductrecommendationservice.infrastructure.governance.ComplianceReportGenerator;
...
class GovernanceEnforcementTest {
    ...
    private ProductRecommendationApplicationService segmentApplicationService;
        ...
        void shouldValidateP95LatencyThreshold() {
            ...
            for (int i = 0; i < 20; i++) {
                try {
                    ...
                    metrics.recordRecommendationTime(100 + (i * 10));
                } catch (Exception e) {
                    // Ignore
                }
            }
    ...
    class ComplianceReportTests {
        ...
        void shouldIncludePerformanceMetricsSection() {
            ...
            for (int i = 0; i < 5; i++) {
                metrics.incrementRecommendationTotal();
                metrics.recordRecommendationTime(100);
            }
            ...
            assertThat(perf.getTotalRecommendations()).isGreaterThanOrEqualTo(0);
            assertThat(perf.getSuccessfulRecommendations()).isGreaterThanOrEqualTo(0);
        }
