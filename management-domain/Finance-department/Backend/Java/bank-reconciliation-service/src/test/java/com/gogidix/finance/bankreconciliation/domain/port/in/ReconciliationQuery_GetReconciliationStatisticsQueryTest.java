...
class ReconciliationQuery_GetReconciliationStatisticsQueryTest {

        @Test
    void testSettersAndGetters() {
        ReconciliationQuery.GetReconciliationStatisticsQuery dto = new ReconciliationQuery.GetReconciliationStatisticsQuery();
    ...
    void testEqualsAndHashCode() {
        ReconciliationQuery.GetReconciliationStatisticsQuery dto1 = new ReconciliationQuery.GetReconciliationStatisticsQuery();
        ReconciliationQuery.GetReconciliationStatisticsQuery dto2 = new ReconciliationQuery.GetReconciliationStatisticsQuery();
