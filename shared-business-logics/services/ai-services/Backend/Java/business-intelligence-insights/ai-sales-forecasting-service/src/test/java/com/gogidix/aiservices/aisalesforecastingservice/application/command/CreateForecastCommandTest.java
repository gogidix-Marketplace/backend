...
/**
 * Unit tests for CreateForecastCommand.
 */
@DisplayName("CreateForecastCommand Tests")
class CreateForecastCommandTest {

    private static final String NAME = "High Value ForecastModels";
    private static final String DESCRIPTION = "ForecastModels with high lifetime value";
    private static final ForecastType SEGMENT_TYPE = ForecastType.BEHAVIORAL;
    ...
    class CreationTests {
        ...
        void shouldThrowWhenNameIsNull() {
            assertThrows(IllegalArgumentException.class,
                    () -> new CreateForecastCommand(null, DESCRIPTION, SEGMENT_TYPE, CRITERIA, TENANT_ID, USER_ID));
        }
        ...
        void shouldThrowWhenNameIsBlank() {
            assertThrows(IllegalArgumentException.class,
                    () -> new CreateForecastCommand("   ", DESCRIPTION, SEGMENT_TYPE, CRITERIA, TENANT_ID, USER_ID));
        }
        ...
        void shouldThrowWhenNameExceedsMaxLength() {
            ...
            assertThrows(IllegalArgumentException.class,
                    () -> new CreateForecastCommand(longName, DESCRIPTION, SEGMENT_TYPE, CRITERIA, TENANT_ID, USER_ID));
        }
        ...
        void shouldThrowWhenDescriptionExceedsMaxLength() {
            ...
            assertThrows(IllegalArgumentException.class,
                    () -> new CreateForecastCommand(NAME, longDescription, SEGMENT_TYPE, CRITERIA, TENANT_ID, USER_ID));
        }

        @Test
        @DisplayName("Should throw when segmentType is null")
        void shouldThrowWhenForecastTypeIsNull() {
            assertThrows(IllegalArgumentException.class,
                    () -> new CreateForecastCommand(NAME, DESCRIPTION, null, CRITERIA, TENANT_ID, USER_ID));
        }
        ...
        void shouldThrowWhenCriteriaIsNull() {
            assertThrows(IllegalArgumentException.class,
                    () -> new CreateForecastCommand(NAME, DESCRIPTION, SEGMENT_TYPE, null, TENANT_ID, USER_ID));
        }
        ...
        void shouldThrowWhenCriteriaIsEmpty() {
            assertThrows(IllegalArgumentException.class,
                    () -> new CreateForecastCommand(NAME, DESCRIPTION, SEGMENT_TYPE, Map.of(), TENANT_ID, USER_ID));
        }
        ...
        void shouldThrowWhenTenantIdIsNull() {
            assertThrows(IllegalArgumentException.class,
                    () -> new CreateForecastCommand(NAME, DESCRIPTION, SEGMENT_TYPE, CRITERIA, null, USER_ID));
        }
        ...
        void shouldThrowWhenTenantIdIsBlank() {
            assertThrows(IllegalArgumentException.class,
                    () -> new CreateForecastCommand(NAME, DESCRIPTION, SEGMENT_TYPE, CRITERIA, "   ", USER_ID));
        }
    ...
    class BoundaryTests {
        ...
        void shouldAcceptNameWithExactly100Characters() {
            ...
            assertDoesNotThrow(() -> new CreateForecastCommand(
