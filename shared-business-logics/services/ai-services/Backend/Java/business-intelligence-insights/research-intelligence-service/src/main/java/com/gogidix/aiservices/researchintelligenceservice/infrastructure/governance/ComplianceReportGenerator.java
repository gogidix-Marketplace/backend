...
import com.gogidix.aiservices.researchintelligenceservice.infrastructure.metrics.ResearchIntelligenceMetrics;
...
public class ComplianceReportGenerator {
    ...
    private final ResearchIntelligenceMetrics metrics;
    private final ThresholdValidator thresholdValidator;

    // SLO Targets for Business Intelligence
    ...
    public ComplianceReportGenerator(
            ResearchIntelligenceMetrics metrics,
    ...
    private PerformanceMetricsSection generatePerformanceSection() {
        ...
        section.setTotalRequests((long) metrics.getMeterRegistry()
                .get("research.analysis.total").counter().count());

        section.setSuccessfulRequests((long) metrics.getMeterRegistry()
                .get("research.analysis.success").counter().count());

        section.setFailedRequests((long) metrics.getMeterRegistry()
                .get("research.analysis.failure").counter().count());

        section.setProjectsCreated((long) metrics.getMeterRegistry()
                .get("project.created").counter().count());

        section.setProjectsCompleted((long) metrics.getMeterRegistry()
                .get("project.completed").counter().count());

        section.setFindingsCreated((long) metrics.getMeterRegistry()
                .get("finding.created").counter().count());

        section.setPublicationsCreated((long) metrics.getMeterRegistry()
                .get("publication.created").counter().count());

        section.setDatasetsCreated((long) metrics.getMeterRegistry()
                .get("dataset.created").counter().count());
    ...
    public static class GovernanceReport {
        ...
        private Map<String, Object> performanceMetricsToMap() {
            ...
            map.put("projectsCreated", performanceMetrics.getProjectsCreated());
            map.put("projectsCompleted", performanceMetrics.getProjectsCompleted());
            return map;
        }
    ...
    public static class PerformanceMetricsSection {
        ...
        private long projectsUpdated;
        private long projectsStarted;
        private long projectsCompleted;
        private long projectsCancelled;
        private long findingsCreated;
        private long publicationsCreated;
        private long datasetsCreated;
        ...
        public long getProjectsCreated() { return projectsCreated; }
        public void setProjectsCreated(long projectsCreated) { this.projectsCreated = projectsCreated; }
        public long getProjectsUpdated() { return projectsUpdated; }
        public void setProjectsUpdated(long projectsUpdated) { this.projectsUpdated = projectsUpdated; }
        public long getProjectsStarted() { return projectsStarted; }
        public void setProjectsStarted(long projectsStarted) { this.projectsStarted = projectsStarted; }
        ...
        public long getProjectsCancelled() { return projectsCancelled; }
        public void setProjectsCancelled(long projectsCancelled) { this.projectsCancelled = projectsCancelled; }
        public long getFindingsCreated() { return findingsCreated; }
        public void setFindingsCreated(long findingsCreated) { this.findingsCreated = findingsCreated; }
        public long getPublicationsCreated() { return publicationsCreated; }
        public void setPublicationsCreated(long publicationsCreated) { this.publicationsCreated = publicationsCreated; }
        public long getDatasetsCreated() { return datasetsCreated; }
        public void setDatasetsCreated(long datasetsCreated) { this.datasetsCreated = datasetsCreated; }
