...
class TaxRateQuery_GetTaxRateHistoryQueryTest {

        @Test
    void testSettersAndGetters() {
        TaxRateQuery.GetTaxRateHistoryQuery dto = new TaxRateQuery.GetTaxRateHistoryQuery();
    ...
    void testEqualsAndHashCode() {
        TaxRateQuery.GetTaxRateHistoryQuery dto1 = new TaxRateQuery.GetTaxRateHistoryQuery();
        TaxRateQuery.GetTaxRateHistoryQuery dto2 = new TaxRateQuery.GetTaxRateHistoryQuery();
