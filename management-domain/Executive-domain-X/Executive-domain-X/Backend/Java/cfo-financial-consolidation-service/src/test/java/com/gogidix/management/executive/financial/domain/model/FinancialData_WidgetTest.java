...
class FinancialData_WidgetTest {

        @Test
    void testBuilder() {
        FinancialData.Widget dto = FinancialData.Widget.builder()
                        .id("test-id")
            .name("test-name")
            .type(FinancialData.Widget.WidgetType.KPI_CARD)
            .position(42)
            .row(42)
            .column(42)
            .width(42)
        ...
        assertEquals(FinancialData.Widget.WidgetType.KPI_CARD, dto.getType());
    ...
    void testSettersAndGetters() {
        FinancialData.Widget dto = new FinancialData.Widget();
        dto.setId("val-id");
        dto.setName("val-name");
        dto.setType(FinancialData.Widget.WidgetType.KPI_CARD);
        dto.setPosition(99);
        dto.setRow(99);
        dto.setColumn(99);
        dto.setWidth(99);
    ...
    void testEqualsAndHashCode() {
        FinancialData.Widget dto1 = FinancialData.Widget.builder()
                        .id("test-id")
            .name("test-name")
            .type(FinancialData.Widget.WidgetType.KPI_CARD)
            .position(42)
            ...
            .dataSource("test-dataSource")
            .build();
        FinancialData.Widget dto2 = FinancialData.Widget.builder()
                        .id("test-id")
            .name("test-name")
            .type(FinancialData.Widget.WidgetType.KPI_CARD)
            .position(42)
