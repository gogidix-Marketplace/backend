 ...
 */
@Schema(description = "Request DTO for searching product recommendations")
public record RecommendationSearchRequestDto(
    ...
    public RecommendationSearchRequestDto {
    ...
    public static RecommendationSearchRequestDto create() {
        return new RecommendationSearchRequestDto(null, null, 0, 20, "createdAt", "DESC");
    }
}
