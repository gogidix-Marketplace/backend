...
class Operations_WidgetTest {

        @Test
    void testBuilder() {
        Operations.Widget dto = Operations.Widget.builder()
                        .id("test-id")
            .name("test-name")
            .type(Operations.Widget.WidgetType.KPI_CARD)
            .position(42)
            .row(42)
            .column(42)
            .width(42)
        ...
        assertEquals(Operations.Widget.WidgetType.KPI_CARD, dto.getType());
    ...
    void testSettersAndGetters() {
        Operations.Widget dto = new Operations.Widget();
        dto.setId("val-id");
        dto.setName("val-name");
        dto.setType(Operations.Widget.WidgetType.KPI_CARD);
        dto.setPosition(99);
        dto.setRow(99);
        dto.setColumn(99);
        dto.setWidth(99);
    ...
    void testEqualsAndHashCode() {
        Operations.Widget dto1 = Operations.Widget.builder()
                        .id("test-id")
            .name("test-name")
            .type(Operations.Widget.WidgetType.KPI_CARD)
            .position(42)
            ...
            .dataSource("test-dataSource")
            .build();
        Operations.Widget dto2 = Operations.Widget.builder()
                        .id("test-id")
            .name("test-name")
            .type(Operations.Widget.WidgetType.KPI_CARD)
            .position(42)
