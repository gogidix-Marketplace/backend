...
mkdir -p src/main/java/com.gogidix/centralizeddashboard/centralized-reporting_CLEAN
mkdir -p src/main/resources
mkdir -p src/test/java/com.gogidix/centralizeddashboard/centralized-reporting_CLEAN
