 ...
 *
 * SLO Thresholds for Document Classification Service:
 * - P95 Latency: < 500ms
 * - P99 Latency: < 1000ms
...
public class ThresholdValidator {
    ...
    public ThresholdValidator(DocumentClassificationMetrics metrics) {
