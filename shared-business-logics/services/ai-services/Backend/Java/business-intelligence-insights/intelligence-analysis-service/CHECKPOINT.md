# AI IntelligenceReport Analysis Service - CHECKPOINT
...
|---------|---------------------|-------|
| **Domain** | IntelligenceAnalysis, AnalysisCriteria, AnalysisType, AnalysisStatus, Business Policies, Repository Ports | 7 |
