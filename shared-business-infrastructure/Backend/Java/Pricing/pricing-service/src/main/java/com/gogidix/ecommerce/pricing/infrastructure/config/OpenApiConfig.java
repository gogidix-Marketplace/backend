package com.gogidix.ecommerce.pricing.infrastructure.config;
    ...
    public OpenAPI pricingServiceOpenAPI() {
        return new OpenAPI()
                .info(new Info()
                        ...
                        .description("REST API for managing pricing rules in the Gogidix E-commerce platform")
                        .version("1.0.0")
                        .contact(new Contact()
                ...
                .servers(List.of(
                        new Server().url("http://localhost:8066").description("Development"),
