...
class CreditMemoResponseDto_CreditMemoLineItemDtoTest {

        @Test
    void testBuilder() {
        CreditMemoResponseDto.CreditMemoLineItemDto dto = CreditMemoResponseDto.CreditMemoLineItemDto.builder()
    ...
    void testSettersAndGetters() {
        CreditMemoResponseDto.CreditMemoLineItemDto dto = new CreditMemoResponseDto.CreditMemoLineItemDto();
    ...
    void testEqualsAndHashCode() {
        CreditMemoResponseDto.CreditMemoLineItemDto dto1 = CreditMemoResponseDto.CreditMemoLineItemDto.builder()
                        .lineItemId("test-lineItemId")
            .itemId("test-itemId")
            .itemCode("test-itemCode")
            .description("test-description")
            ...
            .reason("test-reason")
            .build();
        CreditMemoResponseDto.CreditMemoLineItemDto dto2 = CreditMemoResponseDto.CreditMemoLineItemDto.builder()
                        .lineItemId("test-lineItemId")
            .itemId("test-itemId")
            .itemCode("test-itemCode")
            .description("test-description")
