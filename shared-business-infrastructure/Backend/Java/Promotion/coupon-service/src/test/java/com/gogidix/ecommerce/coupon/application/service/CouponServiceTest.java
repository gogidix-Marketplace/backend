...
import com.gogidix.ecommerce.coupon.shared.requestcontext.RequestContext;
...
class CouponServiceTest {
    ...
    @Mock private CouponMapper mapper;
    private CouponService service;

    @BeforeEach
    void setUp() {
        service = new CouponService(repository, mapper);
    ...
    void shouldGetById() {
        ...
        when(mapper.toResponse(entity)).thenReturn(
            new CouponResponse("id-1", "test", null, null, null, null, null, true, null, null));
    ...
    void shouldCreate() {
        ...
        when(mapper.toResponse(any())).thenReturn(
            new CouponResponse("id-1", "test", null, null, null, null, null, true, null, null));
        assertThat(service.create(new CreateCouponRequest("test", null, null, null, null, null))).isNotNull();
    }
    ...
    void shouldUpdate() {
        ...
        when(repository.save(any())).thenReturn(entity);
        when(mapper.toResponse(any())).thenReturn(
            new CouponResponse("id-1", "updated", null, null, null, null, null, true, null, null));
        assertThat(service.update("id-1", new UpdateCouponRequest("updated", null, null, null, null, null, null))).isNotNull();
    }
