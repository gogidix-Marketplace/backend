...
@DisplayName("AnalyticsMapper Tests")
class AnalyticsMapperTest {

    private AnalyticsMapper mapper;

    @BeforeEach
    void setUp() { mapper = new AnalyticsMapper(); }
    ...
    void shouldMapToResponse() {
        ...
        AnalyticsResponse response = mapper.toResponse(entity);
    ...
    void shouldMapToEntity() {
        CreateAnalyticsRequest request = new CreateAnalyticsRequest("test", "desc", "type", null, null, null);
    ...
    void shouldUpdateFromRequest() {
        Analytics entity = new Analytics("tenant-1");
        entity.setName("old");
        UpdateAnalyticsRequest request = new UpdateAnalyticsRequest("new", "desc", null, null, null, null, null);
    ...
    void shouldSkipNullFields() {
        ...
        UpdateAnalyticsRequest request = new UpdateAnalyticsRequest(null, null, null, null, null, null, null);
        mapper.updateFromRequest(entity, request);
