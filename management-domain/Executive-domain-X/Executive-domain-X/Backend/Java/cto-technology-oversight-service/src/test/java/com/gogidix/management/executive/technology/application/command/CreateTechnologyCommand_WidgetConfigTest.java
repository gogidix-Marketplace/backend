...
import com.gogidix.management.executive.technology.application.command.CreateTechnologyCommand;
...
class CreateTechnologyCommand_WidgetConfigTest {

        @Test
    void testBuilder() {
        CreateTechnologyCommand.WidgetConfig dto = CreateTechnologyCommand.WidgetConfig.builder()
                        .name("test-name")
            .type("test-type")
            .position(42)
            .row(42)
    ...
    void testSettersAndGetters() {
        CreateTechnologyCommand.WidgetConfig dto = new CreateTechnologyCommand.WidgetConfig();
    ...
    void testEqualsAndHashCode() {
        CreateTechnologyCommand.WidgetConfig dto1 = CreateTechnologyCommand.WidgetConfig.builder()
                        .name("test-name")
            .type("test-type")
            .position(42)
            .row(42)
            ...
            .dataSource("test-dataSource")
            .build();
        CreateTechnologyCommand.WidgetConfig dto2 = CreateTechnologyCommand.WidgetConfig.builder()
                        .name("test-name")
            .type("test-type")
            .position(42)
            .row(42)
