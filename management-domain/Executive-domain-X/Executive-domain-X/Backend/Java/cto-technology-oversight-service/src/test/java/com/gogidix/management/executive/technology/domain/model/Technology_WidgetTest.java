package com.gogidix.management.executive.technology.domain.model;
...
class Technology_WidgetTest {

        @Test
    void testBuilder() {
        Technology.Widget dto = Technology.Widget.builder()
                        .id("test-id")
            .name("test-name")
            .type(Technology.Widget.WidgetType.KPI_CARD)
            .position(42)
            .row(42)
            .column(42)
            .width(42)
        ...
        assertEquals(Technology.Widget.WidgetType.KPI_CARD, dto.getType());
    ...
    void testSettersAndGetters() {
        Technology.Widget dto = new Technology.Widget();
        dto.setId("val-id");
        dto.setName("val-name");
        dto.setType(Technology.Widget.WidgetType.KPI_CARD);
        dto.setPosition(99);
        dto.setRow(99);
        dto.setColumn(99);
        dto.setWidth(99);
    ...
    void testEqualsAndHashCode() {
        Technology.Widget dto1 = Technology.Widget.builder()
                        .id("test-id")
            .name("test-name")
            .type(Technology.Widget.WidgetType.KPI_CARD)
            .position(42)
            ...
            .dataSource("test-dataSource")
            .build();
        Technology.Widget dto2 = Technology.Widget.builder()
                        .id("test-id")
            .name("test-name")
            .type(Technology.Widget.WidgetType.KPI_CARD)
            .position(42)
