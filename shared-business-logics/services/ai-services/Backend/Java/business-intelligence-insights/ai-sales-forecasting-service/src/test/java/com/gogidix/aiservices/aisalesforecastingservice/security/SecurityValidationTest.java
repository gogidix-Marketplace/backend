package com.gogidix.aiservices.aisalesforecastingservice.security;
...
class SecurityValidationTest {
    ...
    class InputValidationTests {
        ...
        void shouldRejectNullForecastModelId() {
            assertThatThrownBy(() -> {
                if (null == null) {
                    throw new IllegalArgumentException("ForecastModel ID cannot be null");
                }
    ...
    class ResourceLimitsTests {
        ...
        void shouldEnforceForecastResultLimit() {
