...
import com.gogidix.management.executive.audit.domain.model.ExecutiveSummary;
...
public interface SummaryGenerationService {
    ...
    /**
     * Generate executive summary for specific audits
     */
    ExecutiveSummary generateSummaryForDashboards(String tenantId, List<String> auditIds, Instant forDate);
