...
class ThresholdValidatorTest {
    ...
    class ValidateAllThresholdsTests {
        ...
        void shouldReturnCompliantReportWhenAllThresholdsWithinLimits() {
            ...
            when(metrics.getMlPredictionLatencyP95()).thenReturn(80.0);  // < 100ms
        ...
        void shouldReturnNonCompliantWhenP95LatencyExceedsThreshold() {
            ...
            when(metrics.getMlPredictionLatencyP95()).thenReturn(80.0);
        ...
        @Test
        @DisplayName("Should return non-compliant report when ML latency exceeds threshold")
        void shouldReturnNonCompliantWhenMlLatencyExceedsThreshold() {
            when(metrics.getAnalysisLatencyP95()).thenReturn(400.0);
            when(metrics.getAnalysisLatencyP99()).thenReturn(800.0);
            when(metrics.getMlPredictionLatencyP95()).thenReturn(150.0);  // > 100ms
            when(metrics.getErrorRate()).thenReturn(0.005);
    ...
    class ValidateSpecificThresholdTests {
        ...
        @Test
        @DisplayName("Should validate ML prediction latency threshold")
        void shouldValidateMlPredictionLatency() {
            when(metrics.getMlPredictionLatencyP95()).thenReturn(95.0);
            ...
            assertThat(validation.getActualValue()).isEqualTo(95.0);
    ...
    class HealthStatusTests {
        ...
        void shouldReturnDegradedWhen75PercentPass() {
            ...
            when(metrics.getMlPredictionLatencyP95()).thenReturn(80.0);  // pass
        ...
        void shouldReturnUnhealthyWhenAllThresholdsFail() {
            ...
            when(metrics.getMlPredictionLatencyP95()).thenReturn(150.0);
