 ...
 */
public class ModelsAddedToPredictionEvent implements DomainEvent {
    ...
    public ModelsAddedToPredictionEvent(String aggregateId, String tenantId, String segmentName,
    ...
    public boolean equals(Object o) {
        ...
        ModelsAddedToPredictionEvent that = (ModelsAddedToPredictionEvent) o;
    ...
    public String toString() {
        return "ModelsAddedToPredictionEvent{" +
                "eventId='" + eventId + '\'' +
