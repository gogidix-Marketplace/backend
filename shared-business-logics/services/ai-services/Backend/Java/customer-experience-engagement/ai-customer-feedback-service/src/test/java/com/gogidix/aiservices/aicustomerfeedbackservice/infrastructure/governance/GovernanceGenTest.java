...
class GovernanceGenTest {
    ...
    @BeforeEach
    void setup() {
        metrics = new CustomerFeedbackMetrics(new SimpleMeterRegistry());
    ...
    @Test
    void validate_NLP_PROCESSING_LATENCY() {
        var r = validator.validateThreshold(ThresholdValidator.ThresholdType.NLP_PROCESSING_LATENCY);
        assertThat(r).isNotNull();
    }
