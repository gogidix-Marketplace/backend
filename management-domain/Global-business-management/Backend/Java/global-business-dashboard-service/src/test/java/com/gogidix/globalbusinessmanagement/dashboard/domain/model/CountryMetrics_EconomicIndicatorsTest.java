...
class CountryMetrics_EconomicIndicatorsTest {

        @Test
    void testBuilder() {
        CountryMetrics.EconomicIndicators dto = CountryMetrics.EconomicIndicators.builder()
    ...
    void testSettersAndGetters() {
        CountryMetrics.EconomicIndicators dto = new CountryMetrics.EconomicIndicators();
    ...
    void testEqualsAndHashCode() {
        CountryMetrics.EconomicIndicators dto1 = CountryMetrics.EconomicIndicators.builder()
                        .gdpGrowth(BigDecimal.TEN)
            .inflationRate(BigDecimal.TEN)
            .unemploymentRate(BigDecimal.TEN)
            .exchangeRate(BigDecimal.TEN)
            ...
            .purchasingPowerIndex(BigDecimal.TEN)
            .build();
        CountryMetrics.EconomicIndicators dto2 = CountryMetrics.EconomicIndicators.builder()
                        .gdpGrowth(BigDecimal.TEN)
            .inflationRate(BigDecimal.TEN)
            .unemploymentRate(BigDecimal.TEN)
            .exchangeRate(BigDecimal.TEN)
