...
public record ProfileAnalysisResponseDto(
        ...
        @Schema(description = "Profile identifier", example = "seg_1234567890abcdef")
        String segmentId,
        ...
        @Schema(description = "User demographics breakdown")
    ...
    /**
     * Get the customer count (alias for totalUsers for test compatibility).
