...
class Analytics_WidgetTest {

        @Test
    void testBuilder() {
        Analytics.Widget dto = Analytics.Widget.builder()
                        .id("test-id")
            .name("test-name")
            .type(Analytics.Widget.WidgetType.KPI_CARD)
            .position(42)
            .row(42)
            .column(42)
            .width(42)
        ...
        assertEquals(Analytics.Widget.WidgetType.KPI_CARD, dto.getType());
    ...
    void testSettersAndGetters() {
        Analytics.Widget dto = new Analytics.Widget();
        dto.setId("val-id");
        dto.setName("val-name");
        dto.setType(Analytics.Widget.WidgetType.KPI_CARD);
        dto.setPosition(99);
        dto.setRow(99);
        dto.setColumn(99);
        dto.setWidth(99);
    ...
    void testEqualsAndHashCode() {
        Analytics.Widget dto1 = Analytics.Widget.builder()
                        .id("test-id")
            .name("test-name")
            .type(Analytics.Widget.WidgetType.KPI_CARD)
            .position(42)
            ...
            .dataSource("test-dataSource")
            .build();
        Analytics.Widget dto2 = Analytics.Widget.builder()
                        .id("test-id")
            .name("test-name")
            .type(Analytics.Widget.WidgetType.KPI_CARD)
            .position(42)
