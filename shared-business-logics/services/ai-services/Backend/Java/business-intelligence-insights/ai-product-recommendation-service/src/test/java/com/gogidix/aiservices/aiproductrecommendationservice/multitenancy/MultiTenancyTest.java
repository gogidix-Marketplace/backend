package com.gogidix.aiservices.aiproductrecommendationservice.multitenancy;
...
class MultiTenancyTest {
    ...
    class CrossTenantAccessTests {
        ...
        void shouldPreventCrossTenantRecommendationAccess() {
        ...
        void shouldPreventCrossTenantProductAccess() {
    ...
    class TenantQuotaTests {
        ...
        void shouldEnforcePerTenantRecommendationLimits() {
        ...
        void shouldEnforcePerTenantProductLimits() {
