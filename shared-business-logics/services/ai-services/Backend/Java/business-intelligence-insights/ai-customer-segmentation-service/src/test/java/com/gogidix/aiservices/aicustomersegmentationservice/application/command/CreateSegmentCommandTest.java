...
/**
 * Unit tests for CreateSegmentCommand.
 */
@DisplayName("CreateSegmentCommand Tests")
class CreateSegmentCommandTest {
    ...
    private static final SegmentType SEGMENT_TYPE = SegmentType.BEHAVIORAL;
    ...
    class CreationTests {
        ...
        void shouldThrowWhenNameIsNull() {
            assertThrows(IllegalArgumentException.class,
                    () -> new CreateSegmentCommand(null, DESCRIPTION, SEGMENT_TYPE, CRITERIA, TENANT_ID, USER_ID));
        }
        ...
        void shouldThrowWhenNameIsBlank() {
            assertThrows(IllegalArgumentException.class,
                    () -> new CreateSegmentCommand("   ", DESCRIPTION, SEGMENT_TYPE, CRITERIA, TENANT_ID, USER_ID));
        }
        ...
        void shouldThrowWhenNameExceedsMaxLength() {
            ...
            assertThrows(IllegalArgumentException.class,
                    () -> new CreateSegmentCommand(longName, DESCRIPTION, SEGMENT_TYPE, CRITERIA, TENANT_ID, USER_ID));
        }
        ...
        void shouldThrowWhenDescriptionExceedsMaxLength() {
            ...
            assertThrows(IllegalArgumentException.class,
                    () -> new CreateSegmentCommand(NAME, longDescription, SEGMENT_TYPE, CRITERIA, TENANT_ID, USER_ID));
        }

        @Test
        @DisplayName("Should throw when segmentType is null")
        void shouldThrowWhenSegmentTypeIsNull() {
            assertThrows(IllegalArgumentException.class,
                    () -> new CreateSegmentCommand(NAME, DESCRIPTION, null, CRITERIA, TENANT_ID, USER_ID));
        }
        ...
        void shouldThrowWhenCriteriaIsNull() {
            assertThrows(IllegalArgumentException.class,
                    () -> new CreateSegmentCommand(NAME, DESCRIPTION, SEGMENT_TYPE, null, TENANT_ID, USER_ID));
        }
        ...
        void shouldThrowWhenCriteriaIsEmpty() {
            assertThrows(IllegalArgumentException.class,
                    () -> new CreateSegmentCommand(NAME, DESCRIPTION, SEGMENT_TYPE, Map.of(), TENANT_ID, USER_ID));
        }
        ...
        void shouldThrowWhenTenantIdIsNull() {
            assertThrows(IllegalArgumentException.class,
                    () -> new CreateSegmentCommand(NAME, DESCRIPTION, SEGMENT_TYPE, CRITERIA, null, USER_ID));
        }
        ...
        void shouldThrowWhenTenantIdIsBlank() {
            assertThrows(IllegalArgumentException.class,
                    () -> new CreateSegmentCommand(NAME, DESCRIPTION, SEGMENT_TYPE, CRITERIA, "   ", USER_ID));
        }
    ...
    class BoundaryTests {
        ...
        void shouldAcceptNameWithExactly100Characters() {
            ...
            assertDoesNotThrow(() -> new CreateSegmentCommand(
