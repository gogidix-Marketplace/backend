...
class ContactCommand_CreateContactCommandTest {

        @Test
    void testSettersAndGetters() {
        ContactCommand.CreateContactCommand dto = new ContactCommand.CreateContactCommand();
    ...
    void testEqualsAndHashCode() {
        ContactCommand.CreateContactCommand dto1 = new ContactCommand.CreateContactCommand();
        ContactCommand.CreateContactCommand dto2 = new ContactCommand.CreateContactCommand();
