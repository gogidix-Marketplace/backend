package com.gogidix.aiservices.aitestingservice.governance;

import com.gogidix.aiservices.aitestingservice.infrastructure.governance.ComplianceReportGenerator;
import com.gogidix.aiservices.aitestingservice.infrastructure.governance.ThresholdValidator;
...
class GovernanceEnforcementTest {
    ...
    private final AiTestingMetrics metrics = new AiTestingMetrics(new SimpleMeterRegistry());
