      ...
      <div className="flex h-16 items-center justify-between border-b px-4">
        {!collapsed && (
          <div className="flex items-center gap-2">
            <div className="flex h-8 w-8 items-center justify-center rounded bg-admin-navy">
              <Shield className="h-5 w-5 text-white" />
            </div>
            <span className="text-lg font-semibold text-admin-navy">Admin Portal</span>
          </div>
        )}
        <button
        ...
        <div className="border-t p-4">
          <div className="flex items-center gap-3 rounded-lg bg-white dark:bg-slate-800 p-3 shadow-sm">
            ...
            <div className="flex-1 text-xs">
              ...
              <p className="text-muted-foreground">HQ Control Center</p>
            </div>
          </div>
        </div>
      )}
