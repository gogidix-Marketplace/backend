package com.gogidix.aiservices.aichurnpredictionservice.infrastructure.config;
...
@Configuration
@PropertySource(value = "classpath:slo-config.yml", factory = YamlPropertySourceFactory.class, ignoreResourceNotFound = true)
