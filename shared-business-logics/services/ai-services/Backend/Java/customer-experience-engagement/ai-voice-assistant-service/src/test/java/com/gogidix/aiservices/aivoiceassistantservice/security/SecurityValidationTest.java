package com.gogidix.aiservices.aivoiceassistantservice.security;
...
class SecurityValidationTest {
    ...
    class InputValidationTests {
        ...
        void shouldHandleSqlInjectionAttempts() {
            String maliciousInput = "'; DROP TABLE voice_sessions; --";
    ...
    class TenantIsolationTests {
        ...
        @Test
        @Order(10)
        @DisplayName("Should isolate voice sessions by tenant")
        void shouldIsolateVoiceSessionsByTenant() {
            String tenant1 = "tenant-1";
            String tenant2 = "tenant-2";

            // Sessions for tenant1 should not affect tenant2
    ...
    class ResourceLimitsTests {
        ...
        @Test
        @Order(20)
        @DisplayName("Should enforce voice session limit")
        void shouldEnforceVoiceSessionLimit() {
            // Simulate large voice session request
    ...
    class AuthenticationContextTests {
        ...
        void shouldPreventUnauthorizedCrossTenantAccess() {
            ...
            // Attempting voice session from different tenant context
            assertThat(tenant1).isNotEqualTo(tenant2);
        }
    }
}
