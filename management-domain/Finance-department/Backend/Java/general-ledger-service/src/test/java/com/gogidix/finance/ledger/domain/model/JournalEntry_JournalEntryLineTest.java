...
class JournalEntry_JournalEntryLineTest {

        @Test
    void testBuilder() {
        JournalEntry.JournalEntryLine dto = JournalEntry.JournalEntryLine.builder()
                        .lineId("test-lineId")
    ...
    void testSettersAndGetters() {
        JournalEntry.JournalEntryLine dto = new JournalEntry.JournalEntryLine();
    ...
    void testEqualsAndHashCode() {
        JournalEntry.JournalEntryLine dto1 = JournalEntry.JournalEntryLine.builder()
                        .lineId("test-lineId")
            .accountId("test-accountId")
            .accountNumber("test-accountNumber")
            .accountName("test-accountName")
            ...
            .sequenceNumber(42)
            .build();
        JournalEntry.JournalEntryLine dto2 = JournalEntry.JournalEntryLine.builder()
                        .lineId("test-lineId")
            .accountId("test-accountId")
            .accountNumber("test-accountNumber")
            .accountName("test-accountName")
