...
/**
 * Unit tests for CreateProfileCommand.
 */
@DisplayName("CreateProfileCommand Tests")
class CreateProfileCommandTest {

    private static final String NAME = "High Value Users";
    private static final String DESCRIPTION = "Users with high lifetime value";
    private static final ProfileType SEGMENT_TYPE = ProfileType.BEHAVIORAL;
    ...
    class CreationTests {
        ...
        void shouldThrowWhenNameIsNull() {
            assertThrows(IllegalArgumentException.class,
                    () -> new CreateProfileCommand(null, DESCRIPTION, SEGMENT_TYPE, CRITERIA, TENANT_ID, USER_ID));
        }
        ...
        void shouldThrowWhenNameIsBlank() {
            assertThrows(IllegalArgumentException.class,
                    () -> new CreateProfileCommand("   ", DESCRIPTION, SEGMENT_TYPE, CRITERIA, TENANT_ID, USER_ID));
        }
        ...
        void shouldThrowWhenNameExceedsMaxLength() {
            ...
            assertThrows(IllegalArgumentException.class,
                    () -> new CreateProfileCommand(longName, DESCRIPTION, SEGMENT_TYPE, CRITERIA, TENANT_ID, USER_ID));
        }
        ...
        void shouldThrowWhenDescriptionExceedsMaxLength() {
            ...
            assertThrows(IllegalArgumentException.class,
                    () -> new CreateProfileCommand(NAME, longDescription, SEGMENT_TYPE, CRITERIA, TENANT_ID, USER_ID));
        }
        ...
        void shouldThrowWhenProfileTypeIsNull() {
            assertThrows(IllegalArgumentException.class,
                    () -> new CreateProfileCommand(NAME, DESCRIPTION, null, CRITERIA, TENANT_ID, USER_ID));
        }
        ...
        void shouldThrowWhenCriteriaIsNull() {
            assertThrows(IllegalArgumentException.class,
                    () -> new CreateProfileCommand(NAME, DESCRIPTION, SEGMENT_TYPE, null, TENANT_ID, USER_ID));
        }
        ...
        void shouldThrowWhenCriteriaIsEmpty() {
            assertThrows(IllegalArgumentException.class,
                    () -> new CreateProfileCommand(NAME, DESCRIPTION, SEGMENT_TYPE, Map.of(), TENANT_ID, USER_ID));
        }
        ...
        void shouldThrowWhenTenantIdIsNull() {
            assertThrows(IllegalArgumentException.class,
                    () -> new CreateProfileCommand(NAME, DESCRIPTION, SEGMENT_TYPE, CRITERIA, null, USER_ID));
        }
        ...
        void shouldThrowWhenTenantIdIsBlank() {
            assertThrows(IllegalArgumentException.class,
                    () -> new CreateProfileCommand(NAME, DESCRIPTION, SEGMENT_TYPE, CRITERIA, "   ", USER_ID));
        }
    ...
    class BoundaryTests {
        ...
        void shouldAcceptNameWithExactly100Characters() {
            ...
            assertDoesNotThrow(() -> new CreateProfileCommand(
