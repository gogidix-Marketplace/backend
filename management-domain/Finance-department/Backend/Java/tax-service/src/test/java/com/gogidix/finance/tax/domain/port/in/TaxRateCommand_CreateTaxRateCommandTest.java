...
class TaxRateCommand_CreateTaxRateCommandTest {

        @Test
    void testSettersAndGetters() {
        TaxRateCommand.CreateTaxRateCommand dto = new TaxRateCommand.CreateTaxRateCommand();
    ...
    void testEqualsAndHashCode() {
        TaxRateCommand.CreateTaxRateCommand dto1 = new TaxRateCommand.CreateTaxRateCommand();
        TaxRateCommand.CreateTaxRateCommand dto2 = new TaxRateCommand.CreateTaxRateCommand();
