...
import com.gogidix.management.executive.analytics.application.dto.AnalyticsDto;
...
class AnalyticsDto_WidgetDtoTest {

        @Test
    void testBuilder() {
        AnalyticsDto.WidgetDto dto = AnalyticsDto.WidgetDto.builder()
                        .id("test-id")
            .name("test-name")
            .type(null)
            .position(42)
    ...
    void testSettersAndGetters() {
        AnalyticsDto.WidgetDto dto = new AnalyticsDto.WidgetDto();
        dto.setId("val-id");
    ...
    void testEqualsAndHashCode() {
        AnalyticsDto.WidgetDto dto1 = AnalyticsDto.WidgetDto.builder()
                        .id("test-id")
            .name("test-name")
            .type(null)
            .position(42)
            ...
            .dataSource("test-dataSource")
            .build();
        AnalyticsDto.WidgetDto dto2 = AnalyticsDto.WidgetDto.builder()
                        .id("test-id")
            .name("test-name")
            .type(null)
            .position(42)
