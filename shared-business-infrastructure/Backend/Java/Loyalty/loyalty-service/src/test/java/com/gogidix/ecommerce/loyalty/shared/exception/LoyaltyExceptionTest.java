...
class LoyaltyExceptionTest {
    ...
    void shouldCreateDuplicateException() {
        DuplicateLoyaltyException ex = new DuplicateLoyaltyException("name-1");
    ...
    void shouldCreateInvalidException() {
        InvalidLoyaltyException ex = new InvalidLoyaltyException("bad data");
    ...
    void shouldCreateInvalidExceptionWithCause() {
        ...
        InvalidLoyaltyException ex = new InvalidLoyaltyException("msg", cause);
