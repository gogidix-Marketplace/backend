package com.gogidix.aiservices.aiworkflowautomationservice.observability;
...
class SloComplianceTest {
    ...
    private AiWorkflowAutomationMetrics metrics;
    private MeterRegistry meterRegistry;

    @BeforeEach
    void setUp() {
        meterRegistry = new SimpleMeterRegistry();
        metrics = new AiWorkflowAutomationMetrics(meterRegistry);
    }
    ...
    class MetricsRecordingTests {
        ...
        @Test
        @Order(10)
        @DisplayName("Should record workflow execution latency")
        void shouldRecordWorkflowExecutionLatency() {
            metrics.recordWorkflowExecutionTime(100);
        ...
        @Test
        @Order(11)
        @DisplayName("Should record automation requests")
        void shouldRecordAutomationRequests() {
    ...
    class SloThresholdTests {
        ...
        void shouldHaveP95LatencyBelowThreshold() {
            ...
            for (int i = 0; i < 100; i++) {
                metrics.recordWorkflowExecutionTime(50 + i);
            }
    ...
    class MetricsStructureTests {
        ...
        @Test
        @Order(30)
        @DisplayName("Should have workflow execution duration timer")
        void shouldHaveWorkflowExecutionDurationTimer() {
            assertThat(meterRegistry.get("ai.workflow.automation.execution.duration").timer()).isNotNull();
        }
        ...
        void shouldHaveRequestsCounter() {
            assertThat(meterRegistry.get("ai.workflow.automation.requests.total").counter()).isNotNull();
        }
    }
}
