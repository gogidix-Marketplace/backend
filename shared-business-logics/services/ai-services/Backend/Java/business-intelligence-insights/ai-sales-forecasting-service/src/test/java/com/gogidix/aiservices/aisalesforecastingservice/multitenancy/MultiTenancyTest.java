...
class MultiTenancyTest {
    ...
    class CrossTenantAccessTests {
        ...
        void shouldPreventCrossTenantForecastAccess() {
        ...
        void shouldPreventCrossTenantForecastModelAccess() {
    ...
    class TenantQuotaTests {
        ...
        void shouldEnforcePerTenantForecastLimits() {
        ...
        void shouldEnforcePerTenantForecastModelLimits() {
