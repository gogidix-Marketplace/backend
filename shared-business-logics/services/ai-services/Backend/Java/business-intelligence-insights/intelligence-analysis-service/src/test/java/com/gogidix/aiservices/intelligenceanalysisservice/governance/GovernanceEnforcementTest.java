package com.gogidix.aiservices.intelligenceanalysisservice.governance;
...
import com.gogidix.aiservices.intelligenceanalysisservice.infrastructure.governance.ComplianceReportGenerator;
import com.gogidix.aiservices.intelligenceanalysisservice.infrastructure.governance.ThresholdValidator;
...
class GovernanceEnforcementTest {
    ...
    private IntelligenceAnalysisApplicationService segmentApplicationService;
    ...
    class ComplianceReportTests {
        ...
        void shouldIncludePerformanceMetricsSection() {
            ...
            assertThat(perf.getTotalAnalysiss()).isGreaterThanOrEqualTo(0);
            assertThat(perf.getSuccessfulAnalysiss()).isGreaterThanOrEqualTo(0);
        }
