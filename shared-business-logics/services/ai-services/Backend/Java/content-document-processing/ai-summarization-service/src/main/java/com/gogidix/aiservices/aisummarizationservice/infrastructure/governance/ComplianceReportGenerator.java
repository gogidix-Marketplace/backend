package com.gogidix.aiservices.aisummarizationservice.infrastructure.governance;
...
public class ComplianceReportGenerator {
    ...
    private PerformanceMetricsSection generatePerformanceSection() {
        ...
        section.setTotalRequests((long) metrics.getMeterRegistry()
                .get("ai.summarization.total").counter().count());

        section.setSuccessfulRequests((long) metrics.getMeterRegistry()
                .get("ai.summarization.success").counter().count());

        section.setFailedRequests((long) metrics.getMeterRegistry()
                .get("ai.summarization.failure").counter().count());

        section.setDocumentsSummarized((long) metrics.getMeterRegistry()
                .get("ai.summarization.documents").counter().count());

        section.setTokensProcessed((long) metrics.getMeterRegistry()
                .get("ai.summarization.tokens").counter().count());

        section.setValidationFailures((long) metrics.getMeterRegistry()
                .get("ai.summarization.validation.failed").counter().count());
    ...
    private String generateReportId() {
        return "GOV-SUMM-" + DateTimeFormatter.ofPattern("yyyyMMdd-HHmmss")
    ...
    public static class GovernanceReport {
        ...
        private Map<String, Object> performanceMetricsToMap() {
            ...
            map.put("documentsSummarized", performanceMetrics.getDocumentsSummarized());
    ...
    public static class PerformanceMetricsSection {
        ...
        private long documentsSummarized;
        ...
        public long getDocumentsSummarized() { return documentsSummarized; }
        public void setDocumentsSummarized(long documentsSummarized) { this.documentsSummarized = documentsSummarized; }
