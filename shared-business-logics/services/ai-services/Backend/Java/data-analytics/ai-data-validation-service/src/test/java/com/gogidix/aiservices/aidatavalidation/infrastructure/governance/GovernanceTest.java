...
class GovernanceTest {
    ...
    @BeforeEach
    void setup() {
        var m = new DataValidationMetrics(new SimpleMeterRegistry());
    ...
    @Test
    void threshold() { assertThat(v.validateThreshold(ThresholdValidator.ThresholdType.P95_LATENCY)).isNotNull(); }
    @Test
