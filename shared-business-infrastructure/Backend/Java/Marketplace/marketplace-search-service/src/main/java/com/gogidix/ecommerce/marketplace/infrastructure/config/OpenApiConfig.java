...
public class OpenApiConfig {
    @Bean
    public OpenAPI marketplaceSearchServiceOpenAPI() {
        return new OpenAPI()
                .info(new Info()
                        .title("Marketplace Search Service API")
                        .description("REST API for marketplace search in the Gogidix E-commerce platform")
                        .version("1.0.0")
                ...
                .servers(List.of(
                        new Server().url("http://localhost:8046").description("Development"),
