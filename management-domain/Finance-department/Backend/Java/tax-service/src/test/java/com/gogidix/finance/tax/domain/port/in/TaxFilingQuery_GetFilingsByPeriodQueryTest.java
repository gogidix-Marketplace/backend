...
class TaxFilingQuery_GetFilingsByPeriodQueryTest {

        @Test
    void testSettersAndGetters() {
        TaxFilingQuery.GetFilingsByPeriodQuery dto = new TaxFilingQuery.GetFilingsByPeriodQuery();
    ...
    void testEqualsAndHashCode() {
        TaxFilingQuery.GetFilingsByPeriodQuery dto1 = new TaxFilingQuery.GetFilingsByPeriodQuery();
        TaxFilingQuery.GetFilingsByPeriodQuery dto2 = new TaxFilingQuery.GetFilingsByPeriodQuery();
