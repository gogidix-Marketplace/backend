# CTO Web Dashboard — Archived

This directory has been archived. All CTO dashboard functionality has been consolidated into the single multi-role executive dashboard.

**Active project:** `../ceo-web-dashboard/`

## How to run CTO dashboard
...
The CTO dashboard runs on **port 3014** with role auto-detection via the unified routing system.
