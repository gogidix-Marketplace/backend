...
class NotificationPreferenceCommand_UpdatePreferenceCommandTest {

        @Test
    void testSettersAndGetters() {
        NotificationPreferenceCommand.UpdatePreferenceCommand dto = new NotificationPreferenceCommand.UpdatePreferenceCommand();
    ...
    void testEqualsAndHashCode() {
        NotificationPreferenceCommand.UpdatePreferenceCommand dto1 = new NotificationPreferenceCommand.UpdatePreferenceCommand();
        NotificationPreferenceCommand.UpdatePreferenceCommand dto2 = new NotificationPreferenceCommand.UpdatePreferenceCommand();
