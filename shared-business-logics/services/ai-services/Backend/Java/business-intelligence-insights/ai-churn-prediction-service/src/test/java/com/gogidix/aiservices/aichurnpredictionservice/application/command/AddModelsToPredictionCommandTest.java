...
/**
 * Unit tests for AddModelsToPredictionCommand.
 */
@DisplayName("AddModelsToPredictionCommand Tests")
class AddModelsToPredictionCommandTest {
    ...
    class CreationTests {
        ...
        void shouldThrowWhenPredictionIdIsNull() {
            assertThrows(IllegalArgumentException.class,
                    () -> new AddModelsToPredictionCommand(null, TENANT_ID, USER_ID, CUSTOMER_IDS));
        }

        @Test
        @DisplayName("Should throw when segmentId is blank")
        void shouldThrowWhenPredictionIdIsBlank() {
            assertThrows(IllegalArgumentException.class,
                    () -> new AddModelsToPredictionCommand("   ", TENANT_ID, USER_ID, CUSTOMER_IDS));
        }
        ...
        void shouldThrowWhenTenantIdIsNull() {
            assertThrows(IllegalArgumentException.class,
                    () -> new AddModelsToPredictionCommand(SEGMENT_ID, null, USER_ID, CUSTOMER_IDS));
        }
        ...
        void shouldThrowWhenTenantIdIsBlank() {
            assertThrows(IllegalArgumentException.class,
                    () -> new AddModelsToPredictionCommand(SEGMENT_ID, "   ", USER_ID, CUSTOMER_IDS));
        }
        ...
        void shouldThrowWhenCustomerIdsIsNull() {
            assertThrows(IllegalArgumentException.class,
                    () -> new AddModelsToPredictionCommand(SEGMENT_ID, TENANT_ID, USER_ID, null));
        }
        ...
        void shouldThrowWhenCustomerIdsIsEmpty() {
            assertThrows(IllegalArgumentException.class,
                    () -> new AddModelsToPredictionCommand(SEGMENT_ID, TENANT_ID, USER_ID, List.of()));
        }
        ...
        void shouldThrowWhenCustomerIdsExceedsMaxSize() {
            ...
            assertThrows(IllegalArgumentException.class,
                    () -> new AddModelsToPredictionCommand(SEGMENT_ID, TENANT_ID, USER_ID, tooManyCustomers));
        }
    }
    ...
    class BoundaryTests {
        ...
        void shouldAcceptExactly1000Customers() {
            ...
            assertDoesNotThrow(() -> new AddModelsToPredictionCommand(
