...
import org.junit.jupiter.api.*; import com.gogidix.aiservices.aidocumentprocessingservice.infrastructure.metrics.DocumentProcessingMetrics; import io.micrometer.core.instrument.simple.SimpleMeterRegistry; import static org.assertj.core.api.Assertions.*;
class GovernanceTest {
    private ThresholdValidator v; private ComplianceReportGenerator g;
    @BeforeEach void setup() { var m = new DocumentProcessingMetrics(new SimpleMeterRegistry()); v = new ThresholdValidator(m); g = new ComplianceReportGenerator(m, v); }
