...
public class ThresholdValidator {
    ...
    private static final double MAX_ANALYSIS_LATENCY_MS = 300.0;

    public ThresholdValidator(PerformanceOptimizationMetrics metrics) {
