...
class GovernanceGenTest {
    ...
    @BeforeEach
    void setup() {
        metrics = new VoiceAssistantMetrics(new SimpleMeterRegistry());
    ...
    @Test
    void validate_SPEECH_TO_TEXT_LATENCY() {
        var r = validator.validateThreshold(ThresholdValidator.ThresholdType.SPEECH_TO_TEXT_LATENCY);
        assertThat(r).isNotNull();
    }
