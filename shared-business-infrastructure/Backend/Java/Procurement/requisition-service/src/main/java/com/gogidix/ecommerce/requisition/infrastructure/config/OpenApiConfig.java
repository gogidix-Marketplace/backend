package com.gogidix.ecommerce.requisition.infrastructure.config;
...
public class OpenApiConfig {
    @Bean
    public OpenAPI requisitionServiceOpenAPI() {
        return new OpenAPI()
                .info(new Info()
                        .title("Requisition Service API")
                        .description("REST API for requisition in the Gogidix E-commerce platform")
                        .version("1.0.0")
                ...
                .servers(List.of(
                        new Server().url("http://localhost:8077").description("Development"),
