...
public class SegmentCriteria {
    ...
    private final List<SegmentCriteria> nestedCriteria;

    // Private constructor
    private SegmentCriteria(Builder builder) {
    ...
    public List<SegmentCriteria> getNestedCriteria() {
     ...
     * @return a new SegmentCriteria with the nested criteria added
     */
    public SegmentCriteria withNestedCriteria(SegmentCriteria criteria) {
        List<SegmentCriteria> newNested = new ArrayList<>(this.nestedCriteria);
    ...
    public static class Builder {
        ...
        private List<SegmentCriteria> nestedCriteria;
        ...
        public Builder nestedCriteria(List<SegmentCriteria> nestedCriteria) {
            this.nestedCriteria = nestedCriteria;
            return this;
        }

        public Builder addNestedCriteria(SegmentCriteria criteria) {
        ...
        public SegmentCriteria build() {
            return new SegmentCriteria(this);
        }
    }
