...
public class ThresholdValidator {
    ...
    public ThresholdValidator(MarketBasketMetrics metrics) {
    ...
    public ComplianceReport validateAllThresholds() {
        ...
        double analysisLatency = metrics.getBasketAnalysisLatencyP95();
        boolean analysisCompliant = analysisLatency <= MAX_ANALYSIS_LATENCY_MS;
        report.addCheck("Basket Analysis Latency", analysisLatency, MAX_ANALYSIS_LATENCY_MS, analysisCompliant);
    ...
    public ThresholdValidation validateThreshold(ThresholdType type) {
        return switch (type) {
            ...
            case SEGMENT_ANALYSIS_LATENCY -> {
                double value = metrics.getBasketAnalysisLatencyP95();
