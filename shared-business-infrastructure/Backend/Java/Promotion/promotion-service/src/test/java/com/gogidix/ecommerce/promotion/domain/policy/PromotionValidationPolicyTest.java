...
@DisplayName("PromotionValidationPolicy Tests")
class PromotionValidationPolicyTest {

    private PromotionValidationPolicy policy;

    @BeforeEach
    void setUp() { policy = new PromotionValidationPolicy(); }
