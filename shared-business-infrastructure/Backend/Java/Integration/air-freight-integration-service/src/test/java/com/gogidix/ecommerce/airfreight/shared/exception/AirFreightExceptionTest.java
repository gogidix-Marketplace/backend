...
@DisplayName("AirFreight Exception Tests")
class AirFreightExceptionTest {

    @Test
    @DisplayName("Should create not found exception")
    void shouldCreateNotFoundException() {
        AirFreightNotFoundException ex = new AirFreightNotFoundException("id-1");
    ...
    void shouldCreateDuplicateException() {
        DuplicateAirFreightException ex = new DuplicateAirFreightException("name-1");
    ...
    void shouldCreateInvalidException() {
        InvalidAirFreightException ex = new InvalidAirFreightException("bad data");
    ...
    void shouldCreateInvalidExceptionWithCause() {
        ...
        InvalidAirFreightException ex = new InvalidAirFreightException("msg", cause);
