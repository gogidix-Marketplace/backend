package com.gogidix.ecommerce.commission.infrastructure.config;
    ...
    public OpenAPI commissionServiceOpenAPI() {
        return new OpenAPI()
                .info(new Info()
                        ...
                        .description("REST API for commission management in the Gogidix E-commerce platform")
                        .version("1.0.0")
                ...
                .servers(List.of(
                        new Server().url("http://localhost:8036").description("Development"),
