package com.gogidix.aiservices.aidocumentprocessingservice.infrastructure.governance;
...
public class ComplianceReportGenerator {
    ...
    private final DocumentProcessingMetrics metrics;
    private final ThresholdValidator thresholdValidator;

    // SLO Targets for Content Processing - Document Processing
    private static final double TARGET_P95_LATENCY_MS = 1000.0;
    private static final double TARGET_P99_LATENCY_MS = 2000.0;
    ...
    private String generateReportId() {
        return "GOV-DOC-" + DateTimeFormatter.ofPattern("yyyyMMdd-HHmmss")
