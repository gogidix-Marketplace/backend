...
public class ThresholdValidator {
    ...
    private static final double MAX_STORE_LATENCY_MS = 200.0;

    public ThresholdValidator(FeatureStoreMetrics metrics) {
    ...
    public ComplianceReport validateAllThresholds() {
        ...
        // Validate store latency
        double storeLatency = metrics.getStoreLatencyP95();
        boolean storeCompliant = storeLatency <= MAX_STORE_LATENCY_MS;
        report.addCheck("Store Latency", storeLatency, MAX_STORE_LATENCY_MS, storeCompliant);
