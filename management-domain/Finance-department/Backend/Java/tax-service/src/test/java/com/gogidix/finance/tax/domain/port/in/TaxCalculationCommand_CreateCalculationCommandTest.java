...
class TaxCalculationCommand_CreateCalculationCommandTest {

        @Test
    void testSettersAndGetters() {
        TaxCalculationCommand.CreateCalculationCommand dto = new TaxCalculationCommand.CreateCalculationCommand();
    ...
    void testEqualsAndHashCode() {
        TaxCalculationCommand.CreateCalculationCommand dto1 = new TaxCalculationCommand.CreateCalculationCommand();
        TaxCalculationCommand.CreateCalculationCommand dto2 = new TaxCalculationCommand.CreateCalculationCommand();
