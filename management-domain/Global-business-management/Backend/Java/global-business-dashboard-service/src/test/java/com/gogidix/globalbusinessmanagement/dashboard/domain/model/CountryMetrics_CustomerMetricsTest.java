...
class CountryMetrics_CustomerMetricsTest {

        @Test
    void testBuilder() {
        CountryMetrics.CustomerMetrics dto = CountryMetrics.CustomerMetrics.builder()
    ...
    void testSettersAndGetters() {
        CountryMetrics.CustomerMetrics dto = new CountryMetrics.CustomerMetrics();
    ...
    void testEqualsAndHashCode() {
        CountryMetrics.CustomerMetrics dto1 = CountryMetrics.CustomerMetrics.builder()
                        .averageAge(BigDecimal.TEN)
            .genderDistribution(Collections.emptyMap())
            .ageGroupDistribution(Collections.emptyMap())
            .satisfactionScore(BigDecimal.TEN)
            ...
            .bounceRate(BigDecimal.TEN)
            .build();
        CountryMetrics.CustomerMetrics dto2 = CountryMetrics.CustomerMetrics.builder()
                        .averageAge(BigDecimal.TEN)
            .genderDistribution(Collections.emptyMap())
            .ageGroupDistribution(Collections.emptyMap())
            .satisfactionScore(BigDecimal.TEN)
