...
/**
 * Input port for updating an existing market basket.
 */
public interface UpdateBasketCommand {
     ...
     * @return the criteria
     */
    com.gogidix.aiservices.aimarketbasketanalysisservice.domain.model.BasketCriteria getCriteria();
