 ...
 */
@Schema(description = "Request DTO for searching market baskets")
public record BasketSearchRequestDto(
    ...
    public static BasketSearchRequestDto create() {
        return new BasketSearchRequestDto(null, null, 0, 20, "createdAt", "DESC");
    }
}
