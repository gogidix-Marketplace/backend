...
public class OpenApiConfig {
    @Bean
    public OpenAPI inventorySyncServiceOpenAPI() {
        return new OpenAPI()
                .info(new Info()
                        .title("Inventory Sync Service API")
                        .description("REST API for inventory sync in the Gogidix E-commerce platform")
                        .version("1.0.0")
                ...
                .servers(List.of(
                        new Server().url("http://localhost:8004").description("Development"),
