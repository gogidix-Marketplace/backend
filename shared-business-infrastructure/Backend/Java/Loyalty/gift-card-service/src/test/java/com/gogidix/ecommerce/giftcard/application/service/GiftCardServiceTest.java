...
import com.gogidix.ecommerce.giftcard.shared.requestcontext.RequestContext;
...
@DisplayName("GiftCardService Tests")
class GiftCardServiceTest {

    @Mock private GiftCardRepository repository;
    @Mock private GiftCardMapper mapper;
    private GiftCardService service;

    @BeforeEach
    void setUp() {
        service = new GiftCardService(repository, mapper);
    ...
    void shouldGetById() {
        ...
        when(mapper.toResponse(entity)).thenReturn(
            new GiftCardResponse("id-1", "test", null, null, null, null, null, true, null, null));
    ...
    void shouldCreate() {
        ...
        when(mapper.toResponse(any())).thenReturn(
            new GiftCardResponse("id-1", "test", null, null, null, null, null, true, null, null));
        assertThat(service.create(new CreateGiftCardRequest("test", null, null, null, null, null))).isNotNull();
    }
    ...
    void shouldUpdate() {
        ...
        when(repository.save(any())).thenReturn(entity);
        when(mapper.toResponse(any())).thenReturn(
            new GiftCardResponse("id-1", "updated", null, null, null, null, null, true, null, null));
        assertThat(service.update("id-1", new UpdateGiftCardRequest("updated", null, null, null, null, null, null))).isNotNull();
    }
