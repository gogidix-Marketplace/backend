...
mkdir -p src/main/java/com.gogidix/centralizeddashboard/centralized-data-aggregation_CLEAN
mkdir -p src/main/resources
mkdir -p src/test/java/com.gogidix/centralizeddashboard/centralized-data-aggregation_CLEAN
