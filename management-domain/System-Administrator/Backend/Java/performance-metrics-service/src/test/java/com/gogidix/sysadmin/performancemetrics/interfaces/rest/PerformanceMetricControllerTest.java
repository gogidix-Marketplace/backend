...
import com.gogidix.sysadmin.performancemetrics.interfaces.rest.PerformanceMetricController;
...
class PerformanceMetricControllerTest {

    @Mock
    private PerformanceMetricService service;

    @InjectMocks
    private PerformanceMetricController underTest;
