...
class ThresholdValidatorTest {
    ...
    class ValidateAllThresholdsTests {
        ...
        void shouldReturnCompliantReportWhenAllThresholdsWithinLimits() {
            ...
            when(metrics.getSegmentationLatencyP95()).thenReturn(400.0);  // < 500ms
            when(metrics.getSegmentationLatencyP99()).thenReturn(800.0);  // < 1000ms
            when(metrics.getSegmentAnalysisLatencyP95()).thenReturn(150.0);  // < 200ms
        ...
        void shouldReturnNonCompliantWhenP95LatencyExceedsThreshold() {
            when(metrics.getSegmentationLatencyP95()).thenReturn(600.0);  // > 500ms
            when(metrics.getSegmentationLatencyP99()).thenReturn(800.0);
            when(metrics.getSegmentAnalysisLatencyP95()).thenReturn(150.0);
        ...
        void shouldReturnNonCompliantWhenP99LatencyExceedsThreshold() {
            when(metrics.getSegmentationLatencyP95()).thenReturn(400.0);
            when(metrics.getSegmentationLatencyP99()).thenReturn(1200.0);  // > 1000ms
            when(metrics.getSegmentAnalysisLatencyP95()).thenReturn(150.0);
            when(metrics.getErrorRate()).thenReturn(0.005);
        ...
        void shouldReturnNonCompliantWhenAnalysisLatencyExceedsThreshold() {
            when(metrics.getSegmentationLatencyP95()).thenReturn(400.0);
            when(metrics.getSegmentationLatencyP99()).thenReturn(800.0);
            when(metrics.getSegmentAnalysisLatencyP95()).thenReturn(250.0);  // > 200ms
            when(metrics.getErrorRate()).thenReturn(0.005);
    ...
    class ValidateSpecificThresholdTests {
        ...
        void shouldValidateP95Latency() {
            when(metrics.getSegmentationLatencyP95()).thenReturn(350.0);
        ...
        void shouldValidateP99Latency() {
            when(metrics.getSegmentationLatencyP99()).thenReturn(850.0);
        ...
        void shouldValidateSegmentAnalysisLatency() {
            when(metrics.getSegmentAnalysisLatencyP95()).thenReturn(150.0);
        ...
        void shouldDetectFailedP95Validation() {
            when(metrics.getSegmentationLatencyP95()).thenReturn(550.0);
    ...
    class HealthStatusTests {
        ...
        void shouldReturnDegradedWhen75PercentPass() {
            // 3 of 4 pass = 75%
            when(metrics.getSegmentationLatencyP95()).thenReturn(600.0);  // fail
            when(metrics.getSegmentationLatencyP99()).thenReturn(800.0);  // pass
            when(metrics.getSegmentAnalysisLatencyP95()).thenReturn(150.0);  // pass
        ...
        void shouldReturnDegradedWhenMoreThan75PercentPass() {
            ...
            when(metrics.getSegmentationLatencyP95()).thenReturn(400.0);  // pass
            when(metrics.getSegmentationLatencyP99()).thenReturn(1200.0);  // fail
            when(metrics.getSegmentAnalysisLatencyP95()).thenReturn(150.0);  // pass
            when(metrics.getErrorRate()).thenReturn(0.005);  // pass
        ...
        void shouldReturnUnhealthyWhenAllThresholdsFail() {
            when(metrics.getSegmentationLatencyP95()).thenReturn(600.0);
            when(metrics.getSegmentationLatencyP99()).thenReturn(1200.0);
            when(metrics.getSegmentAnalysisLatencyP95()).thenReturn(250.0);
