...
import com.gogidix.management.executive.workflow.application.query.WorkflowQueryService;
...
class WorkflowQueryServiceTest {
    ...
    @Test
    void handle() {
        GetWorkflowQuery query = new GetWorkflowQuery();
        query.setWorkflowId("test-workflowId");
    ...
    void exists() {
        ...
        try {
        boolean result = service.exists(workflowId, tenantId);
