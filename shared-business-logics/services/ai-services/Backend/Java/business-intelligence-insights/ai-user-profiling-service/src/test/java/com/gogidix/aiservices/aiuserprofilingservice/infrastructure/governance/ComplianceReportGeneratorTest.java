...
class ComplianceReportGeneratorTest {
    ...
    class ReportGenerationTests {
        ...
        void shouldPopulateSloComplianceSection() {
            Timer segmentationTimer = meterRegistry.timer("segmentation.duration", "service", "ai-customer-segmentation");
            ...
            Counter totalCounter = meterRegistry.counter("segmentation.total", "service", "ai-customer-segmentation");
            Counter failureCounter = meterRegistry.counter("segmentation.failure", "service", "ai-customer-segmentation");
        ...
        void shouldPopulatePerformanceMetricsSection() {
            Counter totalCounter = meterRegistry.counter("segmentation.total", "service", "ai-customer-segmentation");
            Counter successCounter = meterRegistry.counter("segmentation.success", "service", "ai-customer-segmentation");
            Counter failureCounter = meterRegistry.counter("segmentation.failure", "service", "ai-customer-segmentation");
            Counter createdCounter = meterRegistry.counter("segment.created", "service", "ai-customer-segmentation");
            Counter updatedCounter = meterRegistry.counter("segment.updated", "service", "ai-customer-segmentation");
            Counter analyzedCounter = meterRegistry.counter("customer.analyzed", "service", "ai-customer-segmentation");
            ...
            assertThat(perf.getTotalProfileations()).isEqualTo(5000L);
            assertThat(perf.getSuccessfulProfileations()).isEqualTo(4750L);
            assertThat(perf.getFailedProfileations()).isEqualTo(250L);
            assertThat(perf.getProfilesCreated()).isEqualTo(100L);
            assertThat(perf.getProfilesUpdated()).isEqualTo(50L);
            assertThat(perf.getUsersAnalyzed()).isEqualTo(50000L);
        }
    ...
    private void recordGoodMetrics() {
        ...
        Timer analysisTimer = meterRegistry.timer("segment.analysis.duration", "service", "ai-customer-segmentation");
