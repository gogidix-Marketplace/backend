package com.gogidix.aiservices.aiorchestrationservice.governance;

import com.gogidix.aiservices.aiorchestrationservice.infrastructure.governance.ComplianceReportGenerator;
import com.gogidix.aiservices.aiorchestrationservice.infrastructure.governance.ThresholdValidator;
...
class GovernanceEnforcementTest {
    ...
    private final AiOrchestrationMetrics metrics = new AiOrchestrationMetrics(new SimpleMeterRegistry());
