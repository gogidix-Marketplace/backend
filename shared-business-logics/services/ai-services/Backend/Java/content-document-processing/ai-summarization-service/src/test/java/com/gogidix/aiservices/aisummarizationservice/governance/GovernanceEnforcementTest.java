package com.gogidix.aiservices.aisummarizationservice.governance;

import com.gogidix.aiservices.aisummarizationservice.infrastructure.governance.ComplianceReportGenerator;
import com.gogidix.aiservices.aisummarizationservice.infrastructure.governance.ThresholdValidator;
...
class GovernanceEnforcementTest {
    ...
    class ThresholdValidationTests {
        ...
        void shouldValidateP95LatencyThreshold() {
            ...
            for (int i = 0; i < 20; i++) {
                ...
                metrics.recordSummarizationTime(100 + (i % 400));
            }
        ...
        void shouldValidateErrorRateThreshold() {
            ...
            for (int i = 0; i < 10; i++) {
                ...
                if (i % 10 != 0) {
                    ...
                    metrics.incrementSummarizationFailure();
                }
            }
    ...
    class ComplianceReportTests {
        ...
        void shouldGenerateComplianceReport() {
            ...
            assertThat(report.getReportId()).startsWith("GOV-SUMM-");
