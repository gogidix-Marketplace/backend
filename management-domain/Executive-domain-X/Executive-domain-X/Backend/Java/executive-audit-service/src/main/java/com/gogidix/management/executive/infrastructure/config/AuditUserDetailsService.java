...
import com.gogidix.management.executive.audit.domain.model.DomainException;
...
/**
 * User Details Service for Executive Audit
 * Loads user-specific data for authentication
 */
@Service
public class AuditUserDetailsService implements UserDetailsService {

    private static final Logger log = LoggerFactory.getLogger(AuditUserDetailsService.class);
