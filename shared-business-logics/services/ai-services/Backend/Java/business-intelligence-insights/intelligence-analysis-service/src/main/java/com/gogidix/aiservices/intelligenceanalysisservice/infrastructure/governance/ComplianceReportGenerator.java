...
public class ComplianceReportGenerator {
    ...
    private final IntelligenceAnalysisationMetrics metrics;
    ...
    public ComplianceReportGenerator(
            IntelligenceAnalysisationMetrics metrics,
    ...
    private PerformanceMetricsSection generatePerformanceSection() {
        ...
        section.setTotalAnalysiss((long) metrics.getMeterRegistry()
                .get("segmentation.total").counter().count());

        section.setSuccessfulAnalysiss((long) metrics.getMeterRegistry()
                .get("segmentation.success").counter().count());

        section.setFailedAnalysiss((long) metrics.getMeterRegistry()
                .get("segmentation.failure").counter().count());

        section.setAnalysissCreated((long) metrics.getMeterRegistry()
                .get("segment.created").counter().count());

        section.setAnalysissUpdated((long) metrics.getMeterRegistry()
                .get("segment.updated").counter().count());

        section.setIntelligenceReportsAnalyzed((long) metrics.getMeterRegistry()
    ...
    public static class GovernanceReport {
        ...
        private Map<String, Object> performanceMetricsToMap() {
            Map<String, Object> map = new HashMap<>();
            map.put("totalAnalysiss", performanceMetrics.getTotalAnalysiss());
            map.put("successfulAnalysiss", performanceMetrics.getSuccessfulAnalysiss());
            map.put("failedAnalysiss", performanceMetrics.getFailedAnalysiss());
            map.put("segmentsCreated", performanceMetrics.getAnalysissCreated());
            map.put("customersAnalyzed", performanceMetrics.getIntelligenceReportsAnalyzed());
            return map;
        }
    ...
    public static class PerformanceMetricsSection {
        private long totalAnalysiss;
        private long successfulAnalysiss;
        private long failedAnalysiss;
        ...
        // Getters and Setters
        public long getTotalAnalysiss() { return totalAnalysiss; }
        public void setTotalAnalysiss(long totalAnalysiss) { this.totalAnalysiss = totalAnalysiss; }
        public long getSuccessfulAnalysiss() { return successfulAnalysiss; }
        public void setSuccessfulAnalysiss(long successfulAnalysiss) { this.successfulAnalysiss = successfulAnalysiss; }
        public long getFailedAnalysiss() { return failedAnalysiss; }
        public void setFailedAnalysiss(long failedAnalysiss) { this.failedAnalysiss = failedAnalysiss; }
        public long getAnalysissCreated() { return segmentsCreated; }
        public void setAnalysissCreated(long segmentsCreated) { this.segmentsCreated = segmentsCreated; }
        public long getAnalysissUpdated() { return segmentsUpdated; }
        public void setAnalysissUpdated(long segmentsUpdated) { this.segmentsUpdated = segmentsUpdated; }
        public long getIntelligenceReportsAnalyzed() { return customersAnalyzed; }
        public void setIntelligenceReportsAnalyzed(long customersAnalyzed) { this.customersAnalyzed = customersAnalyzed; }
