...
import com.gogidix.management.executive.financial.application.command.FinancialDataCommandService;
...
class FinancialDataCommandServiceTest {
    ...
    @InjectMocks
    private FinancialDataCommandService service;
    ...
    @Test
    void handle() {
        CreateFinancialDataCommand command = new CreateFinancialDataCommand();
