package com.gogidix.aiservices.aiuserprofilingservice.infrastructure.governance;

import com.gogidix.aiservices.aiuserprofilingservice.infrastructure.metrics.UserProfileationMetrics;
...
public class ComplianceReportGenerator {
    ...
    private final UserProfileationMetrics metrics;
    ...
    public ComplianceReportGenerator(
            UserProfileationMetrics metrics,
    ...
    private SloComplianceSection generateSloComplianceSection() {
        ...
        // P95 Latency
        double p95Latency = metrics.getProfileationLatencyP95();
        ...
        // P99 Latency
        double p99Latency = metrics.getProfileationLatencyP99();
    ...
    private PerformanceMetricsSection generatePerformanceSection() {
        ...
        section.setTotalProfileations((long) metrics.getMeterRegistry()
                .get("segmentation.total").counter().count());

        section.setSuccessfulProfileations((long) metrics.getMeterRegistry()
                .get("segmentation.success").counter().count());

        section.setFailedProfileations((long) metrics.getMeterRegistry()
                .get("segmentation.failure").counter().count());

        section.setProfilesCreated((long) metrics.getMeterRegistry()
                .get("segment.created").counter().count());

        section.setProfilesUpdated((long) metrics.getMeterRegistry()
                .get("segment.updated").counter().count());

        section.setUsersAnalyzed((long) metrics.getMeterRegistry()
    ...
    public static class GovernanceReport {
        ...
        private Map<String, Object> performanceMetricsToMap() {
            Map<String, Object> map = new HashMap<>();
            map.put("totalProfileations", performanceMetrics.getTotalProfileations());
            map.put("successfulProfileations", performanceMetrics.getSuccessfulProfileations());
            map.put("failedProfileations", performanceMetrics.getFailedProfileations());
            map.put("segmentsCreated", performanceMetrics.getProfilesCreated());
            map.put("customersAnalyzed", performanceMetrics.getUsersAnalyzed());
            return map;
        }
    ...
    public static class PerformanceMetricsSection {
        private long totalProfileations;
        private long successfulProfileations;
        private long failedProfileations;
        ...
        // Getters and Setters
        public long getTotalProfileations() { return totalProfileations; }
        public void setTotalProfileations(long totalProfileations) { this.totalProfileations = totalProfileations; }
        public long getSuccessfulProfileations() { return successfulProfileations; }
        public void setSuccessfulProfileations(long successfulProfileations) { this.successfulProfileations = successfulProfileations; }
        public long getFailedProfileations() { return failedProfileations; }
        public void setFailedProfileations(long failedProfileations) { this.failedProfileations = failedProfileations; }
        public long getProfilesCreated() { return segmentsCreated; }
        public void setProfilesCreated(long segmentsCreated) { this.segmentsCreated = segmentsCreated; }
        public long getProfilesUpdated() { return segmentsUpdated; }
        public void setProfilesUpdated(long segmentsUpdated) { this.segmentsUpdated = segmentsUpdated; }
        public long getUsersAnalyzed() { return customersAnalyzed; }
        public void setUsersAnalyzed(long customersAnalyzed) { this.customersAnalyzed = customersAnalyzed; }
