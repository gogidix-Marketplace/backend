...
import com.gogidix.aiservices.aichurnpredictionservice.infrastructure.governance.ComplianceReportGenerator;
...
class GovernanceEnforcementTest {
    ...
    private ChurnPredictionApplicationService segmentApplicationService;
        ...
        void shouldValidateP95LatencyThreshold() {
            ...
            for (int i = 0; i < 20; i++) {
                try {
                    ...
                    metrics.recordPredictionTime(100 + (i * 10));
                } catch (Exception e) {
                    // Ignore
                }
            }
    ...
    class ComplianceReportTests {
        ...
        void shouldIncludePerformanceMetricsSection() {
            ...
            for (int i = 0; i < 5; i++) {
                metrics.incrementPredictionTotal();
                metrics.recordPredictionTime(100);
            }
            ...
            assertThat(perf.getTotalPredictions()).isGreaterThanOrEqualTo(0);
            assertThat(perf.getSuccessfulPredictions()).isGreaterThanOrEqualTo(0);
        }
