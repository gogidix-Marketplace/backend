...
class GovernanceGenTest {
    private VoiceRecognitionMetrics m; private ThresholdValidator v; private ComplianceReportGenerator g;
    @BeforeEach void setup() { m = new VoiceRecognitionMetrics(new SimpleMeterRegistry()); v = new ThresholdValidator(m); g = new ComplianceReportGenerator(m, v); }
