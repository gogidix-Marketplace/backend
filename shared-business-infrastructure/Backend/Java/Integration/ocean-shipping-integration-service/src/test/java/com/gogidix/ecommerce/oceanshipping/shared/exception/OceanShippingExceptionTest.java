...
@DisplayName("OceanShipping Exception Tests")
class OceanShippingExceptionTest {

    @Test
    @DisplayName("Should create not found exception")
    void shouldCreateNotFoundException() {
        OceanShippingNotFoundException ex = new OceanShippingNotFoundException("id-1");
    ...
    void shouldCreateDuplicateException() {
        DuplicateOceanShippingException ex = new DuplicateOceanShippingException("name-1");
    ...
    void shouldCreateInvalidException() {
        InvalidOceanShippingException ex = new InvalidOceanShippingException("bad data");
    ...
    void shouldCreateInvalidExceptionWithCause() {
        ...
        InvalidOceanShippingException ex = new InvalidOceanShippingException("msg", cause);
