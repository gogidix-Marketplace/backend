...
@DisplayName("PushNotification Exception Tests")
class PushNotificationExceptionTest {

    @Test
    @DisplayName("Should create not found exception")
    void shouldCreateNotFoundException() {
        PushNotificationNotFoundException ex = new PushNotificationNotFoundException("id-1");
    ...
    void shouldCreateDuplicateException() {
        DuplicatePushNotificationException ex = new DuplicatePushNotificationException("name-1");
    ...
    void shouldCreateInvalidException() {
        InvalidPushNotificationException ex = new InvalidPushNotificationException("bad data");
    ...
    void shouldCreateInvalidExceptionWithCause() {
        ...
        InvalidPushNotificationException ex = new InvalidPushNotificationException("msg", cause);
