...
class ComplianceCheckController_CreateCheckRequestDtoTest {

        @Test
    void testSettersAndGetters() {
        ComplianceCheckController.CreateCheckRequestDto dto = new ComplianceCheckController.CreateCheckRequestDto();
    ...
    void testEqualsAndHashCode() {
        ComplianceCheckController.CreateCheckRequestDto dto1 = new ComplianceCheckController.CreateCheckRequestDto();
        ComplianceCheckController.CreateCheckRequestDto dto2 = new ComplianceCheckController.CreateCheckRequestDto();
        dto1.setRuleId("test");
