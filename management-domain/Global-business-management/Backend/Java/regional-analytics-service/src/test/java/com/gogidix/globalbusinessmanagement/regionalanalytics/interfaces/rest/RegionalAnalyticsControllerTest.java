...
import com.gogidix.globalbusinessmanagement.regionalanalytics.interfaces.rest.RegionalAnalyticsController;
...
class RegionalAnalyticsControllerTest {

    @Mock
    private RegionalAnalyticsService service;

    @InjectMocks
    private RegionalAnalyticsController underTest;
