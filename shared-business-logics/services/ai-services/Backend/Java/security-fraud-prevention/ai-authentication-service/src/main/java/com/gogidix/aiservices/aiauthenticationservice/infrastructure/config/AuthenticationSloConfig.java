...
public class AuthenticationSloConfig {
    ...
    public long getLatencyThreshold(String sloName, String thresholdType) {
        ...
        return 200L; // Default threshold for authentication (stricter than fraud detection)
    }
