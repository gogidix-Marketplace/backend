...
/**
 * Domain event fired when a product recommendation is updated.
 */
public class RecommendationUpdatedEvent implements DomainEvent {
    ...
    public RecommendationUpdatedEvent(String aggregateId, String tenantId, String oldName,
    ...
    public boolean equals(Object o) {
        ...
        RecommendationUpdatedEvent that = (RecommendationUpdatedEvent) o;
    ...
    public String toString() {
        return "RecommendationUpdatedEvent{" +
                "eventId='" + eventId + '\'' +
