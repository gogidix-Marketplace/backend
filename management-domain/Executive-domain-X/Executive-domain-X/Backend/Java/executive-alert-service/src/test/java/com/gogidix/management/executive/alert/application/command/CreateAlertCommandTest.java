...
class CreateAlertCommandTest {

        @Test
    void testBuilder() {
        CreateAlertCommand dto = CreateAlertCommand.builder()
    ...
    void testSettersAndGetters() {
        CreateAlertCommand dto = new CreateAlertCommand();
    ...
    void testEqualsAndHashCode() {
        CreateAlertCommand dto1 = CreateAlertCommand.builder()
                        .tenantId("test-tenantId")
            .name("test-name")
            .description("test-description")
            .ownerId("test-ownerId")
            ...
            .widgets(Collections.emptyList())
            .build();
        CreateAlertCommand dto2 = CreateAlertCommand.builder()
                        .tenantId("test-tenantId")
            .name("test-name")
            .description("test-description")
            .ownerId("test-ownerId")
