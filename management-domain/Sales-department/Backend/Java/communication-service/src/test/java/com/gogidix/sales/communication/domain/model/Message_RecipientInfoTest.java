...
class Message_RecipientInfoTest {

        @Test
    void testBuilder() {
        Message.RecipientInfo dto = Message.RecipientInfo.builder()
    ...
    void testSettersAndGetters() {
        Message.RecipientInfo dto = new Message.RecipientInfo();
    ...
    void testEqualsAndHashCode() {
        Message.RecipientInfo dto1 = Message.RecipientInfo.builder()
                        .recipientId("test-recipientId")
            .recipientName("test-recipientName")
            .recipientType("test-recipientType")
            .emailAddress("test-emailAddress")
            ...
            .deliveredAt(Instant.parse("2025-01-15T10:00:00Z"))
            .build();
        Message.RecipientInfo dto2 = Message.RecipientInfo.builder()
                        .recipientId("test-recipientId")
            .recipientName("test-recipientName")
            .recipientType("test-recipientType")
            .emailAddress("test-emailAddress")
