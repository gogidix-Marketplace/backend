package com.gogidix.ecommerce.realtime.infrastructure.config;
...
public class OpenApiConfig {
    ...
    public OpenAPI realtimeTrackingServiceOpenAPI() {
        return new OpenAPI()
                .info(new Info()
                        .title("Realtime Tracking Service API")
                        .description("REST API for realtime tracking in the Gogidix E-commerce platform")
                        .version("1.0.0")
                ...
                .servers(List.of(
                        new Server().url("http://localhost:8088").description("Development"),
