...
export function DashboardLayout() {
  ...
  const navItems = [
    ...
    { title: 'Regional Analytics', href: '/regional-analytics', icon: 'Globe' },
    { title: 'Country Management', href: '/country-management', icon: 'Map' },
    { title: 'Currency Management', href: '/currency', icon: 'DollarSign' },
    { title: 'Data Aggregation', href: '/aggregation', icon: 'Database' },
