...
class CashflowForecast_ForecastVarianceTest {

        @Test
    void testBuilder() {
        CashflowForecast.ForecastVariance dto = CashflowForecast.ForecastVariance.builder()
    ...
    void testSettersAndGetters() {
        CashflowForecast.ForecastVariance dto = new CashflowForecast.ForecastVariance();
    ...
    void testEqualsAndHashCode() {
        CashflowForecast.ForecastVariance dto1 = CashflowForecast.ForecastVariance.builder()
                        .category("test-category")
            .forecastedAmount(BigDecimal.TEN)
            .actualAmount(BigDecimal.TEN)
            .variance(BigDecimal.TEN)
            ...
            .periodDate(LocalDate.of(2025,1,15))
            .build();
        CashflowForecast.ForecastVariance dto2 = CashflowForecast.ForecastVariance.builder()
                        .category("test-category")
            .forecastedAmount(BigDecimal.TEN)
            .actualAmount(BigDecimal.TEN)
            .variance(BigDecimal.TEN)
