package com.gogidix.aiservices.aicustomersegmentationservice.domain.event;
 ...
 */
public class CustomersAddedToSegmentEvent implements DomainEvent {
    ...
    public CustomersAddedToSegmentEvent(String aggregateId, String tenantId, String segmentName,
    ...
    public boolean equals(Object o) {
        ...
        CustomersAddedToSegmentEvent that = (CustomersAddedToSegmentEvent) o;
    ...
    public String toString() {
        return "CustomersAddedToSegmentEvent{" +
                "eventId='" + eventId + '\'' +
