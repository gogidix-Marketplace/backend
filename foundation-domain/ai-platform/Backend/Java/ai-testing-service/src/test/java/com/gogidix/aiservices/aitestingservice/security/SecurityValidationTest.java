package com.gogidix.aiservices.aitestingservice.security;
...
class SecurityValidationTest {
    ...
    class InputValidationTests {
        ...
        @Test
        @Order(1)
        @DisplayName("Should reject null testId")
        void shouldRejectNullTestId() {
            assertThatThrownBy(() -> {
                if (null == null) {
        ...
        void shouldHandleSqlInjectionAttempts() {
            String maliciousInput = "'; DROP TABLE tests; --";
    ...
    class TenantIsolationTests {
        ...
        @Test
        @Order(10)
        @DisplayName("Should isolate tests by tenant")
        void shouldIsolateTestsByTenant() {
            String tenant1 = "tenant-1";
            String tenant2 = "tenant-2";

            // Tests for tenant1 should not affect tenant2
    ...
    class ResourceLimitsTests {
        ...
        @Test
        @Order(20)
        @DisplayName("Should enforce test result limit")
        void shouldEnforceTestResultLimit() {
            // Simulate large test result set
    ...
    class AuthenticationContextTests {
        ...
        void shouldPreventUnauthorizedCrossTenantAccess() {
            ...
            // Attempting test from different tenant context
            assertThat(tenant1).isNotEqualTo(tenant2);
        }
    }
}
