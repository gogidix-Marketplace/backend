...
class GovernanceGenTest {
    ...
    @BeforeEach
    void setup() {
        metrics = new SearchMetrics(new SimpleMeterRegistry());
    ...
    @Test
    void validate_SEARCH_ENGINE_LATENCY() {
        var r = validator.validateThreshold(ThresholdValidator.ThresholdType.SEARCH_ENGINE_LATENCY);
        assertThat(r).isNotNull();
    }
