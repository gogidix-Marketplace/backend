...
import com.gogidix.aiservices.aichurnpredictionservice.shared.exception.ConflictException;

import java.util.List;

/**
 * Business rule policy: Prediction names must be unique within a tenant.
 * Enforces uniqueness to prevent confusion and conflicts.
 */
public class PredictionNameUniquePolicy {
