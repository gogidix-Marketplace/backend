...
class ForecastController_AddLineItemRequestDtoTest {

        @Test
    void testSettersAndGetters() {
        ForecastController.AddLineItemRequestDto dto = new ForecastController.AddLineItemRequestDto();
    ...
    void testEqualsAndHashCode() {
        ForecastController.AddLineItemRequestDto dto1 = new ForecastController.AddLineItemRequestDto();
        ForecastController.AddLineItemRequestDto dto2 = new ForecastController.AddLineItemRequestDto();
        dto1.setName("test");
