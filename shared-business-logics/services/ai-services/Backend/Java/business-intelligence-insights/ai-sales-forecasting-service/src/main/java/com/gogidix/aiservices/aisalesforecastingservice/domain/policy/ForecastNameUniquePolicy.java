...
import com.gogidix.aiservices.aisalesforecastingservice.shared.exception.ConflictException;

import java.util.List;

/**
 * Business rule policy: Forecast names must be unique within a tenant.
 * Enforces uniqueness to prevent confusion and conflicts.
 */
public class ForecastNameUniquePolicy {
