...
public class ComplianceReportGenerator {
    ...
    public ComplianceReportGenerator(
            CustomerFeedbackMetrics metrics,
    ...
    private PerformanceMetricsSection generatePerformanceSection() {
        ...
        section.setTotalRequests((long) metrics.getMeterRegistry()
                .get("ai.customer.feedback.total").counter().count());
        section.setSuccessfulRequests((long) metrics.getMeterRegistry()
                .get("ai.customer.feedback.success").counter().count());
        section.setFailedRequests((long) metrics.getMeterRegistry()
                .get("ai.customer.feedback.failure").counter().count());
        section.setFeedbackProcessed((long) metrics.getMeterRegistry()
                .get("ai.customer.feedback.processed").counter().count());
    ...
    public static class PerformanceMetricsSection {
        ...
        private long feedbackProcessed;
        ...
        public long getFeedbackProcessed() { return feedbackProcessed; }
        public void setFeedbackProcessed(long feedbackProcessed) { this.feedbackProcessed = feedbackProcessed; }
