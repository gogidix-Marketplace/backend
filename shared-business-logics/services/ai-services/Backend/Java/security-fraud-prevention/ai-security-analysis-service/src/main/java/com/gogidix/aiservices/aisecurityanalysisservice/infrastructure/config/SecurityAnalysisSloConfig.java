package com.gogidix.aiservices.aisecurityanalysisservice.infrastructure.config;
...
public class SecurityAnalysisSloConfig {
    ...
    public long getLatencyThreshold(String sloName, String thresholdType) {
        ...
        // Security analysis can take longer - default 5 seconds
        return 5000L;
    }
