...
class EmailExceptionTest {
    ...
    void shouldCreateDuplicateException() {
        DuplicateEmailException ex = new DuplicateEmailException("name-1");
    ...
    void shouldCreateInvalidException() {
        InvalidEmailException ex = new InvalidEmailException("bad data");
    ...
    void shouldCreateInvalidExceptionWithCause() {
        ...
        InvalidEmailException ex = new InvalidEmailException("msg", cause);
