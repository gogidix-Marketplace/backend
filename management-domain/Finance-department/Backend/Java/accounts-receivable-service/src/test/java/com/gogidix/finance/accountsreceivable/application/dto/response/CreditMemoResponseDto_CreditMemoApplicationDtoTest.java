...
class CreditMemoResponseDto_CreditMemoApplicationDtoTest {

        @Test
    void testBuilder() {
        CreditMemoResponseDto.CreditMemoApplicationDto dto = CreditMemoResponseDto.CreditMemoApplicationDto.builder()
    ...
    void testSettersAndGetters() {
        CreditMemoResponseDto.CreditMemoApplicationDto dto = new CreditMemoResponseDto.CreditMemoApplicationDto();
    ...
    void testEqualsAndHashCode() {
        CreditMemoResponseDto.CreditMemoApplicationDto dto1 = CreditMemoResponseDto.CreditMemoApplicationDto.builder()
                        .applicationId("test-applicationId")
            .invoiceId("test-invoiceId")
            .invoiceNumber("test-invoiceNumber")
            .appliedAmount(BigDecimal.TEN)
            ...
            .appliedBy("test-appliedBy")
            .build();
        CreditMemoResponseDto.CreditMemoApplicationDto dto2 = CreditMemoResponseDto.CreditMemoApplicationDto.builder()
                        .applicationId("test-applicationId")
            .invoiceId("test-invoiceId")
            .invoiceNumber("test-invoiceNumber")
            .appliedAmount(BigDecimal.TEN)
