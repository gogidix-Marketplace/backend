...
class TerritoryAssignmentCommand_CreateAssignmentCommandTest {

        @Test
    void testSettersAndGetters() {
        TerritoryAssignmentCommand.CreateAssignmentCommand dto = new TerritoryAssignmentCommand.CreateAssignmentCommand();
    ...
    void testEqualsAndHashCode() {
        TerritoryAssignmentCommand.CreateAssignmentCommand dto1 = new TerritoryAssignmentCommand.CreateAssignmentCommand();
        TerritoryAssignmentCommand.CreateAssignmentCommand dto2 = new TerritoryAssignmentCommand.CreateAssignmentCommand();
