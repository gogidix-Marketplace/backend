package com.gogidix.aiservices.intelligenceanalysisservice.multitenancy;
...
class MultiTenancyTest {
    ...
    class CrossTenantAccessTests {
        ...
        void shouldPreventCrossTenantAnalysisAccess() {
        ...
        void shouldPreventCrossTenantIntelligenceReportAccess() {
    ...
    class TenantQuotaTests {
        ...
        void shouldEnforcePerTenantAnalysisLimits() {
        ...
        void shouldEnforcePerTenantIntelligenceReportLimits() {
