...
@DisplayName("PaymentValidationPolicy Tests")
class PaymentValidationPolicyTest {

    private PaymentValidationPolicy policy;

    @BeforeEach
    void setUp() { policy = new PaymentValidationPolicy(); }
