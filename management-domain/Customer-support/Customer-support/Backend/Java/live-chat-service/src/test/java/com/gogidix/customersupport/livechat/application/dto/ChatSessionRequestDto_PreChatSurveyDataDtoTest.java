...
class ChatSessionRequestDto_PreChatSurveyDataDtoTest {

        @Test
    void testBuilder() {
        ChatSessionRequestDto.PreChatSurveyDataDto dto = ChatSessionRequestDto.PreChatSurveyDataDto.builder()
    ...
    void testSettersAndGetters() {
        ChatSessionRequestDto.PreChatSurveyDataDto dto = new ChatSessionRequestDto.PreChatSurveyDataDto();
    ...
    void testEqualsAndHashCode() {
        ChatSessionRequestDto.PreChatSurveyDataDto dto1 = ChatSessionRequestDto.PreChatSurveyDataDto.builder()
                        .question1("test-question1")
            .answer1("test-answer1")
            .question2("test-question2")
            .answer2("test-answer2")
            ...
            .answer3("test-answer3")
            .build();
        ChatSessionRequestDto.PreChatSurveyDataDto dto2 = ChatSessionRequestDto.PreChatSurveyDataDto.builder()
                        .question1("test-question1")
            .answer1("test-answer1")
            .question2("test-question2")
            .answer2("test-answer2")
