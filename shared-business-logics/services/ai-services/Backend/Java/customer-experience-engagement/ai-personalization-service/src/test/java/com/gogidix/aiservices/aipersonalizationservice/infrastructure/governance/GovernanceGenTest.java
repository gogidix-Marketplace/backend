...
class GovernanceGenTest {
    ...
    @BeforeEach
    void setup() {
        metrics = new PersonalizationMetrics(new SimpleMeterRegistry());
    ...
    @Test
    void validate_PROFILE_MATCHING_LATENCY() {
        var r = validator.validateThreshold(ThresholdValidator.ThresholdType.PROFILE_MATCHING_LATENCY);
        assertThat(r).isNotNull();
    }
