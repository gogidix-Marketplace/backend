...
import com.gogidix.aiservices.aiuserprofilingservice.shared.exception.ConflictException;

import java.util.List;

/**
 * Business rule policy: Profile names must be unique within a tenant.
 * Enforces uniqueness to prevent confusion and conflicts.
 */
public class ProfileNameUniquePolicy {
