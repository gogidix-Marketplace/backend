...
class ContactResponseDto_AddressDtoTest {

        @Test
    void testBuilder() {
        ContactResponseDto.AddressDto dto = ContactResponseDto.AddressDto.builder()
                        .street("test-street")
            .city("test-city")
            .state("test-state")
    ...
    void testSettersAndGetters() {
        ContactResponseDto.AddressDto dto = new ContactResponseDto.AddressDto();
    ...
    void testEqualsAndHashCode() {
        ContactResponseDto.AddressDto dto1 = ContactResponseDto.AddressDto.builder()
                        .street("test-street")
            .city("test-city")
            .state("test-state")
            .postalCode("test-postalCode")
            .country("test-country")
            .build();
        ContactResponseDto.AddressDto dto2 = ContactResponseDto.AddressDto.builder()
                        .street("test-street")
            .city("test-city")
            .state("test-state")
            .postalCode("test-postalCode")
