package com.gogidix.aiservices.aidatavalidation.governance;
...
import com.gogidix.aiservices.aidatavalidation.infrastructure.governance.ComplianceReportGenerator;
import com.gogidix.aiservices.aidatavalidation.infrastructure.governance.ThresholdValidator;
...
class GovernanceEnforcementTest {
    ...
    class ThresholdValidationTests {
        ...
        void shouldValidateP95LatencyThreshold() {
            ...
            for (int i = 0; i < 20; i++) {
                try {
                    ValidateDatasetRequest request = createTestRequest("p95-validation-" + i);
        ...
        void shouldValidateErrorRateThreshold() {
            ...
            for (int i = 0; i < 10; i++) {
                try {
                    ValidateDatasetRequest request = createTestRequest("error-rate-val-" + i);
                    validationService.validateDataset(request);
                } catch (Exception e) {
    ...
    class ComplianceReportTests {
        ...
        void shouldIncludePerformanceMetricsSection() {
            ...
            for (int i = 0; i < 5; i++) {
                try {
                    validationService.validateDataset(createTestRequest("perf-metrics-" + i));
                } catch (Exception e) {
                    // Ignore
                }
            }
    ...
    class ThresholdEnforcementTests {
        ...
        void shouldEnforceLatencyThreshold() {
            ...
            for (int i = 0; i < requests; i++) {
                try {
                    validationService.validateDataset(createTestRequest("enforce-latency-" + i));
                } catch (Exception e) {
                    // Ignore
                }
            }
        ...
        void shouldEnforceErrorRateThreshold() {
            ...
            for (int i = 0; i < requests; i++) {
                try {
                    validationService.validateDataset(createTestRequest("enforce-error-" + i));
                } catch (Exception e) {
                    failures++;
                }
            }
