package com.gogidix.management.executive.workflow.config;

import com.gogidix.management.executive.workflow.domain.model.DomainException;
...
/**
 * User Details Service for Executive Workflow
 * Loads user-specific data for authentication
 */
@Service
public class WorkflowUserDetailsService implements UserDetailsService {

    private static final Logger log = LoggerFactory.getLogger(WorkflowUserDetailsService.class);
