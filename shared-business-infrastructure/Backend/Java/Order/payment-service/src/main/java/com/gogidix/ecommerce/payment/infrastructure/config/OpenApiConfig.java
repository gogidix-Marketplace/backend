package com.gogidix.ecommerce.payment.order.infrastructure.config;
...
public class OpenApiConfig {
    @Bean
    public OpenAPI orderPaymentServiceOpenAPI() {
        return new OpenAPI()
                .info(new Info()
                        .title("Order Payment Service API")
                        .description("REST API for order payment in the Gogidix E-commerce platform")
                        .version("1.0.0")
                ...
                .servers(List.of(
                        new Server().url("http://localhost:8007").description("Development"),
