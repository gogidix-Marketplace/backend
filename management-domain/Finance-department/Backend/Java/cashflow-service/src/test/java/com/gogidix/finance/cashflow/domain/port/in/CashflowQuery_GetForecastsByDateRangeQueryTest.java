...
class CashflowQuery_GetForecastsByDateRangeQueryTest {

        @Test
    void testSettersAndGetters() {
        CashflowQuery.GetForecastsByDateRangeQuery dto = new CashflowQuery.GetForecastsByDateRangeQuery();
    ...
    void testEqualsAndHashCode() {
        CashflowQuery.GetForecastsByDateRangeQuery dto1 = new CashflowQuery.GetForecastsByDateRangeQuery();
        CashflowQuery.GetForecastsByDateRangeQuery dto2 = new CashflowQuery.GetForecastsByDateRangeQuery();
