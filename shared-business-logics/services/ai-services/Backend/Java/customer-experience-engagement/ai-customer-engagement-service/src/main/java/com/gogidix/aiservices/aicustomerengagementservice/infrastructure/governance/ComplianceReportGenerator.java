...
public class ComplianceReportGenerator {
    ...
    private final CustomerEngagementMetrics metrics;
    ...
    public ComplianceReportGenerator(
            CustomerEngagementMetrics metrics,
    ...
    private SloComplianceSection generateSloComplianceSection() {
        ...
        // P99 Latency
        double p99Latency = metrics.getEngagementLatencyP99();
        section.setP99LatencyMs(p99Latency);
        section.setP99LatencyCompliant(p99Latency <= 400.0);
    ...
    private PerformanceMetricsSection generatePerformanceSection() {
        ...
        section.setCampaignsCreated((long) metrics.getMeterRegistry()
                .get("engagement.campaigns.created").counter().count());

        section.setMessagesSent((long) metrics.getMeterRegistry()
                .get("engagement.messages.sent").counter().count());

        section.setInteractionsRecorded((long) metrics.getMeterRegistry()
    ...
    public static class GovernanceReport {
        ...
        private Map<String, Object> performanceMetricsToMap() {
            ...
            map.put("campaignsCreated", performanceMetrics.getCampaignsCreated());
            return map;
        }
    ...
    public static class PerformanceMetricsSection {
        ...
        private long campaignsCreated;
        private long messagesSent;
        private long interactionsRecorded;
        ...
        public long getCampaignsCreated() { return campaignsCreated; }
        public void setCampaignsCreated(long campaignsCreated) { this.campaignsCreated = campaignsCreated; }
        ...
        public long getInteractionsRecorded() { return interactionsRecorded; }
        public void setInteractionsRecorded(long interactionsRecorded) { this.interactionsRecorded = interactionsRecorded; }
