...
class CashflowItemCommand_CreateCashflowItemCommandTest {

        @Test
    void testSettersAndGetters() {
        CashflowItemCommand.CreateCashflowItemCommand dto = new CashflowItemCommand.CreateCashflowItemCommand();
    ...
    void testEqualsAndHashCode() {
        CashflowItemCommand.CreateCashflowItemCommand dto1 = new CashflowItemCommand.CreateCashflowItemCommand();
        CashflowItemCommand.CreateCashflowItemCommand dto2 = new CashflowItemCommand.CreateCashflowItemCommand();
