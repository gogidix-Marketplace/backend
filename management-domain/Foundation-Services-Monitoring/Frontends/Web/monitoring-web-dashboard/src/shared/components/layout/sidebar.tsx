        ...
        {!collapsed && (
          <div className="flex items-center gap-2">
            ...
            <div className="flex flex-col">
              ...
              <span className="text-xs text-muted-foreground">Foundation Services</span>
            </div>
          </div>
        )}
        <button
        ...
        <div className="border-t p-4">
          <div className="flex items-center gap-3 rounded-lg bg-white dark:bg-slate-800 p-3 shadow-sm">
            ...
            <div className="flex-1 text-xs">
              <p className="font-medium">Gogidix Operations</p>
              <p className="text-muted-foreground">Foundation Services</p>
            </div>
          </div>
        </div>
      )}
