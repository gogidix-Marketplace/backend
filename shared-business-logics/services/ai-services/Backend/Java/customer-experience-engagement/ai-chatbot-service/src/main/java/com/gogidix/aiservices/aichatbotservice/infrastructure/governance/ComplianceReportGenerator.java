...
public class ComplianceReportGenerator {
    ...
    private PerformanceMetricsSection generatePerformanceSection() {
        ...
        section.setTotalRequests((long) metrics.getMeterRegistry()
                .get("ai.chatbot.total").counter().count());
        section.setSuccessfulRequests((long) metrics.getMeterRegistry()
                .get("ai.chatbot.success").counter().count());
        section.setFailedRequests((long) metrics.getMeterRegistry()
                .get("ai.chatbot.failure").counter().count());
        section.setConversationsHandled((long) metrics.getMeterRegistry()
                .get("ai.chatbot.conversations.handled").counter().count());
    ...
    public static class PerformanceMetricsSection {
        ...
        private long conversationsHandled;
        ...
        public long getConversationsHandled() { return conversationsHandled; }
        public void setConversationsHandled(long conversationsHandled) { this.conversationsHandled = conversationsHandled; }
