...
class ForecastQuery_GetPendingApprovalQueryTest {

        @Test
    void testSettersAndGetters() {
        ForecastQuery.GetPendingApprovalQuery dto = new ForecastQuery.GetPendingApprovalQuery();
    ...
    void testEqualsAndHashCode() {
        ForecastQuery.GetPendingApprovalQuery dto1 = new ForecastQuery.GetPendingApprovalQuery();
        ForecastQuery.GetPendingApprovalQuery dto2 = new ForecastQuery.GetPendingApprovalQuery();
