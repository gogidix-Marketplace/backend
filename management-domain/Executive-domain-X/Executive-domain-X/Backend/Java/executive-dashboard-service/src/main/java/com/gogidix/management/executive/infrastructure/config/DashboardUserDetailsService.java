package com.gogidix.management.executive.infrastructure.config;

import com.gogidix.management.executive.domain.model.DomainException;
...
/**
 * User Details Service for Executive Dashboard
 * Loads user-specific data for authentication
 */
@Service
public class DashboardUserDetailsService implements UserDetailsService {

    private static final Logger log = LoggerFactory.getLogger(DashboardUserDetailsService.class);
