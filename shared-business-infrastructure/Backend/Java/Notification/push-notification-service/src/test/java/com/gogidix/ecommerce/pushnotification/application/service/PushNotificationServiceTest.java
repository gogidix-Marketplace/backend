...
class PushNotificationServiceTest {
    ...
    @Mock private PushNotificationRepository repository;
    @Mock private PushNotificationMapper mapper;
    private PushNotificationService service;

    @BeforeEach
    void setUp() {
        service = new PushNotificationService(repository, mapper);
    ...
    void shouldGetById() {
        ...
        when(mapper.toResponse(entity)).thenReturn(
            new PushNotificationResponse("id-1", "test", null, null, null, null, null, true, null, null));
    ...
    void shouldCreate() {
        ...
        when(mapper.toResponse(any())).thenReturn(
            new PushNotificationResponse("id-1", "test", null, null, null, null, null, true, null, null));
        assertThat(service.create(new CreatePushNotificationRequest("test", null, null, null, null, null))).isNotNull();
    }
    ...
    void shouldUpdate() {
        ...
        when(repository.save(any())).thenReturn(entity);
        when(mapper.toResponse(any())).thenReturn(
            new PushNotificationResponse("id-1", "updated", null, null, null, null, null, true, null, null));
        assertThat(service.update("id-1", new UpdatePushNotificationRequest("updated", null, null, null, null, null, null))).isNotNull();
    }
