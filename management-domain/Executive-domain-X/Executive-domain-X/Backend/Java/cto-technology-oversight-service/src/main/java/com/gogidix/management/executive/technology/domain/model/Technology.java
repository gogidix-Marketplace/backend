...
/**
 * Technology aggregate root for Executive Domain
...
@NoArgsConstructor
@AllArgsConstructor
@Document(collection = "cto-technology-oversight-service")
public class Technology extends BaseEntity {
    ...
    public boolean isActive() {
        return status == TechnologyStatus.ACTIVE && deletedAt == null;
    }
}
