...
class CustomerCommand_ReactivateCustomerCommandTest {

        @Test
    void testSettersAndGetters() {
        CustomerCommand.ReactivateCustomerCommand dto = new CustomerCommand.ReactivateCustomerCommand();
    ...
    void testEqualsAndHashCode() {
        CustomerCommand.ReactivateCustomerCommand dto1 = new CustomerCommand.ReactivateCustomerCommand();
        CustomerCommand.ReactivateCustomerCommand dto2 = new CustomerCommand.ReactivateCustomerCommand();
