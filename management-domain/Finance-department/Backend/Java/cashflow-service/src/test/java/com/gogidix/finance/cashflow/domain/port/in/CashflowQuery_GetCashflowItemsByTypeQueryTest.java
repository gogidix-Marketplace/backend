...
class CashflowQuery_GetCashflowItemsByTypeQueryTest {

        @Test
    void testSettersAndGetters() {
        CashflowQuery.GetCashflowItemsByTypeQuery dto = new CashflowQuery.GetCashflowItemsByTypeQuery();
    ...
    void testEqualsAndHashCode() {
        CashflowQuery.GetCashflowItemsByTypeQuery dto1 = new CashflowQuery.GetCashflowItemsByTypeQuery();
        CashflowQuery.GetCashflowItemsByTypeQuery dto2 = new CashflowQuery.GetCashflowItemsByTypeQuery();
