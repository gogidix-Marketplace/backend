...
class SearchMapperTest {
    ...
    @BeforeEach
    void setUp() { mapper = new SearchMapper(); }
    ...
    void shouldMapToResponse() {
        ...
        SearchResponse response = mapper.toResponse(entity);
    ...
    void shouldMapToEntity() {
        CreateSearchRequest request = new CreateSearchRequest("test", "desc", "type", null, null, null);
    ...
    void shouldUpdateFromRequest() {
        Search entity = new Search("tenant-1");
        entity.setName("old");
        UpdateSearchRequest request = new UpdateSearchRequest("new", "desc", null, null, null, null, null);
    ...
    void shouldSkipNullFields() {
        ...
        UpdateSearchRequest request = new UpdateSearchRequest(null, null, null, null, null, null, null);
        mapper.updateFromRequest(entity, request);
