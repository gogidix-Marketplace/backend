...
class GovernanceTest {
    ...
    @BeforeEach
    void setup() {
        var m = new PredictiveAnalyticsMetrics(new SimpleMeterRegistry());
    ...
    @Test
    void threshold() { assertThat(v.validateThreshold(ThresholdValidator.ThresholdType.P95_FORECAST_LATENCY)).isNotNull(); }
    @Test
