...
import com.gogidix.digitalmarketing.contentmanagement.interfaces.rest.ContentPieceController;
...
class ContentPieceControllerTest {

    @Mock
    private ContentPieceService service;

    @InjectMocks
    private ContentPieceController underTest;
