...
/**
 * MongoDB Configuration for Global Support Dashboard Service
 */
@Configuration
@EnableMongoRepositories(basePackages = {
        "com.gogidix.customersupport.globalsupportdashboard.domain.repository"
})
...
public class MongoConfig {
    ...
    @Value("${spring.data.mongodb.database:global_support_dashboard_db}")
