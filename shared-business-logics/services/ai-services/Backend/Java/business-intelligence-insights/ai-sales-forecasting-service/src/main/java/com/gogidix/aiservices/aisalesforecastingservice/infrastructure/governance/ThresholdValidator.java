...
public class ThresholdValidator {
    ...
    public ThresholdValidator(SalesForecastingMetrics metrics) {
    ...
    public ComplianceReport validateAllThresholds() {
        ...
        double analysisLatency = metrics.getForecastAnalysisLatencyP95();
        boolean analysisCompliant = analysisLatency <= MAX_ANALYSIS_LATENCY_MS;
        report.addCheck("Forecast Analysis Latency", analysisLatency, MAX_ANALYSIS_LATENCY_MS, analysisCompliant);
    ...
    public ThresholdValidation validateThreshold(ThresholdType type) {
        return switch (type) {
            ...
            case SEGMENT_ANALYSIS_LATENCY -> {
                double value = metrics.getForecastAnalysisLatencyP95();
