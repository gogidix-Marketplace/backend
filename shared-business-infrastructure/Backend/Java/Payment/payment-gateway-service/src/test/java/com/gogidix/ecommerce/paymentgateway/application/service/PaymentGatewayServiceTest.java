...
class PaymentGatewayServiceTest {
    ...
    @Mock private PaymentGatewayRepository repository;
    @Mock private PaymentGatewayMapper mapper;
    private PaymentGatewayService service;

    @BeforeEach
    void setUp() {
        service = new PaymentGatewayService(repository, mapper);
    ...
    void shouldGetById() {
        ...
        when(mapper.toResponse(entity)).thenReturn(
            new PaymentGatewayResponse("id-1", "test", null, null, null, null, null, true, null, null));
    ...
    void shouldCreate() {
        ...
        when(mapper.toResponse(any())).thenReturn(
            new PaymentGatewayResponse("id-1", "test", null, null, null, null, null, true, null, null));
        assertThat(service.create(new CreatePaymentGatewayRequest("test", null, null, null, null, null))).isNotNull();
    }
    ...
    void shouldUpdate() {
        ...
        when(repository.save(any())).thenReturn(entity);
        when(mapper.toResponse(any())).thenReturn(
            new PaymentGatewayResponse("id-1", "updated", null, null, null, null, null, true, null, null));
        assertThat(service.update("id-1", new UpdatePaymentGatewayRequest("updated", null, null, null, null, null, null))).isNotNull();
    }
