...
import com.gogidix.management.executive.technology.application.command.TechnologyCommandService;
...
class TechnologyCommandServiceTest {
    ...
    @Test
    void handle() {
        CreateTechnologyCommand command = new CreateTechnologyCommand();
