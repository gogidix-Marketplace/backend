package com.gogidix.aiservices.performanceoptimizationservice.governance;

import com.gogidix.aiservices.performanceoptimizationservice.infrastructure.governance.ComplianceReportGenerator;
import com.gogidix.aiservices.performanceoptimizationservice.infrastructure.governance.ThresholdValidator;
...
class GovernanceEnforcementTest {
    ...
    private final PerformanceOptimizationMetrics metrics = new PerformanceOptimizationMetrics(new SimpleMeterRegistry());
    private final ThresholdValidator thresholdValidator = new ThresholdValidator(metrics);
    private final ComplianceReportGenerator reportGenerator = new ComplianceReportGenerator(metrics, thresholdValidator);
