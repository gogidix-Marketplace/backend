package com.gogidix.ecommerce.approval.infrastructure.config;
...
public class OpenApiConfig {
    @Bean
    public OpenAPI approvalWorkflowServiceOpenAPI() {
        return new OpenAPI()
                .info(new Info()
                        .title("Approval Workflow Service API")
                        .description("REST API for approval workflow in the Gogidix E-commerce platform")
                        .version("1.0.0")
                ...
                .servers(List.of(
                        new Server().url("http://localhost:8072").description("Development"),
