...
class SecurityValidationTest {
    ...
    class InputValidationTests {
        ...
        @Test
        @Order(1)
        @DisplayName("Should reject null contentId")
        ...
        void shouldHandleSqlInjectionAttempts() {
            String maliciousInput = "'; DROP TABLE content; --";
    ...
    class TenantIsolationTests {
        ...
        @Test
        @Order(10)
        @DisplayName("Should isolate content by tenant")
        void shouldIsolateContentByTenant() {
            String tenant1 = "tenant-1";
            String tenant2 = "tenant-2";

            // Content for tenant1 should not affect tenant2
    ...
    class ResourceLimitsTests {
        ...
        @Test
        @Order(20)
        @DisplayName("Should enforce content generation limit")
        void shouldEnforceContentGenerationLimit() {
            // Simulate large content generation request
    ...
    class AuthenticationContextTests {
        ...
        void shouldPreventUnauthorizedCrossTenantAccess() {
            ...
            // Attempting content generation from different tenant context
            assertThat(tenant1).isNotEqualTo(tenant2);
        }
    }
}
