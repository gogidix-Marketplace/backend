package com.gogidix.ecommerce.affiliate.infrastructure.config;
...
public class OpenApiConfig {
    @Bean
    public OpenAPI affiliateServiceOpenAPI() {
        return new OpenAPI()
                .info(new Info()
                        .title("Affiliate Service API")
                        .description("REST API for affiliate management in the Gogidix E-commerce platform")
                        .version("1.0.0")
                ...
                .servers(List.of(
                        new Server().url("http://localhost:8035").description("Development"),
