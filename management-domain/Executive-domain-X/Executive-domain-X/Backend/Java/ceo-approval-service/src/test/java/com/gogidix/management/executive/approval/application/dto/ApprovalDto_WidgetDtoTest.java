...
import com.gogidix.management.executive.approval.application.dto.ApprovalDto;
...
class ApprovalDto_WidgetDtoTest {

        @Test
    void testBuilder() {
        ApprovalDto.WidgetDto dto = ApprovalDto.WidgetDto.builder()
                        .id("test-id")
            .name("test-name")
            .type(null)
            .position(42)
    ...
    void testSettersAndGetters() {
        ApprovalDto.WidgetDto dto = new ApprovalDto.WidgetDto();
        dto.setId("val-id");
    ...
    void testEqualsAndHashCode() {
        ApprovalDto.WidgetDto dto1 = ApprovalDto.WidgetDto.builder()
                        .id("test-id")
            .name("test-name")
            .type(null)
            .position(42)
            ...
            .dataSource("test-dataSource")
            .build();
        ApprovalDto.WidgetDto dto2 = ApprovalDto.WidgetDto.builder()
                        .id("test-id")
            .name("test-name")
            .type(null)
            .position(42)
