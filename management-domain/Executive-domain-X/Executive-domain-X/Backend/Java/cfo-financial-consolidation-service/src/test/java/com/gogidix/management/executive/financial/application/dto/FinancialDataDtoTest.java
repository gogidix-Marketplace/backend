...
class FinancialDataDtoTest {

        @Test
    void testBuilder() {
        FinancialDataDto dto = FinancialDataDto.builder()
                        .id("test-id")
    ...
    void testEqualsAndHashCode() {
        FinancialDataDto dto1 = FinancialDataDto.builder()
                        .id("test-id")
            .tenantId("test-tenantId")
            .name("test-name")
            .description("test-description")
            ...
            .updatedAt(Instant.parse("2025-01-15T10:00:00Z"))
            .build();
        FinancialDataDto dto2 = FinancialDataDto.builder()
                        .id("test-id")
            .tenantId("test-tenantId")
            .name("test-name")
            .description("test-description")
