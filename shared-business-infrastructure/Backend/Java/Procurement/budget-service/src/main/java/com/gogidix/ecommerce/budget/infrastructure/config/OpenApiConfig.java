package com.gogidix.ecommerce.budget.infrastructure.config;
    ...
    public OpenAPI budgetServiceOpenAPI() {
        return new OpenAPI()
                .info(new Info()
                        ...
                        .description("REST API for budget management in the Gogidix E-commerce platform")
                        .version("1.0.0")
                ...
                .servers(List.of(
                        new Server().url("http://localhost:8074").description("Development"),
