package com.gogidix.aiservices.aipersonalizationservice.security;
...
class SecurityValidationTest {
    ...
    class TenantIsolationTests {
        ...
        @Test
        @Order(10)
        @DisplayName("Should isolate personalization by tenant")
        void shouldIsolatePersonalizationByTenant() {
            String tenant1 = "tenant-1";
            String tenant2 = "tenant-2";

            // Personalization for tenant1 should not affect tenant2
    ...
    class ResourceLimitsTests {
        ...
        @Test
        @Order(20)
        @DisplayName("Should enforce personalization request limit")
        void shouldEnforcePersonalizationRequestLimit() {
            // Simulate large personalization request
    ...
    class AuthenticationContextTests {
        ...
        void shouldPreventUnauthorizedCrossTenantAccess() {
            ...
            // Attempting personalization from different tenant context
            assertThat(tenant1).isNotEqualTo(tenant2);
        }
    }
}
