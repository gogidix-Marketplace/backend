...
public class ComplianceReportGenerator {
    ...
    public ComplianceReportGenerator(
            TimeSeriesForecastingMetrics metrics,
    ...
    private SloComplianceSection generateSloComplianceSection() {
        ...
        section.setP99LatencyCompliant(p99Latency <= 5000.0);
    ...
    private PerformanceMetricsSection generatePerformanceSection() {
        ...
        section.setTotalRequests((long) metrics.getMeterRegistry()
                .get("timeseries.forecasting.total").counter().count());

        section.setSuccessfulRequests((long) metrics.getMeterRegistry()
                .get("timeseries.forecasting.success").counter().count());

        section.setFailedRequests((long) metrics.getMeterRegistry()
                .get("timeseries.forecasting.failure").counter().count());

        section.setModelTrainings((long) metrics.getMeterRegistry()
                .get("timeseries.model.training").counter().count());

        section.setSeasonalityAnalyses((long) metrics.getMeterRegistry()
                .get("timeseries.seasonality.analysis").counter().count());
    ...
    public static class GovernanceReport {
        ...
        private Map<String, Object> performanceMetricsToMap() {
            ...
            map.put("modelTrainings", performanceMetrics.getModelTrainings());
            return map;
        }
    ...
    public static class PerformanceMetricsSection {
        ...
        private long modelTrainings;
        private long seasonalityAnalyses;
        ...
        public long getModelTrainings() { return modelTrainings; }
        public void setModelTrainings(long modelTrainings) { this.modelTrainings = modelTrainings; }
        public long getSeasonalityAnalyses() { return seasonalityAnalyses; }
        public void setSeasonalityAnalyses(long seasonalityAnalyses) { this.seasonalityAnalyses = seasonalityAnalyses; }
