...
class RegionalSummaryDto_CountryMetricSummaryDtoTest {

        @Test
    void testBuilder() {
        RegionalSummaryDto.CountryMetricSummaryDto dto = RegionalSummaryDto.CountryMetricSummaryDto.builder()
    ...
    void testSettersAndGetters() {
        RegionalSummaryDto.CountryMetricSummaryDto dto = new RegionalSummaryDto.CountryMetricSummaryDto();
    ...
    void testEqualsAndHashCode() {
        RegionalSummaryDto.CountryMetricSummaryDto dto1 = RegionalSummaryDto.CountryMetricSummaryDto.builder()
                        .countryCode("test-countryCode")
            .countryName("test-countryName")
            .revenue(BigDecimal.TEN)
            .revenueContribution(BigDecimal.TEN)
            ...
            .marketShare(BigDecimal.TEN)
            .build();
        RegionalSummaryDto.CountryMetricSummaryDto dto2 = RegionalSummaryDto.CountryMetricSummaryDto.builder()
                        .countryCode("test-countryCode")
            .countryName("test-countryName")
            .revenue(BigDecimal.TEN)
            .revenueContribution(BigDecimal.TEN)
