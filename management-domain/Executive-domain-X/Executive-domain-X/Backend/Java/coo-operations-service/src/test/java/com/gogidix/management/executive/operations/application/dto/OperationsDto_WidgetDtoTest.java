...
class OperationsDto_WidgetDtoTest {

        @Test
    void testBuilder() {
        OperationsDto.WidgetDto dto = OperationsDto.WidgetDto.builder()
                        .id("test-id")
            .name("test-name")
            .type(null)
            .position(42)
    ...
    void testSettersAndGetters() {
        OperationsDto.WidgetDto dto = new OperationsDto.WidgetDto();
        dto.setId("val-id");
    ...
    void testEqualsAndHashCode() {
        OperationsDto.WidgetDto dto1 = OperationsDto.WidgetDto.builder()
                        .id("test-id")
            .name("test-name")
            .type(null)
            .position(42)
            ...
            .dataSource("test-dataSource")
            .build();
        OperationsDto.WidgetDto dto2 = OperationsDto.WidgetDto.builder()
                        .id("test-id")
            .name("test-name")
            .type(null)
            .position(42)
