...
class Approval_WidgetTest {

        @Test
    void testBuilder() {
        Approval.Widget dto = Approval.Widget.builder()
                        .id("test-id")
            .name("test-name")
            .type(Approval.Widget.WidgetType.KPI_CARD)
            .position(42)
            .row(42)
            .column(42)
            .width(42)
        ...
        assertEquals(Approval.Widget.WidgetType.KPI_CARD, dto.getType());
    ...
    void testSettersAndGetters() {
        Approval.Widget dto = new Approval.Widget();
        dto.setId("val-id");
        dto.setName("val-name");
        dto.setType(Approval.Widget.WidgetType.KPI_CARD);
        dto.setPosition(99);
        dto.setRow(99);
        dto.setColumn(99);
        dto.setWidth(99);
    ...
    void testEqualsAndHashCode() {
        Approval.Widget dto1 = Approval.Widget.builder()
                        .id("test-id")
            .name("test-name")
            .type(Approval.Widget.WidgetType.KPI_CARD)
            .position(42)
            ...
            .dataSource("test-dataSource")
            .build();
        Approval.Widget dto2 = Approval.Widget.builder()
                        .id("test-id")
            .name("test-name")
            .type(Approval.Widget.WidgetType.KPI_CARD)
            .position(42)
