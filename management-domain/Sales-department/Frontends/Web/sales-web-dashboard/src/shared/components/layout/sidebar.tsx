      ...
      <div className="flex h-16 items-center justify-between border-b px-4">
        {!collapsed && (
          <div className="flex items-center gap-2">
            <div className="flex h-8 w-8 items-center justify-center rounded bg-[#1E40AF]">
              <span className="text-lg font-bold text-white">S</span>
            </div>
            <div className="flex flex-col">
              <span className="text-sm font-semibold leading-tight">Gogidix</span>
              <span className="text-xs text-muted-foreground">Sales Suite</span>
            </div>
          </div>
        )}
        <button
        ...
        <div className="border-t p-4">
          <div className="flex items-center gap-3 rounded-lg bg-white dark:bg-slate-800 p-3 shadow-sm">
            ...
            <div className="flex-1 text-xs">
              ...
              <p className="text-muted-foreground">Management Domain</p>
            </div>
          </div>
        </div>
      )}
