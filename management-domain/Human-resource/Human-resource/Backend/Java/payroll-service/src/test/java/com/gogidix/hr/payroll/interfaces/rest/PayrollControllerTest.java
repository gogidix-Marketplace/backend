...
class PayrollControllerTest {
    ...
    @InjectMocks
    private PayrollController underTest;
    ...
    void setUp() {
        ...
        lenient().when(payrollQueryService.getAllForTenant()).thenReturn(Collections.emptyList());
        lenient().when(payrollQueryService.getByCountryCode(any())).thenReturn(Collections.emptyList());
    }
    ...
    @Test
    void createPayroll___callsService() {
        try {
            underTest.createPayroll(null);
        } catch (Throwable e) {
