...
class GovernanceGateEnforcementTest {
    ...
    class P95LatencyGateTests {
        ...
        void shouldPassP95LatencyGateWhenUnderThreshold() {
            ...
            for (int i = 0; i < 50; i++) {
                metrics.recordProfileationTime(300 + (i * 3)); // Max ~450ms
            }
        ...
        void shouldFailP95LatencyGateWhenOverThreshold() {
            ...
            for (int i = 0; i < 50; i++) {
                metrics.recordProfileationTime(400 + (i * 5)); // Max ~650ms
            }
    ...
    @Nested
    @DisplayName("Profile Analysis Latency Gate")
    class ProfileAnalysisLatencyGateTests {

        @Test
        @DisplayName("Should pass segment analysis latency gate when under threshold")
        void shouldPassProfileAnalysisLatencyGateWhenUnderThreshold() {
            // Record analysis latencies under 200ms threshold
            for (int i = 0; i < 30; i++) {
                var sample = metrics.startProfileAnalysisTimer();
                try {
    ...
    class OverallHealthStatusGateTests {
        ...
        void shouldReportHealthyStatusWhenAllGatesPass() {
            ...
            for (int i = 0; i < 50; i++) {
                metrics.recordProfileationTime(300); // Under P95 threshold
            }
        ...
        void shouldReportDegradedStatusWhenSomeGatesFail() {
            ...
            for (int i = 0; i < 50; i++) {
                metrics.recordProfileationTime(300);
            }
