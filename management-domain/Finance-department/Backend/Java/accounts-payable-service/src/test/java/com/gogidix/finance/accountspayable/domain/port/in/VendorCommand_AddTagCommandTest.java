...
class VendorCommand_AddTagCommandTest {

        @Test
    void testSettersAndGetters() {
        VendorCommand.AddTagCommand dto = new VendorCommand.AddTagCommand();
    ...
    void testEqualsAndHashCode() {
        VendorCommand.AddTagCommand dto1 = new VendorCommand.AddTagCommand();
        VendorCommand.AddTagCommand dto2 = new VendorCommand.AddTagCommand();
