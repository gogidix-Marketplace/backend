...
class PromotionExceptionTest {
    ...
    void shouldCreateDuplicateException() {
        DuplicatePromotionException ex = new DuplicatePromotionException("name-1");
    ...
    void shouldCreateInvalidException() {
        InvalidPromotionException ex = new InvalidPromotionException("bad data");
    ...
    void shouldCreateInvalidExceptionWithCause() {
        ...
        InvalidPromotionException ex = new InvalidPromotionException("msg", cause);
