package com.gogidix.aiservices.aidocumentextractionervice.security;
...
class SecurityValidationTest {
    ...
    class TenantIsolationTests {
        ...
        @Test
        @Order(10)
        @DisplayName("Should isolate extractions by tenant")
        void shouldIsolateExtractionsByTenant() {
            String tenant1 = "tenant-1";
            String tenant2 = "tenant-2";

            // Extractions for tenant1 should not affect tenant2
    ...
    class ResourceLimitsTests {
        ...
        @Test
        @Order(20)
        @DisplayName("Should enforce extraction result limit")
        void shouldEnforceExtractionResultLimit() {
    ...
    class AuthenticationContextTests {
        ...
        void shouldPreventUnauthorizedCrossTenantAccess() {
            ...
            // Attempting extraction from different tenant context
            assertThat(tenant1).isNotEqualTo(tenant2);
        }
    }
}
