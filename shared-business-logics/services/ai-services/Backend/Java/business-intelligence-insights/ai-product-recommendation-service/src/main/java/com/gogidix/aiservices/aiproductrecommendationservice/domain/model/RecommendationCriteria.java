...
public class RecommendationCriteria {
    ...
    private final List<RecommendationCriteria> nestedCriteria;

    // Private constructor
    private RecommendationCriteria(Builder builder) {
    ...
    public List<RecommendationCriteria> getNestedCriteria() {
     ...
     * @return a new RecommendationCriteria with the nested criteria added
     */
    public RecommendationCriteria withNestedCriteria(RecommendationCriteria criteria) {
        List<RecommendationCriteria> newNested = new ArrayList<>(this.nestedCriteria);
    ...
    public boolean equals(Object o) {
        ...
        RecommendationCriteria that = (RecommendationCriteria) o;
    ...
    /**
     * Builder for RecommendationCriteria.
     */
    public static class Builder {
        ...
        private List<RecommendationCriteria> nestedCriteria;
        ...
        public Builder nestedCriteria(List<RecommendationCriteria> nestedCriteria) {
            this.nestedCriteria = nestedCriteria;
            return this;
        }

        public Builder addNestedCriteria(RecommendationCriteria criteria) {
        ...
        public RecommendationCriteria build() {
            return new RecommendationCriteria(this);
        }
    }
