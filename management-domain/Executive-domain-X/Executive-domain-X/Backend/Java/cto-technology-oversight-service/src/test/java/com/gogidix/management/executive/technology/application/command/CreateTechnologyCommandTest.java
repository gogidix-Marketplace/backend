...
class CreateTechnologyCommandTest {
        ...
        @Test
    void testBuilder() {
        CreateTechnologyCommand dto = CreateTechnologyCommand.builder()
    ...
    void testSettersAndGetters() {
        CreateTechnologyCommand dto = new CreateTechnologyCommand();
    ...
    void testEqualsAndHashCode() {
        CreateTechnologyCommand dto1 = CreateTechnologyCommand.builder()
                        .tenantId("test-tenantId")
            .name("test-name")
            .description("test-description")
            .ownerId("test-ownerId")
            ...
            .widgets(Collections.emptyList())
            .build();
        CreateTechnologyCommand dto2 = CreateTechnologyCommand.builder()
                        .tenantId("test-tenantId")
            .name("test-name")
            .description("test-description")
            .ownerId("test-ownerId")
