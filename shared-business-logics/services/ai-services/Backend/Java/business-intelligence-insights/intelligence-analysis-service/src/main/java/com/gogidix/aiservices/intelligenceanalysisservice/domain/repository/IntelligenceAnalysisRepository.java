package com.gogidix.aiservices.intelligenceanalysisservice.domain.repository;
...
public interface IntelligenceAnalysisRepository {
     ...
     */
    Optional<IntelligenceAnalysis> findByIdAndTenantId(String id, String tenantId);
     ...
     */
    List<IntelligenceAnalysis> findByTenantId(String tenantId);
     ...
     * @return list of segments
     */
    List<IntelligenceAnalysis> findByTenantIdAndStatus(String tenantId, com.gogidix.aiservices.intelligenceanalysisservice.domain.model.AnalysisStatus status);
     ...
     * @return list of segments
     */
    List<IntelligenceAnalysis> findByTenantIdAndAnalysisType(String tenantId,
                                                        com.gogidix.aiservices.intelligenceanalysisservice.domain.model.AnalysisType segmentType);
     ...
     * @return the segment if found
     */
    Optional<IntelligenceAnalysis> findByNameAndTenantId(String name, String tenantId);
     ...
     * @return list of segments
     */
    List<IntelligenceAnalysis> findByTenantIdPaginated(String tenantId, int page, int size);
}
