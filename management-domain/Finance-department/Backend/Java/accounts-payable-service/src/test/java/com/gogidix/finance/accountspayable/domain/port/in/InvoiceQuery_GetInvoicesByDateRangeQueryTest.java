...
class InvoiceQuery_GetInvoicesByDateRangeQueryTest {

        @Test
    void testSettersAndGetters() {
        InvoiceQuery.GetInvoicesByDateRangeQuery dto = new InvoiceQuery.GetInvoicesByDateRangeQuery();
    ...
    void testEqualsAndHashCode() {
        InvoiceQuery.GetInvoicesByDateRangeQuery dto1 = new InvoiceQuery.GetInvoicesByDateRangeQuery();
        InvoiceQuery.GetInvoicesByDateRangeQuery dto2 = new InvoiceQuery.GetInvoicesByDateRangeQuery();
