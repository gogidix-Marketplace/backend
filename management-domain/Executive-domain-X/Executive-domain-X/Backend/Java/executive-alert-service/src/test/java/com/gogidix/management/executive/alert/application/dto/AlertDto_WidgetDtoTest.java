package com.gogidix.management.executive.alert.application.dto;
...
class AlertDto_WidgetDtoTest {

        @Test
    void testBuilder() {
        AlertDto.WidgetDto dto = AlertDto.WidgetDto.builder()
                        .id("test-id")
            .name("test-name")
            .type(null)
            .position(42)
    ...
    void testSettersAndGetters() {
        AlertDto.WidgetDto dto = new AlertDto.WidgetDto();
        dto.setId("val-id");
    ...
    void testEqualsAndHashCode() {
        AlertDto.WidgetDto dto1 = AlertDto.WidgetDto.builder()
                        .id("test-id")
            .name("test-name")
            .type(null)
            .position(42)
            ...
            .dataSource("test-dataSource")
            .build();
        AlertDto.WidgetDto dto2 = AlertDto.WidgetDto.builder()
                        .id("test-id")
            .name("test-name")
            .type(null)
            .position(42)
