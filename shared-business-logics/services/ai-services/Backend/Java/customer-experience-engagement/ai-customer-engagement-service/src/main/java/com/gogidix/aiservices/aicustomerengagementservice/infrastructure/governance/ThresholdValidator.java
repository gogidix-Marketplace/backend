...
public class ThresholdValidator {
    ...
    private static final double MAX_P99_LATENCY_MS = 400.0;
    private static final double MAX_ERROR_RATE = 0.01;  // 1%
    private static final double MAX_ML_LATENCY_MS = 100.0;

    public ThresholdValidator(CustomerEngagementMetrics metrics) {
