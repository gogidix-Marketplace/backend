...
class CustomerMapperTest {
    ...
    @BeforeEach
    void setUp() { mapper = new CustomerMapper(); }
    ...
    void shouldMapToEntity() {
        CreateCustomerRequest request = new CreateCustomerRequest("test", "desc", "type", null, null, null);
    ...
    void shouldUpdateFromRequest() {
        Customer entity = new Customer("tenant-1");
        entity.setName("old");
        UpdateCustomerRequest request = new UpdateCustomerRequest("new", "desc", null, null, null, null, null);
    ...
    void shouldSkipNullFields() {
        ...
        UpdateCustomerRequest request = new UpdateCustomerRequest(null, null, null, null, null, null, null);
        mapper.updateFromRequest(entity, request);
