...
class PaymentMethodServiceTest {
    ...
    @Mock private PaymentMethodMapper mapper;
    private PaymentMethodService service;

    @BeforeEach
    void setUp() {
        service = new PaymentMethodService(repository, mapper);
    ...
    void shouldGetById() {
        ...
        when(mapper.toResponse(entity)).thenReturn(
            new PaymentMethodResponse("id-1", "test", null, null, null, null, null, true, null, null));
    ...
    void shouldCreate() {
        ...
        when(mapper.toResponse(any())).thenReturn(
            new PaymentMethodResponse("id-1", "test", null, null, null, null, null, true, null, null));
        assertThat(service.create(new CreatePaymentMethodRequest("test", null, null, null, null, null))).isNotNull();
    }
    ...
    void shouldUpdate() {
        ...
        when(repository.save(any())).thenReturn(entity);
        when(mapper.toResponse(any())).thenReturn(
            new PaymentMethodResponse("id-1", "updated", null, null, null, null, null, true, null, null));
        assertThat(service.update("id-1", new UpdatePaymentMethodRequest("updated", null, null, null, null, null, null))).isNotNull();
    }
