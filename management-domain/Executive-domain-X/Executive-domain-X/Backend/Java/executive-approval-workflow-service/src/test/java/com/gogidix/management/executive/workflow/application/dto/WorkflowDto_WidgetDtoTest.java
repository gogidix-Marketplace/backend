...
class WorkflowDto_WidgetDtoTest {

        @Test
    void testBuilder() {
        WorkflowDto.WidgetDto dto = WorkflowDto.WidgetDto.builder()
                        .id("test-id")
            .name("test-name")
            .type(null)
            .position(42)
    ...
    void testSettersAndGetters() {
        WorkflowDto.WidgetDto dto = new WorkflowDto.WidgetDto();
        dto.setId("val-id");
    ...
    void testEqualsAndHashCode() {
        WorkflowDto.WidgetDto dto1 = WorkflowDto.WidgetDto.builder()
                        .id("test-id")
            .name("test-name")
            .type(null)
            .position(42)
            ...
            .dataSource("test-dataSource")
            .build();
        WorkflowDto.WidgetDto dto2 = WorkflowDto.WidgetDto.builder()
                        .id("test-id")
            .name("test-name")
            .type(null)
            .position(42)
