 ...
 */
public record FindRecommendationsByTenantQuery(
        String tenantId,
    ...
    public FindRecommendationsByTenantQuery {
    ...
    public static FindRecommendationsByTenantQuery create(String tenantId) {
        return new FindRecommendationsByTenantQuery(tenantId, null, null, 0, 20, "createdAt", "DESC");
    }
}
