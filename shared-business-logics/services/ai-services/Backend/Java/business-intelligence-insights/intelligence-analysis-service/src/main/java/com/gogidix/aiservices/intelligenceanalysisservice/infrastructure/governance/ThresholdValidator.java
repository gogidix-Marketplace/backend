...
public class ThresholdValidator {
    ...
    public ThresholdValidator(IntelligenceAnalysisationMetrics metrics) {
    ...
    public ComplianceReport validateAllThresholds() {
        ...
        double analysisLatency = metrics.getAnalysisAnalysisLatencyP95();
        boolean analysisCompliant = analysisLatency <= MAX_ANALYSIS_LATENCY_MS;
        report.addCheck("Analysis Analysis Latency", analysisLatency, MAX_ANALYSIS_LATENCY_MS, analysisCompliant);
    ...
    public ThresholdValidation validateThreshold(ThresholdType type) {
        return switch (type) {
            ...
            case SEGMENT_ANALYSIS_LATENCY -> {
                double value = metrics.getAnalysisAnalysisLatencyP95();
