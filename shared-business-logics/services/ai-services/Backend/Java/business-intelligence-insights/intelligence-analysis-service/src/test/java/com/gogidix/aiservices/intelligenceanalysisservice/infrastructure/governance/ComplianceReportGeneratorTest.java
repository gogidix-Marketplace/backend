...
class ComplianceReportGeneratorTest {
    ...
    class ReportGenerationTests {
        ...
        void shouldPopulatePerformanceMetricsSection() {
            ...
            assertThat(perf.getTotalAnalysiss()).isEqualTo(5000L);
            assertThat(perf.getSuccessfulAnalysiss()).isEqualTo(4750L);
            assertThat(perf.getFailedAnalysiss()).isEqualTo(250L);
            assertThat(perf.getAnalysissCreated()).isEqualTo(100L);
            assertThat(perf.getAnalysissUpdated()).isEqualTo(50L);
            assertThat(perf.getIntelligenceReportsAnalyzed()).isEqualTo(50000L);
        }
