...
class AuditDto_WidgetDtoTest {

        @Test
    void testBuilder() {
        AuditDto.WidgetDto dto = AuditDto.WidgetDto.builder()
                        .id("test-id")
            .name("test-name")
            .type(null)
            .position(42)
    ...
    void testSettersAndGetters() {
        AuditDto.WidgetDto dto = new AuditDto.WidgetDto();
        dto.setId("val-id");
    ...
    void testEqualsAndHashCode() {
        AuditDto.WidgetDto dto1 = AuditDto.WidgetDto.builder()
                        .id("test-id")
            .name("test-name")
            .type(null)
            .position(42)
            ...
            .dataSource("test-dataSource")
            .build();
        AuditDto.WidgetDto dto2 = AuditDto.WidgetDto.builder()
                        .id("test-id")
            .name("test-name")
            .type(null)
            .position(42)
