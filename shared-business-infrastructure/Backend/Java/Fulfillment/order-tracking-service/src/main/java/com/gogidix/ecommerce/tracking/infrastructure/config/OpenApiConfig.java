...
public class OpenApiConfig {
    ...
    public OpenAPI orderTrackingServiceOpenAPI() {
        return new OpenAPI()
                .info(new Info()
                        .title("Order Tracking Service API")
                        .description("REST API for order tracking in the Gogidix E-commerce platform")
                        .version("1.0.0")
                ...
                .servers(List.of(
                        new Server().url("http://localhost:8087").description("Development"),
