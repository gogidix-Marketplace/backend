...
@DisplayName("GiftCard Exception Tests")
class GiftCardExceptionTest {

    @Test
    @DisplayName("Should create not found exception")
    void shouldCreateNotFoundException() {
        GiftCardNotFoundException ex = new GiftCardNotFoundException("id-1");
    ...
    void shouldCreateDuplicateException() {
        DuplicateGiftCardException ex = new DuplicateGiftCardException("name-1");
    ...
    void shouldCreateInvalidException() {
        InvalidGiftCardException ex = new InvalidGiftCardException("bad data");
    ...
    void shouldCreateInvalidExceptionWithCause() {
        ...
        InvalidGiftCardException ex = new InvalidGiftCardException("msg", cause);
