package com.gogidix.aiservices.aiuserprofilingservice.security;
...
class SecurityValidationTest {
    ...
    class TenantIsolationTests {
        ...
        void shouldIsolateProfilesByTenant() {
            String tenant1 = "tenant-1";
            String tenant2 = "tenant-2";

            // Profiles for tenant1 should not affect tenant2
    ...
    class ResourceLimitsTests {
        ...
        void shouldEnforceProfileResultLimit() {
