...
public class ForecastCriteria {
    ...
    private final List<ForecastCriteria> nestedCriteria;

    // Private constructor
    private ForecastCriteria(Builder builder) {
    ...
    public List<ForecastCriteria> getNestedCriteria() {
     ...
     * @return a new ForecastCriteria with the nested criteria added
     */
    public ForecastCriteria withNestedCriteria(ForecastCriteria criteria) {
        List<ForecastCriteria> newNested = new ArrayList<>(this.nestedCriteria);
    ...
    public boolean equals(Object o) {
        ...
        ForecastCriteria that = (ForecastCriteria) o;
    ...
    public static class Builder {
        ...
        private List<ForecastCriteria> nestedCriteria;
        ...
        public Builder nestedCriteria(List<ForecastCriteria> nestedCriteria) {
            this.nestedCriteria = nestedCriteria;
            return this;
        }

        public Builder addNestedCriteria(ForecastCriteria criteria) {
        ...
        public ForecastCriteria build() {
            return new ForecastCriteria(this);
        }
    }
