...
import com.gogidix.aiservices.intelligenceanalysisservice.shared.exception.ConflictException;

import java.util.List;

/**
 * Business rule policy: Analysis names must be unique within a tenant.
 * Enforces uniqueness to prevent confusion and conflicts.
 */
public class AnalysisNameUniquePolicy {
