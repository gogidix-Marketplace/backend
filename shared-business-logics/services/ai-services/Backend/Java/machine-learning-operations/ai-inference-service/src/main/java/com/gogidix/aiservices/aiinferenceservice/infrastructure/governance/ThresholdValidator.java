...
public class ThresholdValidator {
    ...
    private static final double MAX_PREDICTION_LATENCY_MS = 100.0;

    public ThresholdValidator(InferenceMetrics metrics) {
    ...
    public ComplianceReport validateAllThresholds() {
        ...
        report.addCheck("Prediction Latency", predictionLatency, MAX_PREDICTION_LATENCY_MS, predictionCompliant);
