...
@DisplayName("PushNotificationValidationPolicy Tests")
class PushNotificationValidationPolicyTest {

    private PushNotificationValidationPolicy policy;

    @BeforeEach
    void setUp() { policy = new PushNotificationValidationPolicy(); }
