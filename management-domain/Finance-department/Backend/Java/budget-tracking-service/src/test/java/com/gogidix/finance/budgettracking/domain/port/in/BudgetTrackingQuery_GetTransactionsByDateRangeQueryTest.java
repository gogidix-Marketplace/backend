...
class BudgetTrackingQuery_GetTransactionsByDateRangeQueryTest {

        @Test
    void testSettersAndGetters() {
        BudgetTrackingQuery.GetTransactionsByDateRangeQuery dto = new BudgetTrackingQuery.GetTransactionsByDateRangeQuery();
    ...
    void testEqualsAndHashCode() {
        BudgetTrackingQuery.GetTransactionsByDateRangeQuery dto1 = new BudgetTrackingQuery.GetTransactionsByDateRangeQuery();
        BudgetTrackingQuery.GetTransactionsByDateRangeQuery dto2 = new BudgetTrackingQuery.GetTransactionsByDateRangeQuery();
