...
class BudgetTransactionCommand_RemoveTagCommandTest {

        @Test
    void testSettersAndGetters() {
        BudgetTransactionCommand.RemoveTagCommand dto = new BudgetTransactionCommand.RemoveTagCommand();
    ...
    void testEqualsAndHashCode() {
        BudgetTransactionCommand.RemoveTagCommand dto1 = new BudgetTransactionCommand.RemoveTagCommand();
        BudgetTransactionCommand.RemoveTagCommand dto2 = new BudgetTransactionCommand.RemoveTagCommand();
