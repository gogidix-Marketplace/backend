...
public class ComplianceReportGenerator {
    ...
    public ComplianceReportGenerator(
            EmailOptimizationMetrics metrics,
    ...
    private PerformanceMetricsSection generatePerformanceSection() {
        ...
        section.setTotalRequests((long) metrics.getMeterRegistry()
                .get("ai.email.optimization.total").counter().count());
        section.setSuccessfulRequests((long) metrics.getMeterRegistry()
                .get("ai.email.optimization.success").counter().count());
        section.setFailedRequests((long) metrics.getMeterRegistry()
                .get("ai.email.optimization.failure").counter().count());
        section.setEmailsOptimized((long) metrics.getMeterRegistry()
                .get("ai.email.optimization.optimized").counter().count());
    ...
    public static class PerformanceMetricsSection {
        ...
        public long getEmailsOptimized() { return emailsOptimized; }
        public void setEmailsOptimized(long emailsOptimized) { this.emailsOptimized = emailsOptimized; }
