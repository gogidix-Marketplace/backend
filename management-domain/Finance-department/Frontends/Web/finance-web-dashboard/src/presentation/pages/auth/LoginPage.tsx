...
export function LoginPage() {
  ...
  const demoUsers = [
    { email: 'finance-manager@gogidix.com', role: 'Finance Manager', label: 'Finance Manager' },
    { email: 'accountant@gogidix.com', role: 'Accountant', label: 'Accountant' },
    { email: 'cfo@gogidix.com', role: 'CFO', label: 'CFO (Executive)' },
  ]
    ...
    <div className="min-h-screen bg-gradient-to-br from-slate-900 via-slate-800 to-slate-900 flex items-center justify-center p-4">
      <div className="w-full max-w-md">
        ...
        <div className="text-center mb-8">
          ...
          <p className="text-slate-400">Gogidix Management Domain - Port 3020</p>
        </div>
          ...
          <div className="mt-6 pt-6 border-t border-slate-200">
            ...
            <div className="space-y-2">
              {demoUsers.map((user) => (
                ...
                >
                  <span className="text-sm font-medium text-slate-700">{user.label}</span>
