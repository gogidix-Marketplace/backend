...
class ComplianceReportGeneratorTest {
    ...
    void generateReport_WhenCalled_ReturnsValidReport() {
        // Arrange
        when(metrics.getTrainingLatencyP95()).thenReturn(300.0);
        when(metrics.getTrainingLatencyP99()).thenReturn(600.0);
    ...
    void generateReport_WhenSloNotCompliant_ReturnsWarningStatus() {
        ...
        when(metrics.getTrainingLatencyP99()).thenReturn(1200.0);
    ...
    void generateReport_WhenUnhealthy_ReturnsNonCompliantStatus() {
        // Arrange
        when(metrics.getTrainingLatencyP95()).thenReturn(800.0);
        when(metrics.getTrainingLatencyP99()).thenReturn(1500.0);
