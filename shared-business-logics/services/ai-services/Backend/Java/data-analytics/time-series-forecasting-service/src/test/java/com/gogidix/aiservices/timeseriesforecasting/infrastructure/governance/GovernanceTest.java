...
class GovernanceTest {
    ...
    @BeforeEach
    void setup() {
        var m = new TimeSeriesForecastingMetrics(new SimpleMeterRegistry());
    ...
    @Test
    void threshold() { assertThat(v.validateThreshold(ThresholdValidator.ThresholdType.P95_FORECASTING_LATENCY)).isNotNull(); }
    @Test
