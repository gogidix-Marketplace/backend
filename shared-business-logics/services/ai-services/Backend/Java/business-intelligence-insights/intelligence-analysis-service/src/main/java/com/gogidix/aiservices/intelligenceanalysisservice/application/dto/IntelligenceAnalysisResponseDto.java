...
public record IntelligenceAnalysisResponseDto(

        @Schema(description = "Unique segment identifier", example = "seg_1234567890abcdef")
        String id,

        @Schema(description = "Name of the segment", example = "High Value IntelligenceReports")
        String name,

        @Schema(description = "Description of the segment", example = "IntelligenceReports with lifetime value > $10,000")
        String description,
        ...
        @Schema(description = "IntelligenceReport IDs in this segment")
