...
class RegionalSummaryDto_RegionalDemographicsDtoTest {

        @Test
    void testBuilder() {
        RegionalSummaryDto.RegionalDemographicsDto dto = RegionalSummaryDto.RegionalDemographicsDto.builder()
                        .totalPopulation(42L)
    ...
    void testSettersAndGetters() {
        RegionalSummaryDto.RegionalDemographicsDto dto = new RegionalSummaryDto.RegionalDemographicsDto();
    ...
    void testEqualsAndHashCode() {
        RegionalSummaryDto.RegionalDemographicsDto dto1 = RegionalSummaryDto.RegionalDemographicsDto.builder()
                        .totalPopulation(42L)
            .targetMarketSize(42L)
            .urbanizationRate(BigDecimal.TEN)
            .averageIncome(BigDecimal.TEN)
            ...
            .acceptedCurrencies(Collections.emptyList())
            .build();
        RegionalSummaryDto.RegionalDemographicsDto dto2 = RegionalSummaryDto.RegionalDemographicsDto.builder()
                        .totalPopulation(42L)
            .targetMarketSize(42L)
            .urbanizationRate(BigDecimal.TEN)
            .averageIncome(BigDecimal.TEN)
