...
public class ThresholdValidator {
    ...
    public ThresholdValidator(ProductRecommendationMetrics metrics) {
    ...
    public ComplianceReport validateAllThresholds() {
        ...
        double analysisLatency = metrics.getRecommendationAnalysisLatencyP95();
        boolean analysisCompliant = analysisLatency <= MAX_ANALYSIS_LATENCY_MS;
        report.addCheck("Recommendation Analysis Latency", analysisLatency, MAX_ANALYSIS_LATENCY_MS, analysisCompliant);
    ...
    public ThresholdValidation validateThreshold(ThresholdType type) {
        return switch (type) {
            ...
            case SEGMENT_ANALYSIS_LATENCY -> {
                double value = metrics.getRecommendationAnalysisLatencyP95();
