...
public record ProfileSearchRequestDto(
    ...
    public ProfileSearchRequestDto {
    ...
    public static ProfileSearchRequestDto create() {
        return new ProfileSearchRequestDto(null, null, 0, 20, "createdAt", "DESC");
    }
}
