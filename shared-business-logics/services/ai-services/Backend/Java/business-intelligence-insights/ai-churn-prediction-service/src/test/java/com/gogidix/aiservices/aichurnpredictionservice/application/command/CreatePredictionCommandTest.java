...
/**
 * Unit tests for CreatePredictionCommand.
 */
@DisplayName("CreatePredictionCommand Tests")
class CreatePredictionCommandTest {
    ...
    private static final PredictionType SEGMENT_TYPE = PredictionType.BEHAVIORAL;
    ...
    class CreationTests {
        ...
        void shouldThrowWhenNameIsNull() {
            assertThrows(IllegalArgumentException.class,
                    () -> new CreatePredictionCommand(null, DESCRIPTION, SEGMENT_TYPE, CRITERIA, TENANT_ID, USER_ID));
        }
        ...
        void shouldThrowWhenNameIsBlank() {
            assertThrows(IllegalArgumentException.class,
                    () -> new CreatePredictionCommand("   ", DESCRIPTION, SEGMENT_TYPE, CRITERIA, TENANT_ID, USER_ID));
        }
        ...
        void shouldThrowWhenNameExceedsMaxLength() {
            ...
            assertThrows(IllegalArgumentException.class,
                    () -> new CreatePredictionCommand(longName, DESCRIPTION, SEGMENT_TYPE, CRITERIA, TENANT_ID, USER_ID));
        }
        ...
        void shouldThrowWhenDescriptionExceedsMaxLength() {
            ...
            assertThrows(IllegalArgumentException.class,
                    () -> new CreatePredictionCommand(NAME, longDescription, SEGMENT_TYPE, CRITERIA, TENANT_ID, USER_ID));
        }

        @Test
        @DisplayName("Should throw when segmentType is null")
        void shouldThrowWhenPredictionTypeIsNull() {
            assertThrows(IllegalArgumentException.class,
                    () -> new CreatePredictionCommand(NAME, DESCRIPTION, null, CRITERIA, TENANT_ID, USER_ID));
        }
        ...
        void shouldThrowWhenCriteriaIsNull() {
            assertThrows(IllegalArgumentException.class,
                    () -> new CreatePredictionCommand(NAME, DESCRIPTION, SEGMENT_TYPE, null, TENANT_ID, USER_ID));
        }
        ...
        void shouldThrowWhenCriteriaIsEmpty() {
            assertThrows(IllegalArgumentException.class,
                    () -> new CreatePredictionCommand(NAME, DESCRIPTION, SEGMENT_TYPE, Map.of(), TENANT_ID, USER_ID));
        }
        ...
        void shouldThrowWhenTenantIdIsNull() {
            assertThrows(IllegalArgumentException.class,
                    () -> new CreatePredictionCommand(NAME, DESCRIPTION, SEGMENT_TYPE, CRITERIA, null, USER_ID));
        }
        ...
        void shouldThrowWhenTenantIdIsBlank() {
            assertThrows(IllegalArgumentException.class,
                    () -> new CreatePredictionCommand(NAME, DESCRIPTION, SEGMENT_TYPE, CRITERIA, "   ", USER_ID));
        }
    ...
    class BoundaryTests {
        ...
        void shouldAcceptNameWithExactly100Characters() {
            ...
            assertDoesNotThrow(() -> new CreatePredictionCommand(
