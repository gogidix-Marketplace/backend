...
@DisplayName("PaymentGateway Exception Tests")
class PaymentGatewayExceptionTest {

    @Test
    @DisplayName("Should create not found exception")
    void shouldCreateNotFoundException() {
        PaymentGatewayNotFoundException ex = new PaymentGatewayNotFoundException("id-1");
    ...
    void shouldCreateDuplicateException() {
        DuplicatePaymentGatewayException ex = new DuplicatePaymentGatewayException("name-1");
    ...
    void shouldCreateInvalidException() {
        InvalidPaymentGatewayException ex = new InvalidPaymentGatewayException("bad data");
    ...
    void shouldCreateInvalidExceptionWithCause() {
        ...
        InvalidPaymentGatewayException ex = new InvalidPaymentGatewayException("msg", cause);
