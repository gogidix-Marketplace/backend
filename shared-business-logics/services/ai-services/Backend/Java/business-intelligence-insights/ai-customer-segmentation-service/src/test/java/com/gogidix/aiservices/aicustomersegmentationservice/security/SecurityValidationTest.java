package com.gogidix.aiservices.aicustomersegmentationservice.security;
...
class SecurityValidationTest {
    ...
    class TenantIsolationTests {
        ...
        void shouldIsolateSegmentsByTenant() {
            String tenant1 = "tenant-1";
            String tenant2 = "tenant-2";

            // Segments for tenant1 should not affect tenant2
    ...
    class ResourceLimitsTests {
        ...
        void shouldEnforceSegmentResultLimit() {
