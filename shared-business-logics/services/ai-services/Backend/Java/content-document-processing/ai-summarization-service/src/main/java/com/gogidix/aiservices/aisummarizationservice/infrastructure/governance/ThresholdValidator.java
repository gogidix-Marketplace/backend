...
public class ThresholdValidator {
    ...
    // Threshold definitions for Content Processing - Summarization
    ...
    private static final double MAX_NLP_LATENCY_MS = 250.0;

    public ThresholdValidator(SummarizationMetrics metrics) {
    ...
    public ComplianceReport validateAllThresholds() {
        ...
        // Validate NLP processing latency
