...
class DealCommand_CreateDealCommandTest {

        @Test
    void testSettersAndGetters() {
        DealCommand.CreateDealCommand dto = new DealCommand.CreateDealCommand();
    ...
    void testEqualsAndHashCode() {
        DealCommand.CreateDealCommand dto1 = new DealCommand.CreateDealCommand();
        DealCommand.CreateDealCommand dto2 = new DealCommand.CreateDealCommand();
