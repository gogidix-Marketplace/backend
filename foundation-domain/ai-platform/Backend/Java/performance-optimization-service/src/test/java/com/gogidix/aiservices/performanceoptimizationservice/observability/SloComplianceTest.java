package com.gogidix.aiservices.performanceoptimizationservice.observability;
...
class SloComplianceTest {
    ...
    private PerformanceOptimizationMetrics metrics;
    private MeterRegistry meterRegistry;

    @BeforeEach
    void setUp() {
        meterRegistry = new SimpleMeterRegistry();
        metrics = new PerformanceOptimizationMetrics(meterRegistry);
    }
    ...
    class MetricsRecordingTests {
        ...
        @Test
        @Order(10)
        @DisplayName("Should record analysis latency")
        void shouldRecordAnalysisLatency() {
            metrics.recordAnalysisTime(100);
        ...
        @Test
        @Order(11)
        @DisplayName("Should record performance requests")
        void shouldRecordPerformanceRequests() {
    ...
    class SloThresholdTests {
        ...
        void shouldHaveP95LatencyBelowThreshold() {
            ...
            for (int i = 0; i < 100; i++) {
                metrics.recordAnalysisTime(50 + i);
            }
    ...
    class MetricsStructureTests {
        ...
        @Test
        @Order(30)
        @DisplayName("Should have analysis duration timer")
        void shouldHaveAnalysisDurationTimer() {
            assertThat(meterRegistry.get("ai.performance.analysis.duration").timer()).isNotNull();
        }
        ...
        void shouldHaveRequestsCounter() {
            assertThat(meterRegistry.get("ai.performance.requests.total").counter()).isNotNull();
        }
    }
}
