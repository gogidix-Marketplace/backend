...
class Audit_WidgetTest {

        @Test
    void testBuilder() {
        Audit.Widget dto = Audit.Widget.builder()
                        .id("test-id")
            .name("test-name")
            .type(Audit.Widget.WidgetType.KPI_CARD)
            .position(42)
            .row(42)
            .column(42)
            .width(42)
        ...
        assertEquals(Audit.Widget.WidgetType.KPI_CARD, dto.getType());
    ...
    void testSettersAndGetters() {
        Audit.Widget dto = new Audit.Widget();
        dto.setId("val-id");
        dto.setName("val-name");
        dto.setType(Audit.Widget.WidgetType.KPI_CARD);
        dto.setPosition(99);
        dto.setRow(99);
        dto.setColumn(99);
        dto.setWidth(99);
    ...
    void testEqualsAndHashCode() {
        Audit.Widget dto1 = Audit.Widget.builder()
                        .id("test-id")
            .name("test-name")
            .type(Audit.Widget.WidgetType.KPI_CARD)
            .position(42)
            ...
            .dataSource("test-dataSource")
            .build();
        Audit.Widget dto2 = Audit.Widget.builder()
                        .id("test-id")
            .name("test-name")
            .type(Audit.Widget.WidgetType.KPI_CARD)
            .position(42)
