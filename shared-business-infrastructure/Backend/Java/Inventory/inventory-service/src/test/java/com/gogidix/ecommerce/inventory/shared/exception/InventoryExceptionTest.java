...
class InventoryExceptionTest {
    ...
    void shouldCreateDuplicateException() {
        DuplicateInventoryException ex = new DuplicateInventoryException("name-1");
    ...
    void shouldCreateInvalidException() {
        InvalidInventoryException ex = new InvalidInventoryException("bad data");
    ...
    void shouldCreateInvalidExceptionWithCause() {
        ...
        InvalidInventoryException ex = new InvalidInventoryException("msg", cause);
