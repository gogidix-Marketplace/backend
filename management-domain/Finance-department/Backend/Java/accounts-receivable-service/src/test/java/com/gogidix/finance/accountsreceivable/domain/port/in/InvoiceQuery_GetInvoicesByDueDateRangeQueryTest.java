...
class InvoiceQuery_GetInvoicesByDueDateRangeQueryTest {

        @Test
    void testSettersAndGetters() {
        InvoiceQuery.GetInvoicesByDueDateRangeQuery dto = new InvoiceQuery.GetInvoicesByDueDateRangeQuery();
    ...
    void testEqualsAndHashCode() {
        InvoiceQuery.GetInvoicesByDueDateRangeQuery dto1 = new InvoiceQuery.GetInvoicesByDueDateRangeQuery();
        InvoiceQuery.GetInvoicesByDueDateRangeQuery dto2 = new InvoiceQuery.GetInvoicesByDueDateRangeQuery();
