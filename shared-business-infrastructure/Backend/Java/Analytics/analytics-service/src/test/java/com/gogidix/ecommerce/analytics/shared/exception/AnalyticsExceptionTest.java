...
@DisplayName("Analytics Exception Tests")
class AnalyticsExceptionTest {

    @Test
    @DisplayName("Should create not found exception")
    void shouldCreateNotFoundException() {
        AnalyticsNotFoundException ex = new AnalyticsNotFoundException("id-1");
    ...
    void shouldCreateDuplicateException() {
        DuplicateAnalyticsException ex = new DuplicateAnalyticsException("name-1");
    ...
    void shouldCreateInvalidException() {
        InvalidAnalyticsException ex = new InvalidAnalyticsException("bad data");
    ...
    void shouldCreateInvalidExceptionWithCause() {
        ...
        InvalidAnalyticsException ex = new InvalidAnalyticsException("msg", cause);
