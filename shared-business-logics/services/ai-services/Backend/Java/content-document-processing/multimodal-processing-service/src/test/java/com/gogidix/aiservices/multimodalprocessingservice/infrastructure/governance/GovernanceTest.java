...
import org.junit.jupiter.api.*; import com.gogidix.aiservices.multimodalprocessingservice.infrastructure.metrics.MultimodalProcessingMetrics; import io.micrometer.core.instrument.simple.SimpleMeterRegistry; import static org.assertj.core.api.Assertions.*;
class GovernanceTest {
    private ThresholdValidator v; private ComplianceReportGenerator g;
    @BeforeEach void setup() { var m = new MultimodalProcessingMetrics(new SimpleMeterRegistry()); v = new ThresholdValidator(m); g = new ComplianceReportGenerator(m, v); }
    ...
    @Test void report() { var r = g.generateReport(); assertThat(r).isNotNull(); assertThat(r.getReportId()).startsWith("GOV-"); }
