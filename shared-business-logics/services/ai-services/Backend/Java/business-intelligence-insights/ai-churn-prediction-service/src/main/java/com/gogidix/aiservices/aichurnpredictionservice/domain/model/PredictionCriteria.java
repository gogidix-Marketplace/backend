...
public class PredictionCriteria {
    ...
    private final List<PredictionCriteria> nestedCriteria;

    // Private constructor
    private PredictionCriteria(Builder builder) {
    ...
    public List<PredictionCriteria> getNestedCriteria() {
     ...
     * @return a new PredictionCriteria with the nested criteria added
     */
    public PredictionCriteria withNestedCriteria(PredictionCriteria criteria) {
        List<PredictionCriteria> newNested = new ArrayList<>(this.nestedCriteria);
    ...
    public boolean equals(Object o) {
        ...
        PredictionCriteria that = (PredictionCriteria) o;
    ...
    /**
     * Builder for PredictionCriteria.
     */
    public static class Builder {
        ...
        private List<PredictionCriteria> nestedCriteria;
        ...
        public Builder nestedCriteria(List<PredictionCriteria> nestedCriteria) {
            this.nestedCriteria = nestedCriteria;
            return this;
        }

        public Builder addNestedCriteria(PredictionCriteria criteria) {
        ...
        public PredictionCriteria build() {
            return new PredictionCriteria(this);
        }
    }
