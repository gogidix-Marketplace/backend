package com.gogidix.aiservices.aiworkflowautomationservice.infrastructure.governance;

import com.gogidix.aiservices.aiworkflowautomationservice.infrastructure.metrics.AiWorkflowAutomationMetrics;
...
public class ComplianceReportGenerator {
    ...
    private final AiWorkflowAutomationMetrics metrics;
    ...
    public ComplianceReportGenerator(
            AiWorkflowAutomationMetrics metrics,
    ...
    private SloComplianceSection generateSloComplianceSection() {
        ...
        // P95 Latency
        double p95Latency = metrics.getWorkflowExecutionLatencyP95();
        ...
        // P99 Latency
        double p99Latency = metrics.getWorkflowExecutionLatencyP99();
    ...
    private PerformanceMetricsSection generatePerformanceSection() {
        ...
        section.setTotalRequests((long) metrics.getMeterRegistry()
                .get("ai.workflow.automation.requests.total").counter().count());

        section.setSuccessfulRequests((long) metrics.getMeterRegistry()
                .get("ai.workflow.automation.requests.success").counter().count());

        section.setFailedRequests((long) metrics.getMeterRegistry()
                .get("ai.workflow.automation.requests.failure").counter().count());

        section.setAutomationsExecuted((long) metrics.getMeterRegistry()
                .get("ai.workflow.automation.executions.total").counter().count());

        section.setAutomationsTriggered((long) metrics.getMeterRegistry()
                .get("ai.workflow.automation.triggered.total").counter().count());
    ...
    public static class GovernanceReport {
        ...
        private Map<String, Object> performanceMetricsToMap() {
            ...
            map.put("automationsExecuted", performanceMetrics.getAutomationsExecuted());
            return map;
        }
    ...
    public static class PerformanceMetricsSection {
        ...
        private long automationsTriggered;
        ...
        public long getAutomationsExecuted() { return automationsExecuted; }
        public void setAutomationsExecuted(long automationsExecuted) { this.automationsExecuted = automationsExecuted; }
        public long getAutomationsTriggered() { return automationsTriggered; }
        public void setAutomationsTriggered(long automationsTriggered) { this.automationsTriggered = automationsTriggered; }
