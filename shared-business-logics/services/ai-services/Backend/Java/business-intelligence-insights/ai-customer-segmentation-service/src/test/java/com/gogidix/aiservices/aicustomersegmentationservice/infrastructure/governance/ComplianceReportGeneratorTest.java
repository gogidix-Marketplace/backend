...
class ComplianceReportGeneratorTest {
    ...
    class ReportGenerationTests {
        ...
        void shouldPopulatePerformanceMetricsSection() {
            ...
            assertThat(perf.getTotalSegmentations()).isEqualTo(5000L);
            assertThat(perf.getSuccessfulSegmentations()).isEqualTo(4750L);
            assertThat(perf.getFailedSegmentations()).isEqualTo(250L);
            assertThat(perf.getSegmentsCreated()).isEqualTo(100L);
            assertThat(perf.getSegmentsUpdated()).isEqualTo(50L);
