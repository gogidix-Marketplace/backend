package com.gogidix.digitalmarketing.leadgeneration.infrastructure.security;
...
public class SecurityConfig {
    ...
    private static final String AUTH_SERVICE_ISSUER_URI = "http://localhost:8081/auth-service/realms/gogidix";
